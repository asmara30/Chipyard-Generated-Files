...
module TLXbar_6(
  ...
  wire        _portsAOI_in_0_a_ready_WIRE = auto_in_a_bits_address[31] & auto_out_0_a_ready | ~(auto_in_a_bits_address[31]) & auto_out_1_a_ready;	// @[Mux.scala:27:73, Parameters.scala:137:65]
  ...
  wire        out_9_bits_corrupt = muxStateEarly_0 & auto_out_0_d_bits_corrupt | muxStateEarly_1 & auto_out_1_d_bits_corrupt;	// @[Arbiter.scala:117:30, Mux.scala:27:73]
  wire        out_9_bits_denied = muxStateEarly_0 & auto_out_0_d_bits_denied | muxStateEarly_1 & auto_out_1_d_bits_denied;	// @[Arbiter.scala:117:30, Mux.scala:27:73]
  wire        out_9_bits_sink = muxStateEarly_1 & auto_out_1_d_bits_sink;	// @[Arbiter.scala:117:30, Mux.scala:27:73]
  wire [4:0]  out_9_bits_source = (muxStateEarly_0 ? auto_out_0_d_bits_source : 5'h0) | (muxStateEarly_1 ? auto_out_1_d_bits_source : 5'h0);	// @[Arbiter.scala:117:30, Bundles.scala:259:74, Mux.scala:27:73]
  ...
  wire [1:0]  out_9_bits_param = muxStateEarly_1 ? auto_out_1_d_bits_param : 2'h0;	// @[Arbiter.scala:117:30, Mux.scala:27:73]
  ...
  assign auto_out_1_a_valid = auto_in_a_valid & ~(auto_in_a_bits_address[31]);	// @[Parameters.scala:137:65, Xbar.scala:430:50]
  ...
  assign auto_out_0_a_valid = auto_in_a_valid & auto_in_a_bits_address[31];	// @[Xbar.scala:430:50]
