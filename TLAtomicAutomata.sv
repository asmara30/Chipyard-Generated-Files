...
module TLAtomicAutomata(
  ...
  wire            idle = beatsLeft == 3'h0;	// @[Arbiter.scala:87:30, :88:28, Misc.scala:201:34]
  ...
  wire            d_first = d_first_counter == 3'h0;	// @[Edges.scala:228:27, :230:25, Misc.scala:201:34]
  ...
  wire            _GEN_8 = out_1_ready & out_1_earlyValid & _GEN & cam_free_0;	// @[Arbiter.scala:123:31, AtomicAutomata.scala:79:24, :82:44, :94:{32,63}, :153:38, :176:50, :178:23, :179:24]
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      beatsLeft <= 3'h0;	// @[Arbiter.scala:87:30, Misc.scala:201:34]
      ...
      if (idle & auto_out_a_ready) begin	// @[Arbiter.scala:88:28, :89:24]
        if (winnerQual_1 & ~(auto_in_a_bits_opcode[2]))	// @[Arbiter.scala:98:79, :111:73, Edges.scala:91:{28,37}, :220:14]
          beatsLeft <= ~(_decode_T_1[5:3]);	// @[Arbiter.scala:87:30, package.scala:235:{46,71,76}]
        else	// @[Arbiter.scala:111:73, Edges.scala:220:14]
          beatsLeft <= 3'h0;	// @[Arbiter.scala:87:30, Misc.scala:201:34]
      end
      else	// @[Arbiter.scala:89:24]
        beatsLeft <= beatsLeft - {2'h0, auto_out_a_ready & out_2_valid};	// @[Arbiter.scala:87:30, :113:52, :125:29, Bundles.scala:259:74, ReadyValidCancel.scala:49:33]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        cam_a_0_bits_address = {_RANDOM_0[31:18], _RANDOM_1[16:0]};	// @[AtomicAutomata.scala:78:28, :79:24]
        cam_a_0_bits_mask = _RANDOM_1[24:17];	// @[AtomicAutomata.scala:79:24]
        cam_a_0_bits_data = {_RANDOM_1[31:25], _RANDOM_2, _RANDOM_3[24:0]};	// @[AtomicAutomata.scala:79:24]
        cam_a_0_bits_corrupt = _RANDOM_3[25];	// @[AtomicAutomata.scala:79:24]
        cam_a_0_fifoId = _RANDOM_3[26];	// @[AtomicAutomata.scala:79:24]
        cam_a_0_lut = _RANDOM_3[30:27];	// @[AtomicAutomata.scala:79:24]
        cam_d_0_data = {_RANDOM_3[31], _RANDOM_4, _RANDOM_5[30:0]};	// @[AtomicAutomata.scala:79:24, :80:24]
        cam_d_0_denied = _RANDOM_5[31];	// @[AtomicAutomata.scala:80:24]
        cam_d_0_corrupt = _RANDOM_6[0];	// @[AtomicAutomata.scala:80:24]
        beatsLeft = _RANDOM_6[3:1];	// @[Arbiter.scala:87:30, AtomicAutomata.scala:80:24]
        state_0 = _RANDOM_6[4];	// @[Arbiter.scala:116:26, AtomicAutomata.scala:80:24]
        state_1 = _RANDOM_6[5];	// @[Arbiter.scala:116:26, AtomicAutomata.scala:80:24]
        d_first_counter = _RANDOM_6[8:6];	// @[AtomicAutomata.scala:80:24, Edges.scala:228:27]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  assign auto_out_a_bits_opcode = muxStateEarly_1 ? (_GEN ? 3'h4 : auto_in_a_bits_opcode) : 3'h0;	// @[Arbiter.scala:117:30, AtomicAutomata.scala:94:{32,63}, :154:24, :155:31, :156:32, Misc.scala:201:34, Mux.scala:27:73]
  assign auto_out_a_bits_param = ~muxStateEarly_1 | _GEN ? 3'h0 : auto_in_a_bits_param;	// @[Arbiter.scala:117:30, AtomicAutomata.scala:94:{32,63}, Misc.scala:201:34, Mux.scala:27:73]
  assign auto_out_a_bits_size = (muxStateEarly_0 ? cam_a_0_bits_size : 3'h0) | (muxStateEarly_1 ? auto_in_a_bits_size : 3'h0);	// @[Arbiter.scala:117:30, AtomicAutomata.scala:79:24, Misc.scala:201:34, Mux.scala:27:73]
