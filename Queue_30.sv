...
module Queue_30(
  ...
  wire [191:0] _ram_ext_R0_data;	// @[Decoupled.scala:273:95]
  ...
  ram_combMem_40 ram_ext (	// @[Decoupled.scala:273:95]
    .R0_addr (1'h0),
    .R0_en   (1'h1),
    .R0_clk  (clock),
    .W0_addr (1'h0),
    ...
    .W0_clk  (clock),
    .W0_data ({io_enq_bits_corrupt, io_enq_bits_data, io_enq_bits_mask, io_enq_bits_address, io_enq_bits_source, io_enq_bits_size, io_enq_bits_param, io_enq_bits_opcode}),	// @[Decoupled.scala:273:95]
  ...
  assign io_deq_bits_source = maybe_full ? _ram_ext_R0_data[14:9] : io_enq_bits_source;	// @[Decoupled.scala:273:95, :276:27, :310:17, :315:17, :316:19]
  assign io_deq_bits_address = maybe_full ? _ram_ext_R0_data[46:15] : io_enq_bits_address;	// @[Decoupled.scala:273:95, :276:27, :310:17, :315:17, :316:19]
  assign io_deq_bits_mask = maybe_full ? _ram_ext_R0_data[62:47] : io_enq_bits_mask;	// @[Decoupled.scala:273:95, :276:27, :310:17, :315:17, :316:19]
  assign io_deq_bits_data = maybe_full ? _ram_ext_R0_data[190:63] : io_enq_bits_data;	// @[Decoupled.scala:273:95, :276:27, :310:17, :315:17, :316:19]
  assign io_deq_bits_corrupt = maybe_full ? _ram_ext_R0_data[191] : io_enq_bits_corrupt;	// @[Decoupled.scala:273:95, :276:27, :310:17, :315:17, :316:19]
endmodule
