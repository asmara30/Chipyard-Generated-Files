...
module Queue_40(
  ...
  wire [146:0] _ram_ext_R0_data;	// @[Decoupled.scala:273:95]
  ...
  assign io_deq_bits_sink = _ram_ext_R0_data[16:13];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_denied = _ram_ext_R0_data[17];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_data = _ram_ext_R0_data[145:18];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_corrupt = _ram_ext_R0_data[146];	// @[Decoupled.scala:273:95]
endmodule
