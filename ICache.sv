...
module ICache(
  ...
  wire         data_arrays_3_dout_3_en;	// @[ICache.scala:582:46]
  wire         data_arrays_3_MPORT_4_mask_3;	// @[ICache.scala:578:102]
  wire         data_arrays_3_MPORT_4_mask_2;	// @[ICache.scala:578:102]
  wire         data_arrays_3_MPORT_4_mask_1;	// @[ICache.scala:578:102]
  wire         data_arrays_3_MPORT_4_mask_0;	// @[ICache.scala:578:102]
  wire [31:0]  _WIRE_4_3;	// @[ICache.scala:575:71]
  wire         data_arrays_3_MPORT_4_en;	// @[ICache.scala:562:32]
  wire         data_arrays_2_dout_2_en;	// @[ICache.scala:582:46]
  wire         data_arrays_2_MPORT_3_mask_3;	// @[ICache.scala:578:102]
  wire         data_arrays_2_MPORT_3_mask_2;	// @[ICache.scala:578:102]
  wire         data_arrays_2_MPORT_3_mask_1;	// @[ICache.scala:578:102]
  wire         data_arrays_2_MPORT_3_mask_0;	// @[ICache.scala:578:102]
  wire [31:0]  _WIRE_3_3;	// @[ICache.scala:575:71]
  wire         data_arrays_2_MPORT_3_en;	// @[ICache.scala:562:32]
  ...
  wire [127:0] _data_arrays_3_RW0_rdata;	// @[DescribedSRAM.scala:17:26]
  wire [127:0] _data_arrays_2_RW0_rdata;	// @[DescribedSRAM.scala:17:26]
  ...
  wire         refill_one_beat = auto_master_out_d_valid & auto_master_out_d_bits_opcode[0];	// @[Edges.scala:105:36, ICache.scala:383:41]
  ...
  wire         tag_array_MPORT_en = refill_one_beat & (counter == 8'h1 | beats1 == 8'h0) & auto_master_out_d_valid;	// @[Edges.scala:220:14, :228:27, :231:{25,37,47}, ICache.scala:383:41, :391:37]
  ...
  assign refillError = auto_master_out_d_bits_corrupt | (|refill_cnt) & accruedRefillError;	// @[Edges.scala:233:25, ICache.scala:420:31, :422:{43,58,64}]
  ...
  wire [7:0]   _mem_idx_T_18 = {refill_paddr[11:6], 2'h0};	// @[ICache.scala:428:97, :566:40, :850:21, Reg.scala:19:16]
  ...
  assign data_arrays_0_dout_en = ~data_arrays_0_MPORT_1_en & s0_valid & io_req_bits_addr[3:2] == 2'h0;	// @[Decoupled.scala:51:35, ICache.scala:428:97, :556:111, :562:32, :582:{41,46}, package.scala:155:13]
  ...
  assign data_arrays_1_dout_1_en = ~data_arrays_1_MPORT_2_en & s0_valid & io_req_bits_addr[3:2] == 2'h1;	// @[Decoupled.scala:51:35, ICache.scala:428:97, :556:111, :562:32, :582:{41,46}, package.scala:155:13]
  assign data_arrays_2_MPORT_3_en = refill_one_beat & ~invalidated;	// @[ICache.scala:359:24, :383:41, :562:{32,35}]
  assign _WIRE_3_3 = auto_master_out_d_bits_data[95:64];	// @[ICache.scala:575:71]
  assign data_arrays_2_MPORT_3_mask_0 = ~(|repl_way_v0);	// @[ICache.scala:399:35, :428:97, :578:102]
  assign data_arrays_2_MPORT_3_mask_1 = repl_way_v0 == 2'h1;	// @[ICache.scala:399:35, :428:97, :578:102]
  assign data_arrays_2_MPORT_3_mask_2 = repl_way_v0 == 2'h2;	// @[ICache.scala:399:35, :403:40, :578:102]
  assign data_arrays_2_MPORT_3_mask_3 = &repl_way_v0;	// @[ICache.scala:399:35, :578:102]
  assign data_arrays_2_dout_2_en = ~data_arrays_2_MPORT_3_en & s0_valid & io_req_bits_addr[3:2] == 2'h2;	// @[Decoupled.scala:51:35, ICache.scala:403:40, :556:111, :562:32, :582:{41,46}, package.scala:155:13]
  assign data_arrays_3_MPORT_4_en = refill_one_beat & ~invalidated;	// @[ICache.scala:359:24, :383:41, :562:{32,35}]
  assign _WIRE_4_3 = auto_master_out_d_bits_data[127:96];	// @[ICache.scala:575:71]
  assign data_arrays_3_MPORT_4_mask_0 = ~(|repl_way_v0);	// @[ICache.scala:399:35, :428:97, :578:102]
  assign data_arrays_3_MPORT_4_mask_1 = repl_way_v0 == 2'h1;	// @[ICache.scala:399:35, :428:97, :578:102]
  assign data_arrays_3_MPORT_4_mask_2 = repl_way_v0 == 2'h2;	// @[ICache.scala:399:35, :403:40, :578:102]
  assign data_arrays_3_MPORT_4_mask_3 = &repl_way_v0;	// @[ICache.scala:399:35, :578:102]
  assign data_arrays_3_dout_3_en = ~data_arrays_3_MPORT_4_en & s0_valid & (&(io_req_bits_addr[3:2]));	// @[Decoupled.scala:51:35, ICache.scala:556:111, :562:32, :582:{41,46}, package.scala:155:13]
  ...
  always @(posedge clock) begin
    ...
    if (s1_valid) begin	// @[ICache.scala:333:25]
      ...
      if (&(io_s1_paddr[3:2])) begin	// @[ICache.scala:556:111, package.scala:155:13]
        s2_dout_0 <= _data_arrays_3_RW0_rdata[31:0];	// @[DescribedSRAM.scala:17:26, Reg.scala:19:16]
        s2_dout_1 <= _data_arrays_3_RW0_rdata[63:32];	// @[DescribedSRAM.scala:17:26, Reg.scala:19:16]
        s2_dout_2 <= _data_arrays_3_RW0_rdata[95:64];	// @[DescribedSRAM.scala:17:26, Reg.scala:19:16]
        s2_dout_3 <= _data_arrays_3_RW0_rdata[127:96];	// @[DescribedSRAM.scala:17:26, Reg.scala:19:16]
      end
      else if (io_s1_paddr[3:2] == 2'h2) begin	// @[ICache.scala:403:40, :556:111, package.scala:155:13]
        s2_dout_0 <= _data_arrays_2_RW0_rdata[31:0];	// @[DescribedSRAM.scala:17:26, Reg.scala:19:16]
        s2_dout_1 <= _data_arrays_2_RW0_rdata[63:32];	// @[DescribedSRAM.scala:17:26, Reg.scala:19:16]
        s2_dout_2 <= _data_arrays_2_RW0_rdata[95:64];	// @[DescribedSRAM.scala:17:26, Reg.scala:19:16]
        s2_dout_3 <= _data_arrays_2_RW0_rdata[127:96];	// @[DescribedSRAM.scala:17:26, Reg.scala:19:16]
      end
      else if (io_s1_paddr[3:2] == 2'h1) begin	// @[ICache.scala:428:97, :556:111, package.scala:155:13]
      ...
      else begin	// @[ICache.scala:556:111]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        counter = {_RANDOM_3[31:26], _RANDOM_4[1:0]};	// @[Edges.scala:228:27]
        accruedRefillError = _RANDOM_4[2];	// @[Edges.scala:228:27, ICache.scala:420:31]
        vb_array = {_RANDOM_4[31:3], _RANDOM_5, _RANDOM_6, _RANDOM_7, _RANDOM_8, _RANDOM_9, _RANDOM_10, _RANDOM_11, _RANDOM_12[2:0]};	// @[Edges.scala:228:27, ICache.scala:440:25]
        s2_tag_hit_0 = _RANDOM_13[17];	// @[Reg.scala:19:16]
        s2_tag_hit_1 = _RANDOM_13[18];	// @[Reg.scala:19:16]
        s2_tag_hit_2 = _RANDOM_13[19];	// @[Reg.scala:19:16]
        s2_tag_hit_3 = _RANDOM_13[20];	// @[Reg.scala:19:16]
        s2_dout_0 = {_RANDOM_13[31:21], _RANDOM_14[20:0]};	// @[Reg.scala:19:16]
        s2_dout_1 = {_RANDOM_14[31:21], _RANDOM_15[20:0]};	// @[Reg.scala:19:16]
        s2_dout_2 = {_RANDOM_15[31:21], _RANDOM_16[20:0]};	// @[Reg.scala:19:16]
        s2_dout_3 = {_RANDOM_16[31:21], _RANDOM_17[20:0]};	// @[Reg.scala:19:16]
        s2_tag_disparity_r_0 = _RANDOM_17[21];	// @[Reg.scala:19:16]
        s2_tag_disparity_r_1 = _RANDOM_17[22];	// @[Reg.scala:19:16]
        s2_tag_disparity_r_2 = _RANDOM_17[23];	// @[Reg.scala:19:16]
        s2_tag_disparity_r_3 = _RANDOM_17[24];	// @[Reg.scala:19:16]
        s2_tl_error = _RANDOM_17[25];	// @[Reg.scala:19:16]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  MaxPeriodFibonacciLFSR_1 repl_way_v0_prng (	// @[PRNG.scala:91:22]
    .clock        (clock),
    .reset        (reset),
  ...
  data_arrays_0_0 data_arrays_0 (	// @[DescribedSRAM.scala:17:26]
    .RW0_addr  (refill_one_beat ? _mem_idx_T_18 | refill_cnt : io_req_bits_addr[11:4]),	// @[Edges.scala:233:25, ICache.scala:383:41, :557:31, :566:{10,40,67}]
  ...
  data_arrays_1_0 data_arrays_1 (	// @[DescribedSRAM.scala:17:26]
    .RW0_addr  (refill_one_beat ? _mem_idx_T_18 | refill_cnt : io_req_bits_addr[11:4]),	// @[Edges.scala:233:25, ICache.scala:383:41, :557:31, :566:{10,40,67}]
  ...
  data_arrays_2 data_arrays_2 (	// @[DescribedSRAM.scala:17:26]
    .RW0_addr  (refill_one_beat ? _mem_idx_T_18 | refill_cnt : io_req_bits_addr[11:4]),	// @[Edges.scala:233:25, ICache.scala:383:41, :557:31, :566:{10,40,67}]
    .RW0_en    (data_arrays_2_dout_2_en | data_arrays_2_MPORT_3_en),	// @[DescribedSRAM.scala:17:26, ICache.scala:562:32, :582:46]
    .RW0_clk   (clock),
    .RW0_wmode (data_arrays_2_MPORT_3_en),	// @[ICache.scala:562:32]
    .RW0_wdata ({4{_WIRE_3_3}}),	// @[DescribedSRAM.scala:17:26, ICache.scala:575:71]
    .RW0_wmask ({data_arrays_2_MPORT_3_mask_3, data_arrays_2_MPORT_3_mask_2, data_arrays_2_MPORT_3_mask_1, data_arrays_2_MPORT_3_mask_0}),	// @[DescribedSRAM.scala:17:26, ICache.scala:578:102]
    .RW0_rdata (_data_arrays_2_RW0_rdata)
  );
  data_arrays_3 data_arrays_3 (	// @[DescribedSRAM.scala:17:26]
    .RW0_addr  (refill_one_beat ? _mem_idx_T_18 | refill_cnt : io_req_bits_addr[11:4]),	// @[Edges.scala:233:25, ICache.scala:383:41, :557:31, :566:{10,40,67}]
    .RW0_en    (data_arrays_3_dout_3_en | data_arrays_3_MPORT_4_en),	// @[DescribedSRAM.scala:17:26, ICache.scala:562:32, :582:46]
    .RW0_clk   (clock),
    .RW0_wmode (data_arrays_3_MPORT_4_en),	// @[ICache.scala:562:32]
    .RW0_wdata ({4{_WIRE_4_3}}),	// @[DescribedSRAM.scala:17:26, ICache.scala:575:71]
    .RW0_wmask ({data_arrays_3_MPORT_4_mask_3, data_arrays_3_MPORT_4_mask_2, data_arrays_3_MPORT_4_mask_1, data_arrays_3_MPORT_4_mask_0}),	// @[DescribedSRAM.scala:17:26, ICache.scala:578:102]
