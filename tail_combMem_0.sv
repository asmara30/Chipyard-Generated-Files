...
module tail_combMem_0(	// @[ListBuffer.scala:47:18]
  input  [5:0] R0_addr,
  input        R0_en,
               R0_clk,
  input  [5:0] R1_addr,
  ...
  reg [4:0] Memory[0:35];	// @[ListBuffer.scala:47:18]
  ...
  `ifndef SYNTHESIS	// @[ListBuffer.scala:47:18]
    `ifdef RANDOMIZE_MEM_INIT	// @[ListBuffer.scala:47:18]
      integer initvar;	// @[ListBuffer.scala:47:18]
    ...
    initial begin	// @[ListBuffer.scala:47:18]
      ...
      `ifdef RANDOMIZE_MEM_INIT	// @[ListBuffer.scala:47:18]
        for (initvar = 0; initvar < 36; initvar = initvar + 1) begin
          _RANDOM_MEM = {`RANDOM};
  ...
  assign R0_data = R0_en ? Memory[R0_addr] : 5'bx;	// @[ListBuffer.scala:47:18]
  assign R1_data = R1_en ? Memory[R1_addr] : 5'bx;	// @[ListBuffer.scala:47:18]
endmodule
