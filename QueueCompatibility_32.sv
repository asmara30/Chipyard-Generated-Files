...
module QueueCompatibility_32(
  ...
  wire [109:0] _ram_ext_R0_data;	// @[Decoupled.scala:273:95]
  ...
  ram_combMem_22 ram_ext (	// @[Decoupled.scala:273:95]
  ...
  assign io_deq_bits_data = _ram_ext_R0_data[108:45];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_corrupt = _ram_ext_R0_data[109];	// @[Decoupled.scala:273:95]
