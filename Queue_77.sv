...
module Queue_77(
  ...
  wire [114:0] _ram_ext_R0_data;	// @[Decoupled.scala:273:95]
  ...
  assign io_deq_bits_address = _ram_ext_R0_data[41:13];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_mask = _ram_ext_R0_data[49:42];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_data = _ram_ext_R0_data[113:50];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_corrupt = _ram_ext_R0_data[114];	// @[Decoupled.scala:273:95]
endmodule
