...
module TLToAXI4(
  ...
  wire [4:0]       _queue_arw_deq_io_deq_bits_echo_tl_state_source;	// @[Decoupled.scala:375:21]
  wire             _queue_arw_deq_io_deq_bits_wen;	// @[Decoupled.scala:375:21]
  wire             _deq_io_enq_ready;	// @[Decoupled.scala:375:21]
  wire [31:0][4:0] _GEN = '{5'h0, 5'h0, 5'h0, 5'h0, 5'h0, 5'h0, 5'h0, 5'h0, 5'h0, 5'h0, 5'h0, 5'h0, 5'h13, 5'h12, 5'h11, 5'h10, 5'hF, 5'hE, 5'hD, 5'hC, 5'hB, 5'hA, 5'h9, 5'h8, 5'h7, 5'h6, 5'h5, 5'h4, 5'h3, 5'h2, 5'h1, 5'h0};	// @[ToAXI4.scala:168:17]
  ...
  wire [4:0]       out_arw_bits_id = _GEN[auto_in_a_bits_source];	// @[ToAXI4.scala:168:17]
  wire [17:0]      _out_arw_bits_len_T_1 = 18'h7FF << auto_in_a_bits_size;	// @[package.scala:235:71]
  wire [31:0]      _GEN_0 = {{count_1}, {count_1}, {count_1}, {count_1}, {count_1}, {count_1}, {count_1}, {count_1}, {count_1}, {count_1}, {count_1}, {count_1}, {count_20}, {count_19}, {count_18}, {count_17}, {count_16}, {count_15}, {count_14}, {count_13}, {count_12}, {count_11}, {count_10}, {count_9}, {count_8}, {count_7}, {count_6}, {count_5}, {count_4}, {count_3}, {count_2}, {count_1}};	// @[ToAXI4.scala:197:49, :256:28]
  ...
  wire [4:0]       bundleIn_0_d_bits_source = r_wins ? auto_out_r_bits_echo_tl_state_source : auto_out_b_bits_echo_tl_state_source;	// @[ToAXI4.scala:217:53, :239:23]
  ...
  wire [4:0]       d_sel_shiftAmount = r_wins ? auto_out_r_bits_id : auto_out_b_bits_id;	// @[ToAXI4.scala:217:53, :245:31]
  wire             d_last = ~r_wins | auto_out_r_bits_last;	// @[ToAXI4.scala:217:53, :246:23]
  wire             _inc_T_19 = _queue_arw_deq_io_enq_ready & out_arw_valid;	// @[Decoupled.scala:51:35, :375:21, ToAXI4.scala:199:45]
  wire             inc = out_arw_bits_id == 5'h0 & _inc_T_19;	// @[Decoupled.scala:51:35, OneHot.scala:64:{12,27}, ToAXI4.scala:168:17, :244:58, :260:22]
  wire             _dec_T_39 = auto_in_d_ready & bundleIn_0_d_valid;	// @[Decoupled.scala:51:35, ToAXI4.scala:221:24]
  wire             dec = d_sel_shiftAmount == 5'h0 & d_last & _dec_T_39;	// @[Decoupled.scala:51:35, OneHot.scala:64:{12,27}, ToAXI4.scala:245:{31,93}, :246:23, :261:32]
  wire             inc_1 = out_arw_bits_id == 5'h1 & _inc_T_19;	// @[Decoupled.scala:51:35, OneHot.scala:64:{12,27}, ToAXI4.scala:168:17, :244:58, :260:22]
  wire             dec_1 = d_sel_shiftAmount == 5'h1 & d_last & _dec_T_39;	// @[Decoupled.scala:51:35, OneHot.scala:64:{12,27}, ToAXI4.scala:245:{31,93}, :246:23, :261:32]
  wire             inc_2 = out_arw_bits_id == 5'h2 & _inc_T_19;	// @[Decoupled.scala:51:35, OneHot.scala:64:{12,27}, ToAXI4.scala:168:17, :244:58, :260:22]
  wire             dec_2 = d_sel_shiftAmount == 5'h2 & d_last & _dec_T_39;	// @[Decoupled.scala:51:35, OneHot.scala:64:{12,27}, ToAXI4.scala:245:{31,93}, :246:23, :261:32]
  wire             inc_3 = out_arw_bits_id == 5'h3 & _inc_T_19;	// @[Decoupled.scala:51:35, OneHot.scala:64:{12,27}, ToAXI4.scala:168:17, :244:58, :260:22]
  wire             dec_3 = d_sel_shiftAmount == 5'h3 & d_last & _dec_T_39;	// @[Decoupled.scala:51:35, OneHot.scala:64:{12,27}, ToAXI4.scala:245:{31,93}, :246:23, :261:32]
  wire             inc_4 = out_arw_bits_id == 5'h4 & _inc_T_19;	// @[Decoupled.scala:51:35, OneHot.scala:64:{12,27}, ToAXI4.scala:168:17, :244:58, :260:22]
  wire             dec_4 = d_sel_shiftAmount == 5'h4 & d_last & _dec_T_39;	// @[Decoupled.scala:51:35, OneHot.scala:64:{12,27}, ToAXI4.scala:245:{31,93}, :246:23, :261:32]
  wire             inc_5 = out_arw_bits_id == 5'h5 & _inc_T_19;	// @[Decoupled.scala:51:35, OneHot.scala:64:{12,27}, ToAXI4.scala:168:17, :244:58, :260:22]
  wire             dec_5 = d_sel_shiftAmount == 5'h5 & d_last & _dec_T_39;	// @[Decoupled.scala:51:35, OneHot.scala:64:{12,27}, ToAXI4.scala:245:{31,93}, :246:23, :261:32]
  wire             inc_6 = out_arw_bits_id == 5'h6 & _inc_T_19;	// @[Decoupled.scala:51:35, OneHot.scala:64:{12,27}, ToAXI4.scala:168:17, :244:58, :260:22]
  wire             dec_6 = d_sel_shiftAmount == 5'h6 & d_last & _dec_T_39;	// @[Decoupled.scala:51:35, OneHot.scala:64:{12,27}, ToAXI4.scala:245:{31,93}, :246:23, :261:32]
  wire             inc_7 = out_arw_bits_id == 5'h7 & _inc_T_19;	// @[Decoupled.scala:51:35, OneHot.scala:64:{12,27}, ToAXI4.scala:168:17, :244:58, :260:22]
  wire             dec_7 = d_sel_shiftAmount == 5'h7 & d_last & _dec_T_39;	// @[Decoupled.scala:51:35, OneHot.scala:64:{12,27}, ToAXI4.scala:245:{31,93}, :246:23, :261:32]
  wire             inc_8 = out_arw_bits_id == 5'h8 & _inc_T_19;	// @[Decoupled.scala:51:35, OneHot.scala:64:{12,27}, ToAXI4.scala:168:17, :244:58, :260:22]
  wire             dec_8 = d_sel_shiftAmount == 5'h8 & d_last & _dec_T_39;	// @[Decoupled.scala:51:35, OneHot.scala:64:{12,27}, ToAXI4.scala:245:{31,93}, :246:23, :261:32]
  wire             inc_9 = out_arw_bits_id == 5'h9 & _inc_T_19;	// @[Decoupled.scala:51:35, OneHot.scala:64:{12,27}, ToAXI4.scala:168:17, :244:58, :260:22]
  wire             dec_9 = d_sel_shiftAmount == 5'h9 & d_last & _dec_T_39;	// @[Decoupled.scala:51:35, OneHot.scala:64:{12,27}, ToAXI4.scala:245:{31,93}, :246:23, :261:32]
  wire             inc_10 = out_arw_bits_id == 5'hA & _inc_T_19;	// @[Decoupled.scala:51:35, OneHot.scala:64:{12,27}, ToAXI4.scala:168:17, :244:58, :260:22]
  wire             dec_10 = d_sel_shiftAmount == 5'hA & d_last & _dec_T_39;	// @[Decoupled.scala:51:35, OneHot.scala:64:{12,27}, ToAXI4.scala:245:{31,93}, :246:23, :261:32]
  wire             inc_11 = out_arw_bits_id == 5'hB & _inc_T_19;	// @[Decoupled.scala:51:35, OneHot.scala:64:{12,27}, ToAXI4.scala:168:17, :244:58, :260:22]
  wire             dec_11 = d_sel_shiftAmount == 5'hB & d_last & _dec_T_39;	// @[Decoupled.scala:51:35, OneHot.scala:64:{12,27}, ToAXI4.scala:245:{31,93}, :246:23, :261:32]
  wire             inc_12 = out_arw_bits_id == 5'hC & _inc_T_19;	// @[Decoupled.scala:51:35, OneHot.scala:64:{12,27}, ToAXI4.scala:168:17, :244:58, :260:22]
  wire             dec_12 = d_sel_shiftAmount == 5'hC & d_last & _dec_T_39;	// @[Decoupled.scala:51:35, OneHot.scala:64:{12,27}, ToAXI4.scala:245:{31,93}, :246:23, :261:32]
  wire             inc_13 = out_arw_bits_id == 5'hD & _inc_T_19;	// @[Decoupled.scala:51:35, OneHot.scala:64:{12,27}, ToAXI4.scala:168:17, :244:58, :260:22]
  wire             dec_13 = d_sel_shiftAmount == 5'hD & d_last & _dec_T_39;	// @[Decoupled.scala:51:35, OneHot.scala:64:{12,27}, ToAXI4.scala:245:{31,93}, :246:23, :261:32]
  wire             inc_14 = out_arw_bits_id == 5'hE & _inc_T_19;	// @[Decoupled.scala:51:35, OneHot.scala:64:{12,27}, ToAXI4.scala:168:17, :244:58, :260:22]
  wire             dec_14 = d_sel_shiftAmount == 5'hE & d_last & _dec_T_39;	// @[Decoupled.scala:51:35, OneHot.scala:64:{12,27}, ToAXI4.scala:245:{31,93}, :246:23, :261:32]
  wire             inc_15 = out_arw_bits_id == 5'hF & _inc_T_19;	// @[Decoupled.scala:51:35, OneHot.scala:64:{12,27}, ToAXI4.scala:168:17, :244:58, :260:22]
  wire             dec_15 = d_sel_shiftAmount == 5'hF & d_last & _dec_T_39;	// @[Decoupled.scala:51:35, OneHot.scala:64:{12,27}, ToAXI4.scala:245:{31,93}, :246:23, :261:32]
  wire             inc_16 = out_arw_bits_id == 5'h10 & _inc_T_19;	// @[Decoupled.scala:51:35, OneHot.scala:64:{12,27}, ToAXI4.scala:168:17, :244:58, :260:22]
  wire             dec_16 = d_sel_shiftAmount == 5'h10 & d_last & _dec_T_39;	// @[Decoupled.scala:51:35, OneHot.scala:64:{12,27}, ToAXI4.scala:245:{31,93}, :246:23, :261:32]
  wire             inc_17 = out_arw_bits_id == 5'h11 & _inc_T_19;	// @[Decoupled.scala:51:35, OneHot.scala:64:{12,27}, ToAXI4.scala:168:17, :244:58, :260:22]
  wire             dec_17 = d_sel_shiftAmount == 5'h11 & d_last & _dec_T_39;	// @[Decoupled.scala:51:35, OneHot.scala:64:{12,27}, ToAXI4.scala:245:{31,93}, :246:23, :261:32]
  wire             inc_18 = out_arw_bits_id == 5'h12 & _inc_T_19;	// @[Decoupled.scala:51:35, OneHot.scala:64:{12,27}, ToAXI4.scala:168:17, :244:58, :260:22]
  wire             dec_18 = d_sel_shiftAmount == 5'h12 & d_last & _dec_T_39;	// @[Decoupled.scala:51:35, OneHot.scala:64:{12,27}, ToAXI4.scala:245:{31,93}, :246:23, :261:32]
  wire             inc_19 = out_arw_bits_id == 5'h13 & _inc_T_19;	// @[Decoupled.scala:51:35, OneHot.scala:64:{12,27}, ToAXI4.scala:168:17, :244:58, :260:22]
  wire             dec_19 = d_sel_shiftAmount == 5'h13 & d_last & _dec_T_39;	// @[Decoupled.scala:51:35, OneHot.scala:64:{12,27}, ToAXI4.scala:245:{31,93}, :246:23, :261:32]
  ...
  Queue_19 deq (	// @[Decoupled.scala:375:21]
    .clock            (clock),
    .reset            (reset),
  ...
  Queue_20 queue_arw_deq (	// @[Decoupled.scala:375:21]
    .clock                            (clock),
    .reset                            (reset),
