...
module UARTAdapter(
  ...
  UARTRx txm (	// @[UARTAdapter.scala:35:19]
    .clock        (clock),
    .reset        (reset),
    .io_en        (1'h1),	// @[UARTAdapter.scala:43:13]
    .io_in        (io_uart_txd),
    .io_div       (16'h364),	// @[UARTAdapter.scala:45:14]
    .io_out_valid (_txm_io_out_valid),
    .io_out_bits  (_txm_io_out_bits)
  );
  Queue_83 txq (	// @[UARTAdapter.scala:36:19]
    .clock        (clock),
    .reset        (reset),
  ...
  UARTTx rxm (	// @[UARTAdapter.scala:37:19]
    .clock       (clock),
    .reset       (reset),
    .io_en       (1'h1),	// @[UARTAdapter.scala:43:13]
  ...
  Queue_83 rxq (	// @[UARTAdapter.scala:38:19]
    .clock        (clock),
    .reset        (reset),
