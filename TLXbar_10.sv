...
module TLXbar_10(
  ...
  wire        out_7_valid = auto_out_d_valid & auto_out_d_bits_source[4];	// @[Parameters.scala:54:10, Xbar.scala:181:40]
  wire        out_10_valid = auto_out_d_valid & ~(auto_out_d_bits_source[4]);	// @[Parameters.scala:54:{10,32}, Xbar.scala:181:40]
  ...
  wire        winnerQual_1 = readys_readys[1] & auto_in_1_a_valid;	// @[Arbiter.scala:26:18, :95:86, :98:79]
  always @(posedge clock) begin
    if (reset) begin
      ...
      if (latch & (|readys_valid))	// @[Arbiter.scala:27:{18,27}, :89:24, Cat.scala:33:92]
        readys_mask <= _readys_mask_T | {_readys_mask_T[0], 1'h0};	// @[Arbiter.scala:23:23, :28:29, Bundle_ACancel.scala:55:22, package.scala:245:{43,53}]
  ...
  TLMonitor_49 monitor (	// @[Nodes.scala:24:25]
    ...
    .io_in_d_valid        (out_7_valid),	// @[Xbar.scala:181:40]
    .io_in_d_bits_opcode  (auto_out_d_bits_opcode),
    .io_in_d_bits_param   (auto_out_d_bits_param),
    .io_in_d_bits_size    (auto_out_d_bits_size),
    .io_in_d_bits_source  (auto_out_d_bits_source[3:0]),	// @[Xbar.scala:230:69]
    .io_in_d_bits_sink    (auto_out_d_bits_sink),
    .io_in_d_bits_denied  (auto_out_d_bits_denied),
    .io_in_d_bits_corrupt (auto_out_d_bits_corrupt)
  );
  TLMonitor_50 monitor_1 (	// @[Nodes.scala:24:25]
    .clock                (clock),
    .reset                (reset),
  ...
  assign auto_in_1_d_valid = out_10_valid;	// @[Xbar.scala:181:40]
  assign auto_in_1_d_bits_opcode = auto_out_d_bits_opcode;
  assign auto_in_1_d_bits_param = auto_out_d_bits_param;
  assign auto_in_1_d_bits_size = auto_out_d_bits_size;
  assign auto_in_1_d_bits_source = auto_out_d_bits_source[3:0];	// @[Xbar.scala:230:69]
  ...
  assign auto_in_0_d_valid = out_7_valid;	// @[Xbar.scala:181:40]
  assign auto_in_0_d_bits_opcode = auto_out_d_bits_opcode;
  assign auto_in_0_d_bits_param = auto_out_d_bits_param;
  assign auto_in_0_d_bits_size = auto_out_d_bits_size;
  assign auto_in_0_d_bits_source = auto_out_d_bits_source[3:0];	// @[Xbar.scala:230:69]
  ...
  assign auto_out_a_bits_opcode = (muxStateEarly_0 ? auto_in_0_a_bits_opcode : 3'h0) | (muxStateEarly_1 ? auto_in_1_a_bits_opcode : 3'h0);	// @[Arbiter.scala:117:30, Bundles.scala:259:74, Mux.scala:27:73]
  assign auto_out_a_bits_param = (muxStateEarly_0 ? auto_in_0_a_bits_param : 3'h0) | (muxStateEarly_1 ? auto_in_1_a_bits_param : 3'h0);	// @[Arbiter.scala:117:30, Bundles.scala:259:74, Mux.scala:27:73]
  assign auto_out_a_bits_size = (muxStateEarly_0 ? auto_in_0_a_bits_size : 4'h0) | (muxStateEarly_1 ? auto_in_1_a_bits_size : 4'h0);	// @[Arbiter.scala:117:30, Bundles.scala:259:74, Mux.scala:27:73]
  assign auto_out_a_bits_source = (muxStateEarly_0 ? {1'h1, auto_in_0_a_bits_source} : 5'h0) | (muxStateEarly_1 ? {1'h0, auto_in_1_a_bits_source} : 5'h0);	// @[Arbiter.scala:117:30, Bundle_ACancel.scala:55:22, Mux.scala:27:73, Parameters.scala:54:32, Xbar.scala:239:{29,55}, :264:23]
  ...
  assign auto_out_a_bits_mask = (muxStateEarly_0 ? auto_in_0_a_bits_mask : 16'h0) | (muxStateEarly_1 ? auto_in_1_a_bits_mask : 16'h0);	// @[Arbiter.scala:117:30, Bundles.scala:259:74, Mux.scala:27:73]
  assign auto_out_a_bits_data = (muxStateEarly_0 ? auto_in_0_a_bits_data : 128'h0) | (muxStateEarly_1 ? auto_in_1_a_bits_data : 128'h0);	// @[Arbiter.scala:117:30, Bundles.scala:259:74, Mux.scala:27:73]
  assign auto_out_a_bits_corrupt = muxStateEarly_0 & auto_in_0_a_bits_corrupt | muxStateEarly_1 & auto_in_1_a_bits_corrupt;	// @[Arbiter.scala:117:30, Mux.scala:27:73]
