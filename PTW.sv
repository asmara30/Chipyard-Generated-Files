...
module PTW(
  ...
  input         io_requestor_1_req_bits_bits_need_gpa,
                ...
                io_requestor_2_req_bits_valid,
  input  [26:0] io_requestor_2_req_bits_bits_addr,
  input         io_requestor_2_req_bits_bits_need_gpa,
                io_requestor_2_req_bits_bits_vstage1,
                io_requestor_2_req_bits_bits_stage2,
                io_mem_req_ready,
                io_mem_s2_nack,
                io_mem_resp_valid,
  ...
  output        io_requestor_1_status_debug,
                io_requestor_1_status_mxr,
                io_requestor_1_status_sum,
  ...
  output        io_requestor_2_req_ready,
                ...
                io_requestor_2_resp_bits_ae_ptw,
                io_requestor_2_resp_bits_ae_final,
                io_requestor_2_resp_bits_pf,
                io_requestor_2_resp_bits_gf,
                io_requestor_2_resp_bits_hr,
                io_requestor_2_resp_bits_hw,
                io_requestor_2_resp_bits_hx,
  output [43:0] io_requestor_2_resp_bits_pte_ppn,
  output        io_requestor_2_resp_bits_pte_d,
                io_requestor_2_resp_bits_pte_a,
                io_requestor_2_resp_bits_pte_g,
                io_requestor_2_resp_bits_pte_u,
                io_requestor_2_resp_bits_pte_x,
                io_requestor_2_resp_bits_pte_w,
                io_requestor_2_resp_bits_pte_r,
                io_requestor_2_resp_bits_pte_v,
  ...
  output        io_requestor_2_pmp_0_cfg_x,
                io_requestor_2_pmp_0_cfg_w,
                io_requestor_2_pmp_0_cfg_r,
  ...
  output        io_requestor_2_pmp_1_cfg_x,
                io_requestor_2_pmp_1_cfg_w,
                io_requestor_2_pmp_1_cfg_r,
  ...
  output        io_requestor_2_pmp_2_cfg_x,
                io_requestor_2_pmp_2_cfg_w,
                io_requestor_2_pmp_2_cfg_r,
  ...
  output        io_requestor_2_pmp_3_cfg_x,
                io_requestor_2_pmp_3_cfg_w,
                io_requestor_2_pmp_3_cfg_r,
  ...
  output        io_requestor_2_pmp_4_cfg_x,
                io_requestor_2_pmp_4_cfg_w,
                io_requestor_2_pmp_4_cfg_r,
  ...
  output        io_requestor_2_pmp_5_cfg_x,
                io_requestor_2_pmp_5_cfg_w,
                io_requestor_2_pmp_5_cfg_r,
  ...
  output        io_requestor_2_pmp_6_cfg_x,
                io_requestor_2_pmp_6_cfg_w,
                io_requestor_2_pmp_6_cfg_r,
  ...
  output        io_requestor_2_pmp_7_cfg_x,
                io_requestor_2_pmp_7_cfg_w,
                io_requestor_2_pmp_7_cfg_r,
  ...
  reg             resp_valid_2;	// @[PTW.scala:242:27]
  ...
  wire [26:0]     _T_15 = do_both_stages & ~stage2 ? mem_resp_data[36:10] : {7'h0, mem_resp_data[29:10]};	// @[PTW.scala:283:19, :289:38, :294:30, :307:{19,35,38,54,99}, Replacement.scala:168:70]
  ...
  wire            _GEN_8 = _T_140 & _T_141;	// @[Decoupled.scala:51:35, PTW.scala:240:30, :587:32]
  wire [7:0][2:0] _GEN_9 = {{3'h0}, {state}, {state}, {io_mem_s2_xcpt_ae_ld ? 3'h0 : 3'h5}, {state}, {3'h4}, {pte_cache_hit ? state : io_mem_req_ready ? 3'h2 : 3'h1}, {_T_141 ? {2'h0, _arb_io_out_bits_valid} : state}};	// @[Decoupled.scala:51:35, Mux.scala:47:70, PTW.scala:233:22, :236:19, :240:30, :379:24, :384:15, :389:24, :581:31, :585:18, :587:32, :595:{20,26}, :621:35, :627:34, :631:{20,26}, :636:18, :639:18, :641:35, :643:20, :648:18]
  ...
  wire            _GEN_17 = r_req_dest == 2'h0;	// @[PTW.scala:272:23, :644:32]
  wire            _GEN_18 = r_req_dest == 2'h1;	// @[PTW.scala:272:23, :644:32]
  wire            _GEN_19 = r_req_dest == 2'h2;	// @[PTW.scala:272:23, :644:32]
  wire            _GEN_20 = _T_140 | _GEN_16;	// @[PTW.scala:240:30, :242:27, :260:24, :585:18]
  wire            _GEN_21 = _T_150 | _T_151 | ~((&state) & ~homogeneous);	// @[PTW.scala:233:22, :259:18, :551:36, :585:18, :650:{13,27}, :651:15]
  always @(posedge clock) begin
    ...
    resp_valid_0 <= mem_resp_valid & ~_GEN_11 & _GEN_17 | ~_GEN_20 & (_T_151 ? io_mem_s2_xcpt_ae_ld & _GEN_17 : (&state) & _GEN_17);	// @[PTW.scala:233:22, :242:27, :293:31, :410:26, :585:18, :641:35, :644:32, :649:30, :683:30, :689:25, :692:21, :701:57, :711:19]
    resp_valid_1 <= mem_resp_valid & ~_GEN_11 & _GEN_18 | ~_GEN_20 & (_T_151 ? io_mem_s2_xcpt_ae_ld & _GEN_18 : (&state) & _GEN_18);	// @[PTW.scala:233:22, :242:27, :293:31, :410:26, :585:18, :641:35, :644:32, :649:30, :683:30, :689:25, :692:21, :701:57, :711:19]
    resp_valid_2 <= mem_resp_valid & ~_GEN_11 & _GEN_19 | ~_GEN_20 & (_T_151 ? io_mem_s2_xcpt_ae_ld & _GEN_19 : (&state) & _GEN_19);	// @[PTW.scala:233:22, :242:27, :293:31, :410:26, :585:18, :641:35, :644:32, :649:30, :683:30, :689:25, :692:21, :701:57, :711:19]
    ...
    if (do_switch) begin	// @[PTW.scala:583:30, :689:25, :692:21]
      ...
      if (mem_resp_valid) begin	// @[PTW.scala:293:31]
        if (traverse)	// @[PTW.scala:316:48]
          ...
          else if (_GEN_21) begin	// @[PTW.scala:259:18, :585:18]
          end
        ...
        count <= 2'h2;	// @[PTW.scala:259:18]
      if (_T_140 & _T_141) begin	// @[Decoupled.scala:51:35, PTW.scala:240:30, :585:18, :587:32]
    ...
    if (_T_140)	// @[PTW.scala:240:30]
      resp_ae_ptw <= ~_T_141 & resp_ae_ptw;	// @[Decoupled.scala:51:35, PTW.scala:260:24, :587:32, :603:21]
    ...
    if (~mem_resp_valid | _GEN_11) begin	// @[PTW.scala:293:31, :410:26, :585:18, :674:8, :689:25, :692:21, :701:57, :711:19]
      resp_ae_final <= ~_GEN_8 & resp_ae_final;	// @[PTW.scala:261:26, :585:18, :587:32, :604:23]
      resp_pf <= ~_GEN_8 & resp_pf;	// @[PTW.scala:261:26, :262:20, :585:18, :587:32, :604:23, :605:17]
      resp_gf <= ~_GEN_8 & resp_gf;	// @[PTW.scala:261:26, :263:20, :585:18, :587:32, :604:23, :606:17]
      resp_hr <= _GEN_8 | resp_hr;	// @[PTW.scala:264:20, :585:18, :587:32, :607:17]
      resp_hw <= _GEN_8 | resp_hw;	// @[PTW.scala:265:20, :585:18, :587:32, :608:17]
      resp_hx <= _GEN_8 | resp_hx;	// @[PTW.scala:266:20, :585:18, :587:32, :609:17]
    end
    ...
    if (_GEN_8) begin	// @[PTW.scala:587:32]
    ...
    stage2 <= do_switch | (~mem_resp_valid | traverse | ~(_T_176 & stage2)) & (_GEN_8 ? _arb_io_out_bits_bits_stage2 : stage2);	// @[PTW.scala:236:19, :283:19, :293:31, :316:48, :583:30, :585:18, :587:32, :596:22, :674:8, :689:25, :692:21, :701:{45,57}, :702:23, :703:18, :737:20, :745:12]
    stage2_final <= mem_resp_valid & ~traverse & _T_176 & ~stage2 | (_GEN_8 ? _arb_io_out_bits_bits_stage2 & ~_arb_io_out_bits_bits_vstage1 : stage2_final);	// @[PTW.scala:236:19, :283:19, :284:25, :293:31, :316:48, :585:18, :587:32, :597:{22,53,56}, :689:25, :692:21, :701:{45,57}, :702:23, :706:24]
  ...
  `ifndef SYNTHESIS
    always @(posedge clock) begin	// @[PTW.scala:613:15]
      if (_GEN_8 & ~reset & ~(~_arb_io_out_bits_bits_need_gpa | _arb_io_out_bits_bits_stage2)) begin	// @[PTW.scala:236:19, :587:32, :613:{15,16,47}]
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        resp_valid_2 = _RANDOM_0[5];	// @[PTW.scala:233:22, :242:27]
        ...
        l2_refill = _RANDOM_37[1];	// @[PTW.scala:410:26]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  Arbiter_9 arb (	// @[PTW.scala:236:19]
    ...
    .io_in_2_ready              (io_requestor_2_req_ready),
  ...
  assign io_requestor_2_resp_valid = resp_valid_2;	// @[PTW.scala:242:27]
  assign io_requestor_2_resp_bits_ae_ptw = resp_ae_ptw;	// @[PTW.scala:260:24]
  assign io_requestor_2_resp_bits_ae_final = resp_ae_final;	// @[PTW.scala:261:26]
  assign io_requestor_2_resp_bits_pf = resp_pf;	// @[PTW.scala:262:20]
  assign io_requestor_2_resp_bits_gf = resp_gf;	// @[PTW.scala:263:20]
  assign io_requestor_2_resp_bits_hr = resp_hr;	// @[PTW.scala:264:20]
  assign io_requestor_2_resp_bits_hw = resp_hw;	// @[PTW.scala:265:20]
  assign io_requestor_2_resp_bits_hx = resp_hx;	// @[PTW.scala:266:20]
  assign io_requestor_2_resp_bits_pte_ppn = r_pte_ppn;	// @[PTW.scala:275:18]
  assign io_requestor_2_resp_bits_pte_d = r_pte_d;	// @[PTW.scala:275:18]
  assign io_requestor_2_resp_bits_pte_a = r_pte_a;	// @[PTW.scala:275:18]
  assign io_requestor_2_resp_bits_pte_g = r_pte_g;	// @[PTW.scala:275:18]
  assign io_requestor_2_resp_bits_pte_u = r_pte_u;	// @[PTW.scala:275:18]
  assign io_requestor_2_resp_bits_pte_x = r_pte_x;	// @[PTW.scala:275:18]
  assign io_requestor_2_resp_bits_pte_w = r_pte_w;	// @[PTW.scala:275:18]
  assign io_requestor_2_resp_bits_pte_r = r_pte_r;	// @[PTW.scala:275:18]
  assign io_requestor_2_resp_bits_pte_v = r_pte_v;	// @[PTW.scala:275:18]
  assign io_requestor_2_resp_bits_level = max_count;	// @[PTW.scala:290:25]
  assign io_requestor_2_resp_bits_homogeneous = homogeneous;	// @[PTW.scala:551:36]
  assign io_requestor_2_ptbr_mode = io_dpath_ptbr_mode;
  ...
  assign io_requestor_2_pmp_0_cfg_w = io_dpath_pmp_0_cfg_w;
  assign io_requestor_2_pmp_0_cfg_r = io_dpath_pmp_0_cfg_r;
  ...
  assign io_requestor_2_pmp_1_cfg_w = io_dpath_pmp_1_cfg_w;
  assign io_requestor_2_pmp_1_cfg_r = io_dpath_pmp_1_cfg_r;
  ...
  assign io_requestor_2_pmp_2_cfg_w = io_dpath_pmp_2_cfg_w;
  assign io_requestor_2_pmp_2_cfg_r = io_dpath_pmp_2_cfg_r;
  ...
  assign io_requestor_2_pmp_3_cfg_w = io_dpath_pmp_3_cfg_w;
  assign io_requestor_2_pmp_3_cfg_r = io_dpath_pmp_3_cfg_r;
  ...
  assign io_requestor_2_pmp_4_cfg_w = io_dpath_pmp_4_cfg_w;
  assign io_requestor_2_pmp_4_cfg_r = io_dpath_pmp_4_cfg_r;
  ...
  assign io_requestor_2_pmp_5_cfg_w = io_dpath_pmp_5_cfg_w;
  assign io_requestor_2_pmp_5_cfg_r = io_dpath_pmp_5_cfg_r;
  ...
  assign io_requestor_2_pmp_6_cfg_w = io_dpath_pmp_6_cfg_w;
  assign io_requestor_2_pmp_6_cfg_r = io_dpath_pmp_6_cfg_r;
  ...
  assign io_requestor_2_pmp_7_cfg_w = io_dpath_pmp_7_cfg_w;
  assign io_requestor_2_pmp_7_cfg_r = io_dpath_pmp_7_cfg_r;
