...
module Queue_79(
  ...
  assign io_deq_bits_size = _ram_ext_R0_data[7:6];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_source = _ram_ext_R0_data[15:8];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_address = _ram_ext_R0_data[44:16];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_mask = _ram_ext_R0_data[52:45];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_data = _ram_ext_R0_data[116:53];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_corrupt = _ram_ext_R0_data[117];	// @[Decoupled.scala:273:95]
endmodule
