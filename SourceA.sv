...
module SourceA(
  ...
  Queue_22 io_a_q (	// @[Decoupled.scala:375:21]
    .clock               (clock),
    .reset               (reset),
    ...
    .io_enq_bits_address ({io_req_bits_tag[12], 3'h0, io_req_bits_tag[11:0], io_req_bits_set, 6'h0}),	// @[Cat.scala:33:92, Parameters.scala:219:15, :227:72]
