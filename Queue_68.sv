...
module Queue_68(
  ...
  wire [68:0] _ram_ext_R0_data;	// @[Decoupled.scala:273:95]
  ...
  ram_combMem_7 ram_ext (	// @[Decoupled.scala:273:95]
    ...
    .W0_clk  (clock),
    .W0_data ({io_enq_bits_data, io_enq_bits_rd}),	// @[Decoupled.scala:273:95]
    .R0_data (_ram_ext_R0_data)
  );
  assign io_enq_ready = ~full;	// @[Decoupled.scala:279:24, :303:19]
  assign io_deq_valid = ~empty;	// @[Decoupled.scala:278:25, :302:19]
  assign io_deq_bits_rd = _ram_ext_R0_data[4:0];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_data = _ram_ext_R0_data[68:5];	// @[Decoupled.scala:273:95]
endmodule
