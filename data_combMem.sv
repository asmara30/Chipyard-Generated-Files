...
module data_combMem(	// @[ListBuffer.scala:50:18]
  input  [4:0]  R0_addr,
  input         R0_en,
                R0_clk,
  input  [4:0]  W0_addr,
  ...
  reg [43:0] Memory[0:27];	// @[ListBuffer.scala:50:18]
  ...
  `ifndef SYNTHESIS	// @[ListBuffer.scala:50:18]
    ...
    initial begin	// @[ListBuffer.scala:50:18]
      ...
      `ifdef RANDOMIZE_MEM_INIT	// @[ListBuffer.scala:50:18]
        for (initvar = 0; initvar < 28; initvar = initvar + 1) begin
          _RANDOM_MEM = {{`RANDOM}, {`RANDOM}};
          Memory[initvar] = _RANDOM_MEM[43:0];
        end	// @[ListBuffer.scala:50:18]
      `endif // RANDOMIZE_MEM_INIT
    end // initial
  `endif // not def SYNTHESIS
  assign R0_data = R0_en ? Memory[R0_addr] : 44'bx;	// @[ListBuffer.scala:50:18]
endmodule
