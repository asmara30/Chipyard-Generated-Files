...
module Queue_71(
  ...
  wire [188:0] _ram_ext_R0_data;	// @[Decoupled.scala:273:95]
  ...
  ram_combMem_38 ram_ext (	// @[Decoupled.scala:273:95]
  ...
  assign io_deq_bits_mask = _ram_ext_R0_data[59:44];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_data = _ram_ext_R0_data[187:60];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_corrupt = _ram_ext_R0_data[188];	// @[Decoupled.scala:273:95]
endmodule
