...
module TLSerdesser(
  ...
  wire [18:0] _merged_bits_last_beats1_decode_T_13 = 19'hFFF << auto_manager_in_a_bits_size;	// @[package.scala:235:71]
  reg  [8:0]  merged_bits_last_counter_4;	// @[Edges.scala:228:27]
  wire        _inDes_io_out_ready_T = _inDes_io_out_bits_chanId == 3'h0;	// @[Serdes.scala:234:37, :314:20, :629:23]
      ...
      if (_outArb_io_in_1_ready & auto_client_out_d_valid) begin	// @[Decoupled.scala:51:35, Serdes.scala:622:24]
        if (merged_bits_last_counter_1 == 9'h0) begin	// @[Edges.scala:228:27, :230:25]
          if (auto_client_out_d_bits_opcode[0])	// @[Edges.scala:105:36]
            merged_bits_last_counter_1 <= ~(_merged_bits_last_beats1_decode_T_1[11:3]);	// @[Edges.scala:228:27, package.scala:235:{46,71,76}]
      ...
      if (_outArb_io_in_4_ready & auto_manager_in_a_valid) begin	// @[Decoupled.scala:51:35, Serdes.scala:622:24]
        if (merged_bits_last_counter_4 == 9'h0) begin	// @[Edges.scala:228:27, :230:25]
          if (auto_manager_in_a_bits_opcode[2])	// @[Edges.scala:91:37]
            ...
            merged_bits_last_counter_4 <= ~(_merged_bits_last_beats1_decode_T_13[11:3]);	// @[Edges.scala:228:27, package.scala:235:{46,71,76}]
        end
        else	// @[Edges.scala:230:25]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        _RANDOM_0 = `RANDOM;
        _RANDOM_1 = `RANDOM;
        merged_bits_last_counter_1 = _RANDOM_0[17:9];	// @[Edges.scala:228:27]
        merged_bits_last_counter_4 = _RANDOM_1[12:4];	// @[Edges.scala:228:27]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  TLMonitor_66 monitor (	// @[Nodes.scala:24:25]
    ...
    .io_in_d_bits_size    (_inDes_io_out_bits_size[2:0]),	// @[Serdes.scala:403:15, :629:23]
    .io_in_d_bits_source  (_inDes_io_out_bits_source),	// @[Serdes.scala:629:23]
    .io_in_d_bits_sink    (_inDes_io_out_bits_union[1]),	// @[Serdes.scala:465:17, :629:23]
  ...
  HellaPeekingArbiter outArb (	// @[Serdes.scala:622:24]
    ...
    .io_in_1_bits_source  ({3'h0, auto_client_out_d_bits_source}),	// @[Serdes.scala:314:20]
    .io_in_1_bits_data    (auto_client_out_d_bits_data),
    .io_in_1_bits_corrupt (auto_client_out_d_bits_corrupt),
    .io_in_1_bits_union   ({3'h0, auto_client_out_d_bits_sink, auto_client_out_d_bits_denied}),	// @[Serdes.scala:314:20, :319:22]
    .io_in_1_bits_last    (merged_bits_last_counter_1 == 9'h1 | (auto_client_out_d_bits_opcode[0] ? ~(_merged_bits_last_beats1_decode_T_1[11:3]) : 9'h0) == 9'h0),	// @[Edges.scala:105:36, :220:14, :228:27, :231:{25,37,47}, package.scala:235:{46,71,76}]
    ...
    .io_in_4_bits_size    ({1'h0, auto_manager_in_a_bits_size}),	// @[Bundles.scala:262:74, Serdes.scala:256:20]
    .io_in_4_bits_source  (auto_manager_in_a_bits_source),
    .io_in_4_bits_address ({3'h0, auto_manager_in_a_bits_address}),	// @[Serdes.scala:258:20, :314:20]
    ...
    .io_in_4_bits_last    (merged_bits_last_counter_4 == 9'h1 | (auto_manager_in_a_bits_opcode[2] ? 9'h0 : ~(_merged_bits_last_beats1_decode_T_13[11:3])) == 9'h0),	// @[Edges.scala:91:37, :220:14, :228:27, :231:{25,37,47}, package.scala:235:{46,71,76}]
  ...
  GenericDeserializer inDes (	// @[Serdes.scala:629:23]
    ...
    .io_out_ready        (_inDes_io_out_bits_chanId != 3'h4 & (_inDes_io_out_ready_T_6 ? auto_manager_in_d_ready : ~(_inDes_io_out_bits_chanId == 3'h2 | _inDes_io_out_bits_chanId == 3'h1) & _inDes_io_out_ready_T & auto_client_out_a_ready)),	// @[Mux.scala:81:58, Serdes.scala:234:37, :235:37, :236:37, :237:37, :238:37, :331:20, :629:23]
  ...
  assign auto_manager_in_d_bits_size = _inDes_io_out_bits_size[2:0];	// @[Serdes.scala:403:15, :629:23]
  assign auto_manager_in_d_bits_source = _inDes_io_out_bits_source;	// @[Serdes.scala:629:23]
  assign auto_manager_in_d_bits_sink = _inDes_io_out_bits_union[1];	// @[Serdes.scala:465:17, :629:23]
  ...
  assign auto_client_out_a_bits_source = _inDes_io_out_bits_source[0];	// @[Serdes.scala:375:15, :629:23]
