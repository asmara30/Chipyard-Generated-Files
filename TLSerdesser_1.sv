...
module TLSerdesser_1(
  ...
  TLMonitor_71 monitor (	// @[Nodes.scala:24:25]
    ...
    .io_in_d_bits_sink    (_inDes_io_out_bits_union[4:1]),	// @[Serdes.scala:465:17, :629:23]
  ...
  assign auto_manager_in_d_bits_sink = _inDes_io_out_bits_union[4:1];	// @[Serdes.scala:465:17, :629:23]
