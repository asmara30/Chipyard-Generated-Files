...
module Queue_43(
  ...
  ram_combMem_41 ram_ext (	// @[Decoupled.scala:273:95]
  ...
  assign io_deq_bits_source = _ram_ext_R0_data[14:10];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_address = _ram_ext_R0_data[46:15];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_mask = _ram_ext_R0_data[62:47];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_data = _ram_ext_R0_data[190:63];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_corrupt = _ram_ext_R0_data[191];	// @[Decoupled.scala:273:95]
endmodule
