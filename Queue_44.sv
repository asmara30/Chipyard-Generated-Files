...
module Queue_44(
  ...
  ram_combMem_34 ram_ext (	// @[Decoupled.scala:273:95]
  ...
  assign io_deq_bits_source = _ram_ext_R0_data[13:9];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_sink = _ram_ext_R0_data[17:14];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_denied = _ram_ext_R0_data[18];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_data = _ram_ext_R0_data[146:19];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_corrupt = _ram_ext_R0_data[147];	// @[Decoupled.scala:273:95]
endmodule
