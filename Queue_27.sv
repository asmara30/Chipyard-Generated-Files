...
module Queue_27(
  ...
  wire [80:0] _ram_ext_R0_data;	// @[Decoupled.scala:273:95]
  ...
  assign io_deq_bits_source = _ram_ext_R0_data[11:8];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_sink = _ram_ext_R0_data[14:12];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_denied = _ram_ext_R0_data[15];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_data = _ram_ext_R0_data[79:16];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_corrupt = _ram_ext_R0_data[80];	// @[Decoupled.scala:273:95]
endmodule
