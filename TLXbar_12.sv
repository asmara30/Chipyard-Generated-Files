...
module TLXbar_12(
  ...
  wire        _portsAOI_in_0_a_ready_WIRE = auto_in_a_bits_address[28] & auto_out_0_a_ready | ~(auto_in_a_bits_address[28]) & auto_out_1_a_ready;	// @[Mux.scala:27:73, Parameters.scala:137:65]
  ...
  wire        out_9_bits_sink = muxStateEarly_0 & auto_out_0_d_bits_sink;	// @[Arbiter.scala:117:30, Mux.scala:27:73]
  wire [3:0]  out_9_bits_source = (muxStateEarly_0 ? auto_out_0_d_bits_source : 4'h0) | (muxStateEarly_1 ? auto_out_1_d_bits_source : 4'h0);	// @[Arbiter.scala:117:30, Bundles.scala:259:74, Mux.scala:27:73]
  ...
  wire [1:0]  out_9_bits_param = muxStateEarly_0 ? auto_out_0_d_bits_param : 2'h0;	// @[Arbiter.scala:117:30, Mux.scala:27:73]
  wire [2:0]  out_9_bits_opcode = (muxStateEarly_0 ? auto_out_0_d_bits_opcode : 3'h0) | {2'h0, muxStateEarly_1};	// @[Arbiter.scala:117:30, Bundles.scala:259:74, Mux.scala:27:73]
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      if (latch)	// @[Arbiter.scala:89:24]
        beatsLeft <= (winnerQual_0 & auto_out_0_d_bits_opcode[0] ? ~(_beatsDO_decode_T_1[5:3]) : 3'h0) | (winnerQual_1 ? ~(_beatsDO_decode_T_5[5:3]) : 3'h0);	// @[Arbiter.scala:87:30, :98:79, :111:73, :112:44, Bundles.scala:259:74, Edges.scala:105:36, :220:14, package.scala:235:{46,71,76}]
  ...
  assign auto_out_1_a_valid = auto_in_a_valid & ~(auto_in_a_bits_address[28]);	// @[Parameters.scala:137:65, Xbar.scala:430:50]
  assign auto_out_1_a_bits_opcode = auto_in_a_bits_opcode;
  assign auto_out_1_a_bits_param = auto_in_a_bits_param;
  assign auto_out_1_a_bits_size = auto_in_a_bits_size;
  assign auto_out_1_a_bits_source = auto_in_a_bits_source;
  assign auto_out_1_a_bits_address = auto_in_a_bits_address[17:0];	// @[BundleMap.scala:247:19]
  ...
  assign auto_out_0_a_valid = auto_in_a_valid & auto_in_a_bits_address[28];	// @[Xbar.scala:430:50]
