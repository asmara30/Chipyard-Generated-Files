...
module tail_combMem(	// @[ListBuffer.scala:47:18]
  input        R0_addr,
               R0_en,
               R0_clk,
               R1_addr,
  ...
  reg [2:0] Memory[0:1];	// @[ListBuffer.scala:47:18]
  ...
  assign R0_data = R0_en ? Memory[R0_addr] : 3'bx;	// @[ListBuffer.scala:47:18]
  assign R1_data = R1_en ? Memory[R1_addr] : 3'bx;	// @[ListBuffer.scala:47:18]
endmodule
