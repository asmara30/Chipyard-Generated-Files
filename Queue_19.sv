...
module Queue_19(
  ...
  ram_combMem_9 ram_ext (	// @[Decoupled.scala:273:95]
    .R0_addr (1'h0),
    .R0_en   (1'h1),
    .R0_clk  (clock),
    .W0_addr (1'h0),
  ...
  assign io_deq_bits_data = maybe_full ? _ram_ext_R0_data[63:0] : io_enq_bits_data;	// @[Decoupled.scala:273:95, :276:27, :310:17, :315:17, :316:19]
  assign io_deq_bits_strb = maybe_full ? _ram_ext_R0_data[71:64] : io_enq_bits_strb;	// @[Decoupled.scala:273:95, :276:27, :310:17, :315:17, :316:19]
  assign io_deq_bits_last = maybe_full ? _ram_ext_R0_data[72] : io_enq_bits_last;	// @[Decoupled.scala:273:95, :276:27, :310:17, :315:17, :316:19]
endmodule
