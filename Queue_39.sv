...
module Queue_39(
  ...
  wire [190:0] _ram_ext_R0_data;	// @[Decoupled.scala:273:95]
  ...
  ram_combMem_39 ram_ext (	// @[Decoupled.scala:273:95]
  ...
  assign io_deq_bits_source = _ram_ext_R0_data[13:10];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_address = _ram_ext_R0_data[45:14];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_mask = _ram_ext_R0_data[61:46];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_data = _ram_ext_R0_data[189:62];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_corrupt = _ram_ext_R0_data[190];	// @[Decoupled.scala:273:95]
endmodule
