...
module Queue_25(
  ...
  wire [175:0] _ram_ext_R0_data;	// @[Decoupled.scala:273:95]
  ...
  ram_combMem_36 ram_ext (	// @[Decoupled.scala:273:95]
    ...
    .W0_clk  (clock),
    .W0_data ({io_enq_bits_corrupt, io_enq_bits_data, io_enq_bits_address, io_enq_bits_source, io_enq_bits_size, io_enq_bits_param, io_enq_bits_opcode}),	// @[Decoupled.scala:273:95]
  ...
  assign io_deq_bits_source = _ram_ext_R0_data[14:9];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_address = _ram_ext_R0_data[46:15];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_data = _ram_ext_R0_data[174:47];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_corrupt = _ram_ext_R0_data[175];	// @[Decoupled.scala:273:95]
endmodule
