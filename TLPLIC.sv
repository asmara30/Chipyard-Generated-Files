...
module TLPLIC(
  ...
  wire        out_woready_6;	// @[RegisterRouter.scala:82:24]
  wire        out_woready_9;	// @[RegisterRouter.scala:82:24]
  wire        _out_rofireMux_T_1;	// @[RegisterRouter.scala:82:24]
  wire        out_backSel_10;	// @[RegisterRouter.scala:82:24]
  wire        out_backSel_8;	// @[RegisterRouter.scala:82:24]
  ...
  wire        _out_T_11 = {_out_back_io_deq_bits_index[22:19], _out_back_io_deq_bits_index[17:11], _out_back_io_deq_bits_index[8:5], _out_back_io_deq_bits_index[3:0]} == 19'h0;	// @[Decoupled.scala:375:21, RegisterRouter.scala:82:24]
  wire [31:0] _out_womask_T_9 = {{8{_out_back_io_deq_bits_mask[7]}}, {8{_out_back_io_deq_bits_mask[6]}}, {8{_out_back_io_deq_bits_mask[5]}}, {8{_out_back_io_deq_bits_mask[4]}}};	// @[Bitwise.scala:28:17, :77:12, Decoupled.scala:375:21, RegisterRouter.scala:82:24]
  wire        claimer_1 = _out_rofireMux_T_1 & out_backSel_10 & _out_T_11 & (|_out_womask_T_9);	// @[RegisterRouter.scala:82:24]
  wire [1:0]  _out_completer_1_T = {enables_1_0, 1'h0} >> _GEN;	// @[Cat.scala:33:92, OneHot.scala:64:12, Plic.scala:163:31, :174:26, :295:51]
  assign completer_1 = out_woready_6 & (&_out_womask_T_9) & _out_completer_1_T[0];	// @[Plic.scala:295:{35,51}, RegisterRouter.scala:82:24]
  wire        claimer_0 = _out_rofireMux_T_1 & out_backSel_8 & _out_T_11 & (|_out_womask_T_9);	// @[RegisterRouter.scala:82:24]
  ...
  assign completer_0 = out_woready_9 & (&_out_womask_T_9) & _out_completer_0_T[0];	// @[Plic.scala:295:{35,51}, RegisterRouter.scala:82:24]
  wire [3:0]  out_oindex = {_out_back_io_deq_bits_index[18], _out_back_io_deq_bits_index[10:9], _out_back_io_deq_bits_index[4]};	// @[Cat.scala:33:92, Decoupled.scala:375:21, RegisterRouter.scala:82:24]
  wire [3:0]  _GEN_0 = {_out_back_io_deq_bits_index[18], _out_back_io_deq_bits_index[10:9], _out_back_io_deq_bits_index[4]};	// @[Cat.scala:33:92, Decoupled.scala:375:21, OneHot.scala:57:35, RegisterRouter.scala:82:24]
  assign out_backSel_8 = _GEN_0 == 4'h8;	// @[MuxLiteral.scala:54:22, OneHot.scala:57:35, RegisterRouter.scala:82:24]
  assign out_backSel_10 = _GEN_0 == 4'hA;	// @[MuxLiteral.scala:54:22, OneHot.scala:57:35, RegisterRouter.scala:82:24]
  ...
  assign out_woready_9 = _out_wofireMux_T_2 & out_backSel_8 & _out_T_11;	// @[RegisterRouter.scala:82:24]
  assign out_woready_6 = _out_wofireMux_T_2 & out_backSel_10 & _out_T_11;	// @[RegisterRouter.scala:82:24]
  ...
  wire        claimedDevs_1 = claimer_0 & maxDevs_0 | claimer_1 & maxDevs_1;	// @[Plic.scala:181:22, :246:{49,96}, RegisterRouter.scala:82:24]
  always @(posedge clock) begin
    if (_out_wofireMux_T_2 & _GEN_0 == 4'h0 & _out_T_11 & _out_back_io_deq_bits_mask[4])	// @[Bitwise.scala:28:17, Decoupled.scala:375:21, MuxLiteral.scala:54:22, OneHot.scala:57:35, RegisterRouter.scala:82:24]
    ...
    if (out_woready_6 & _out_back_io_deq_bits_mask[0])	// @[Bitwise.scala:28:17, Decoupled.scala:375:21, RegisterRouter.scala:82:24]
      threshold_1 <= _out_back_io_deq_bits_data[0];	// @[Decoupled.scala:375:21, Plic.scala:166:31, RegisterRouter.scala:82:24]
    if (_out_wofireMux_T_2 & _GEN_0 == 4'h4 & _out_T_11 & _out_back_io_deq_bits_mask[0])	// @[Bitwise.scala:28:17, Decoupled.scala:375:21, MuxLiteral.scala:54:22, OneHot.scala:57:35, RegisterRouter.scala:82:24]
      enables_0_0 <= _out_back_io_deq_bits_data[1];	// @[Decoupled.scala:375:21, Plic.scala:174:26, RegisterRouter.scala:82:24]
    if (_out_wofireMux_T_2 & _GEN_0 == 4'h5 & _out_T_11 & _out_back_io_deq_bits_mask[0])	// @[Bitwise.scala:28:17, Decoupled.scala:375:21, MuxLiteral.scala:54:22, OneHot.scala:57:35, RegisterRouter.scala:82:24]
  ...
  `ifndef SYNTHESIS
    always @(posedge clock) begin	// @[Plic.scala:245:11]
      if (~reset & (|({claimer_1, claimer_0} & {claimer_1, claimer_0} - 2'h1))) begin	// @[Plic.scala:245:{11,21,28,46,58}, RegisterRouter.scala:82:24]
      ...
      if (~reset & (|({completer_1, completer_0} & {completer_1, completer_0} - 2'h1))) begin	// @[Plic.scala:262:{11,23,30,50,62}, :295:35]
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        pending_0 = _RANDOM_0[3];	// @[Plic.scala:163:31, :168:22]
        enables_0_0 = _RANDOM_0[4];	// @[Plic.scala:163:31, :174:26]
        enables_1_0 = _RANDOM_0[5];	// @[Plic.scala:163:31, :174:26]
        maxDevs_0 = _RANDOM_0[6];	// @[Plic.scala:163:31, :181:22]
        maxDevs_1 = _RANDOM_0[7];	// @[Plic.scala:163:31, :181:22]
        x1_0_REG = _RANDOM_0[8];	// @[Plic.scala:163:31, :188:41]
        bundleOut_1_0_REG = _RANDOM_0[9];	// @[Plic.scala:163:31, :188:41]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  LevelGateway gateways_gateway (	// @[Plic.scala:156:27]
    ...
    .io_plic_complete ((completer_0 | completer_1) & completerDev),	// @[Plic.scala:264:{28,48}, :295:35, RegisterRouter.scala:82:24, package.scala:155:13]
  ...
  Queue_76 out_back (	// @[Decoupled.scala:375:21]
    .clock                               (clock),
    .reset                               (reset),
