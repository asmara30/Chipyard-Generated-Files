...
module next_combMem_0(	// @[ListBuffer.scala:49:18]
  input  [4:0] R0_addr,
  input        R0_en,
               R0_clk,
  input  [4:0] W0_addr,
  ...
  reg [4:0] Memory[0:27];	// @[ListBuffer.scala:49:18]
  ...
  `ifndef SYNTHESIS	// @[ListBuffer.scala:49:18]
    `ifdef RANDOMIZE_MEM_INIT	// @[ListBuffer.scala:49:18]
      integer initvar;	// @[ListBuffer.scala:49:18]
  ...
  assign R0_data = R0_en ? Memory[R0_addr] : 5'bx;	// @[ListBuffer.scala:49:18]
endmodule
