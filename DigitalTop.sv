...
module DigitalTop(
  input         clock,
                ...
                auto_prci_ctrl_domain_tileResetSetter_clock_in_member_allClocks_subsystem_mbus_0_clock,
                auto_prci_ctrl_domain_tileResetSetter_clock_in_member_allClocks_subsystem_mbus_0_reset,
                ...
                auto_prci_ctrl_domain_tileResetSetter_clock_in_member_allClocks_subsystem_sbus_1_clock,
                auto_prci_ctrl_domain_tileResetSetter_clock_in_member_allClocks_subsystem_sbus_1_reset,
  ...
  wire         _dtm_io_dmi_req_valid;	// @[Periphery.scala:159:21]
  wire [6:0]   _dtm_io_dmi_req_bits_addr;	// @[Periphery.scala:159:21]
  wire [31:0]  _dtm_io_dmi_req_bits_data;	// @[Periphery.scala:159:21]
  wire [1:0]   _dtm_io_dmi_req_bits_op;	// @[Periphery.scala:159:21]
  wire         _dtm_io_dmi_resp_ready;	// @[Periphery.scala:159:21]
  ...
  wire         _resetSynchronizer_auto_out_member_allClocks_subsystem_mbus_0_clock;	// @[ResetSynchronizer.scala:44:69]
  wire         _resetSynchronizer_auto_out_member_allClocks_subsystem_mbus_0_reset;	// @[ResetSynchronizer.scala:44:69]
  ...
  wire         _resetSynchronizer_auto_out_member_allClocks_subsystem_sbus_1_clock;	// @[ResetSynchronizer.scala:44:69]
  wire         _resetSynchronizer_auto_out_member_allClocks_subsystem_sbus_1_reset;	// @[ResetSynchronizer.scala:44:69]
  ...
  wire         _clockGroupCombiner_auto_frequency_specifier_out_member_allClocks_implicit_clock_clock;	// @[ClockGroupCombiner.scala:19:15]
  wire         _clockGroupCombiner_auto_frequency_specifier_out_member_allClocks_implicit_clock_reset;	// @[ClockGroupCombiner.scala:19:15]
  wire         _clockGroupCombiner_auto_frequency_specifier_out_member_allClocks_subsystem_cbus_0_clock;	// @[ClockGroupCombiner.scala:19:15]
  wire         _clockGroupCombiner_auto_frequency_specifier_out_member_allClocks_subsystem_cbus_0_reset;	// @[ClockGroupCombiner.scala:19:15]
  wire         _clockGroupCombiner_auto_frequency_specifier_out_member_allClocks_subsystem_mbus_0_clock;	// @[ClockGroupCombiner.scala:19:15]
  wire         _clockGroupCombiner_auto_frequency_specifier_out_member_allClocks_subsystem_mbus_0_reset;	// @[ClockGroupCombiner.scala:19:15]
  wire         _clockGroupCombiner_auto_frequency_specifier_out_member_allClocks_subsystem_fbus_0_clock;	// @[ClockGroupCombiner.scala:19:15]
  wire         _clockGroupCombiner_auto_frequency_specifier_out_member_allClocks_subsystem_fbus_0_reset;	// @[ClockGroupCombiner.scala:19:15]
  wire         _clockGroupCombiner_auto_frequency_specifier_out_member_allClocks_subsystem_pbus_0_clock;	// @[ClockGroupCombiner.scala:19:15]
  wire         _clockGroupCombiner_auto_frequency_specifier_out_member_allClocks_subsystem_pbus_0_reset;	// @[ClockGroupCombiner.scala:19:15]
  wire         _clockGroupCombiner_auto_frequency_specifier_out_member_allClocks_subsystem_sbus_1_clock;	// @[ClockGroupCombiner.scala:19:15]
  wire         _clockGroupCombiner_auto_frequency_specifier_out_member_allClocks_subsystem_sbus_1_reset;	// @[ClockGroupCombiner.scala:19:15]
  wire         _clockGroupCombiner_auto_frequency_specifier_out_member_allClocks_subsystem_sbus_0_clock;	// @[ClockGroupCombiner.scala:19:15]
  wire         _clockGroupCombiner_auto_frequency_specifier_out_member_allClocks_subsystem_sbus_0_reset;	// @[ClockGroupCombiner.scala:19:15]
  ...
  wire         _aggregator_auto_out_4_member_subsystem_cbus_subsystem_cbus_0_clock;	// @[HasChipyardPRCI.scala:40:30]
  wire         _aggregator_auto_out_4_member_subsystem_cbus_subsystem_cbus_0_reset;	// @[HasChipyardPRCI.scala:40:30]
  wire         _aggregator_auto_out_3_member_subsystem_mbus_subsystem_mbus_0_clock;	// @[HasChipyardPRCI.scala:40:30]
  wire         _aggregator_auto_out_3_member_subsystem_mbus_subsystem_mbus_0_reset;	// @[HasChipyardPRCI.scala:40:30]
  wire         _aggregator_auto_out_2_member_subsystem_fbus_subsystem_fbus_0_clock;	// @[HasChipyardPRCI.scala:40:30]
  wire         _aggregator_auto_out_2_member_subsystem_fbus_subsystem_fbus_0_reset;	// @[HasChipyardPRCI.scala:40:30]
  wire         _aggregator_auto_out_1_member_subsystem_pbus_subsystem_pbus_0_clock;	// @[HasChipyardPRCI.scala:40:30]
  wire         _aggregator_auto_out_1_member_subsystem_pbus_subsystem_pbus_0_reset;	// @[HasChipyardPRCI.scala:40:30]
  wire         _aggregator_auto_out_0_member_subsystem_sbus_subsystem_sbus_1_clock;	// @[HasChipyardPRCI.scala:40:30]
  wire         _aggregator_auto_out_0_member_subsystem_sbus_subsystem_sbus_1_reset;	// @[HasChipyardPRCI.scala:40:30]
  wire         _aggregator_auto_out_0_member_subsystem_sbus_subsystem_sbus_0_clock;	// @[HasChipyardPRCI.scala:40:30]
  wire         _aggregator_auto_out_0_member_subsystem_sbus_subsystem_sbus_0_reset;	// @[HasChipyardPRCI.scala:40:30]
  wire         _prci_ctrl_domain_auto_tileResetSetter_tl_in_a_ready;	// @[HasChipyardPRCI.scala:36:36]
  wire         _prci_ctrl_domain_auto_tileResetSetter_tl_in_d_valid;	// @[HasChipyardPRCI.scala:36:36]
  wire [2:0]   _prci_ctrl_domain_auto_tileResetSetter_tl_in_d_bits_opcode;	// @[HasChipyardPRCI.scala:36:36]
  wire [1:0]   _prci_ctrl_domain_auto_tileResetSetter_tl_in_d_bits_size;	// @[HasChipyardPRCI.scala:36:36]
  wire [10:0]  _prci_ctrl_domain_auto_tileResetSetter_tl_in_d_bits_source;	// @[HasChipyardPRCI.scala:36:36]
  wire [63:0]  _prci_ctrl_domain_auto_tileResetSetter_tl_in_d_bits_data;	// @[HasChipyardPRCI.scala:36:36]
  wire         _prci_ctrl_domain_auto_tileClockGater_tile_clock_gater_in_a_ready;	// @[HasChipyardPRCI.scala:36:36]
  wire         _prci_ctrl_domain_auto_tileClockGater_tile_clock_gater_in_d_valid;	// @[HasChipyardPRCI.scala:36:36]
  wire [2:0]   _prci_ctrl_domain_auto_tileClockGater_tile_clock_gater_in_d_bits_opcode;	// @[HasChipyardPRCI.scala:36:36]
  wire [1:0]   _prci_ctrl_domain_auto_tileClockGater_tile_clock_gater_in_d_bits_size;	// @[HasChipyardPRCI.scala:36:36]
  wire [10:0]  _prci_ctrl_domain_auto_tileClockGater_tile_clock_gater_in_d_bits_source;	// @[HasChipyardPRCI.scala:36:36]
  wire [63:0]  _prci_ctrl_domain_auto_tileClockGater_tile_clock_gater_in_d_bits_data;	// @[HasChipyardPRCI.scala:36:36]
  wire         _prci_ctrl_domain_auto_tileClockGater_tile_clock_gater_out_member_allClocks_implicit_clock_clock;	// @[HasChipyardPRCI.scala:36:36]
  wire         _prci_ctrl_domain_auto_tileClockGater_tile_clock_gater_out_member_allClocks_implicit_clock_reset;	// @[HasChipyardPRCI.scala:36:36]
  wire         _prci_ctrl_domain_auto_tileClockGater_tile_clock_gater_out_member_allClocks_subsystem_cbus_0_clock;	// @[HasChipyardPRCI.scala:36:36]
  wire         _prci_ctrl_domain_auto_tileClockGater_tile_clock_gater_out_member_allClocks_subsystem_cbus_0_reset;	// @[HasChipyardPRCI.scala:36:36]
  wire         _prci_ctrl_domain_auto_tileClockGater_tile_clock_gater_out_member_allClocks_subsystem_mbus_0_clock;	// @[HasChipyardPRCI.scala:36:36]
  wire         _prci_ctrl_domain_auto_tileClockGater_tile_clock_gater_out_member_allClocks_subsystem_mbus_0_reset;	// @[HasChipyardPRCI.scala:36:36]
  wire         _prci_ctrl_domain_auto_tileClockGater_tile_clock_gater_out_member_allClocks_subsystem_fbus_0_clock;	// @[HasChipyardPRCI.scala:36:36]
  wire         _prci_ctrl_domain_auto_tileClockGater_tile_clock_gater_out_member_allClocks_subsystem_fbus_0_reset;	// @[HasChipyardPRCI.scala:36:36]
  wire         _prci_ctrl_domain_auto_tileClockGater_tile_clock_gater_out_member_allClocks_subsystem_pbus_0_clock;	// @[HasChipyardPRCI.scala:36:36]
  wire         _prci_ctrl_domain_auto_tileClockGater_tile_clock_gater_out_member_allClocks_subsystem_pbus_0_reset;	// @[HasChipyardPRCI.scala:36:36]
  wire         _prci_ctrl_domain_auto_tileClockGater_tile_clock_gater_out_member_allClocks_subsystem_sbus_1_clock;	// @[HasChipyardPRCI.scala:36:36]
  wire         _prci_ctrl_domain_auto_tileClockGater_tile_clock_gater_out_member_allClocks_subsystem_sbus_1_reset;	// @[HasChipyardPRCI.scala:36:36]
  wire         _prci_ctrl_domain_auto_tileClockGater_tile_clock_gater_out_member_allClocks_subsystem_sbus_0_clock;	// @[HasChipyardPRCI.scala:36:36]
  wire         _prci_ctrl_domain_auto_tileClockGater_tile_clock_gater_out_member_allClocks_subsystem_sbus_0_reset;	// @[HasChipyardPRCI.scala:36:36]
  wire         _intsink_4_auto_out_0;	// @[Crossing.scala:99:29]
  wire         _uartClockDomainWrapper_auto_uart_0_int_xing_out_sync_0;	// @[UART.scala:218:44]
  wire         _uartClockDomainWrapper_auto_uart_0_control_xing_in_a_ready;	// @[UART.scala:218:44]
  wire         _uartClockDomainWrapper_auto_uart_0_control_xing_in_d_valid;	// @[UART.scala:218:44]
  wire [2:0]   _uartClockDomainWrapper_auto_uart_0_control_xing_in_d_bits_opcode;	// @[UART.scala:218:44]
  wire [1:0]   _uartClockDomainWrapper_auto_uart_0_control_xing_in_d_bits_size;	// @[UART.scala:218:44]
  wire [10:0]  _uartClockDomainWrapper_auto_uart_0_control_xing_in_d_bits_source;	// @[UART.scala:218:44]
  wire [63:0]  _uartClockDomainWrapper_auto_uart_0_control_xing_in_d_bits_data;	// @[UART.scala:218:44]
  wire         _tsi_domain_auto_serdesser_client_out_a_valid;	// @[SerialAdapter.scala:381:32]
  wire [2:0]   _tsi_domain_auto_serdesser_client_out_a_bits_opcode;	// @[SerialAdapter.scala:381:32]
  wire [2:0]   _tsi_domain_auto_serdesser_client_out_a_bits_param;	// @[SerialAdapter.scala:381:32]
  wire [3:0]   _tsi_domain_auto_serdesser_client_out_a_bits_size;	// @[SerialAdapter.scala:381:32]
  wire         _tsi_domain_auto_serdesser_client_out_a_bits_source;	// @[SerialAdapter.scala:381:32]
  wire [31:0]  _tsi_domain_auto_serdesser_client_out_a_bits_address;	// @[SerialAdapter.scala:381:32]
  wire [7:0]   _tsi_domain_auto_serdesser_client_out_a_bits_mask;	// @[SerialAdapter.scala:381:32]
  wire [63:0]  _tsi_domain_auto_serdesser_client_out_a_bits_data;	// @[SerialAdapter.scala:381:32]
  wire         _tsi_domain_auto_serdesser_client_out_a_bits_corrupt;	// @[SerialAdapter.scala:381:32]
  wire         _tsi_domain_auto_serdesser_client_out_d_ready;	// @[SerialAdapter.scala:381:32]
  wire         _tsi_domain_auto_tlserial_manager_crossing_in_a_ready;	// @[SerialAdapter.scala:381:32]
  wire         _tsi_domain_auto_tlserial_manager_crossing_in_d_valid;	// @[SerialAdapter.scala:381:32]
  wire [2:0]   _tsi_domain_auto_tlserial_manager_crossing_in_d_bits_opcode;	// @[SerialAdapter.scala:381:32]
  wire [1:0]   _tsi_domain_auto_tlserial_manager_crossing_in_d_bits_param;	// @[SerialAdapter.scala:381:32]
  wire [2:0]   _tsi_domain_auto_tlserial_manager_crossing_in_d_bits_size;	// @[SerialAdapter.scala:381:32]
  wire [3:0]   _tsi_domain_auto_tlserial_manager_crossing_in_d_bits_source;	// @[SerialAdapter.scala:381:32]
  wire         _tsi_domain_auto_tlserial_manager_crossing_in_d_bits_sink;	// @[SerialAdapter.scala:381:32]
  wire         _tsi_domain_auto_tlserial_manager_crossing_in_d_bits_denied;	// @[SerialAdapter.scala:381:32]
  wire [63:0]  _tsi_domain_auto_tlserial_manager_crossing_in_d_bits_data;	// @[SerialAdapter.scala:381:32]
  wire         _tsi_domain_auto_tlserial_manager_crossing_in_d_bits_corrupt;	// @[SerialAdapter.scala:381:32]
  ...
  wire         _tileHartIdNexusNode_auto_out;	// @[HasTiles.scala:158:39]
  wire         _xbar_2_auto_int_out_0;	// @[Xbar.scala:30:26]
  wire         _xbar_1_auto_int_out_0;	// @[Xbar.scala:30:26]
  wire         _xbar_auto_int_out_0;	// @[Xbar.scala:30:26]
  wire         _tlDM_auto_dmInner_dmInner_tl_in_a_ready;	// @[Periphery.scala:84:26]
  wire         _tlDM_auto_dmInner_dmInner_tl_in_d_valid;	// @[Periphery.scala:84:26]
  wire [2:0]   _tlDM_auto_dmInner_dmInner_tl_in_d_bits_opcode;	// @[Periphery.scala:84:26]
  wire [1:0]   _tlDM_auto_dmInner_dmInner_tl_in_d_bits_size;	// @[Periphery.scala:84:26]
  wire [10:0]  _tlDM_auto_dmInner_dmInner_tl_in_d_bits_source;	// @[Periphery.scala:84:26]
  wire [63:0]  _tlDM_auto_dmInner_dmInner_tl_in_d_bits_data;	// @[Periphery.scala:84:26]
  wire         _tlDM_auto_dmOuter_intsource_out_sync_0;	// @[Periphery.scala:84:26]
  wire         _tlDM_io_dmi_dmi_req_ready;	// @[Periphery.scala:84:26]
  wire         _tlDM_io_dmi_dmi_resp_valid;	// @[Periphery.scala:84:26]
  wire [31:0]  _tlDM_io_dmi_dmi_resp_bits_data;	// @[Periphery.scala:84:26]
  wire [1:0]   _tlDM_io_dmi_dmi_resp_bits_resp;	// @[Periphery.scala:84:26]
  ...
  wire         _tile_prci_domain_auto_tl_master_clock_xing_out_1_a_valid;	// @[HasTiles.scala:250:38]
  wire [2:0]   _tile_prci_domain_auto_tl_master_clock_xing_out_1_a_bits_opcode;	// @[HasTiles.scala:250:38]
  wire [2:0]   _tile_prci_domain_auto_tl_master_clock_xing_out_1_a_bits_param;	// @[HasTiles.scala:250:38]
  wire [3:0]   _tile_prci_domain_auto_tl_master_clock_xing_out_1_a_bits_size;	// @[HasTiles.scala:250:38]
  wire [1:0]   _tile_prci_domain_auto_tl_master_clock_xing_out_1_a_bits_source;	// @[HasTiles.scala:250:38]
  wire [31:0]  _tile_prci_domain_auto_tl_master_clock_xing_out_1_a_bits_address;	// @[HasTiles.scala:250:38]
  wire [15:0]  _tile_prci_domain_auto_tl_master_clock_xing_out_1_a_bits_mask;	// @[HasTiles.scala:250:38]
  wire [127:0] _tile_prci_domain_auto_tl_master_clock_xing_out_1_a_bits_data;	// @[HasTiles.scala:250:38]
  wire         _tile_prci_domain_auto_tl_master_clock_xing_out_1_a_bits_corrupt;	// @[HasTiles.scala:250:38]
  wire         _tile_prci_domain_auto_tl_master_clock_xing_out_1_b_ready;	// @[HasTiles.scala:250:38]
  wire         _tile_prci_domain_auto_tl_master_clock_xing_out_1_c_valid;	// @[HasTiles.scala:250:38]
  wire [2:0]   _tile_prci_domain_auto_tl_master_clock_xing_out_1_c_bits_opcode;	// @[HasTiles.scala:250:38]
  wire [2:0]   _tile_prci_domain_auto_tl_master_clock_xing_out_1_c_bits_param;	// @[HasTiles.scala:250:38]
  wire [3:0]   _tile_prci_domain_auto_tl_master_clock_xing_out_1_c_bits_size;	// @[HasTiles.scala:250:38]
  wire [1:0]   _tile_prci_domain_auto_tl_master_clock_xing_out_1_c_bits_source;	// @[HasTiles.scala:250:38]
  wire [31:0]  _tile_prci_domain_auto_tl_master_clock_xing_out_1_c_bits_address;	// @[HasTiles.scala:250:38]
  wire [127:0] _tile_prci_domain_auto_tl_master_clock_xing_out_1_c_bits_data;	// @[HasTiles.scala:250:38]
  wire         _tile_prci_domain_auto_tl_master_clock_xing_out_1_c_bits_corrupt;	// @[HasTiles.scala:250:38]
  wire         _tile_prci_domain_auto_tl_master_clock_xing_out_1_d_ready;	// @[HasTiles.scala:250:38]
  wire         _tile_prci_domain_auto_tl_master_clock_xing_out_1_e_valid;	// @[HasTiles.scala:250:38]
  wire [3:0]   _tile_prci_domain_auto_tl_master_clock_xing_out_1_e_bits_sink;	// @[HasTiles.scala:250:38]
  wire         _tile_prci_domain_auto_tl_master_clock_xing_out_0_a_valid;	// @[HasTiles.scala:250:38]
  wire [2:0]   _tile_prci_domain_auto_tl_master_clock_xing_out_0_a_bits_opcode;	// @[HasTiles.scala:250:38]
  wire [2:0]   _tile_prci_domain_auto_tl_master_clock_xing_out_0_a_bits_param;	// @[HasTiles.scala:250:38]
  wire [3:0]   _tile_prci_domain_auto_tl_master_clock_xing_out_0_a_bits_size;	// @[HasTiles.scala:250:38]
  wire [4:0]   _tile_prci_domain_auto_tl_master_clock_xing_out_0_a_bits_source;	// @[HasTiles.scala:250:38]
  wire [31:0]  _tile_prci_domain_auto_tl_master_clock_xing_out_0_a_bits_address;	// @[HasTiles.scala:250:38]
  wire [15:0]  _tile_prci_domain_auto_tl_master_clock_xing_out_0_a_bits_mask;	// @[HasTiles.scala:250:38]
  wire [127:0] _tile_prci_domain_auto_tl_master_clock_xing_out_0_a_bits_data;	// @[HasTiles.scala:250:38]
  wire         _tile_prci_domain_auto_tl_master_clock_xing_out_0_a_bits_corrupt;	// @[HasTiles.scala:250:38]
  wire         _tile_prci_domain_auto_tl_master_clock_xing_out_0_d_ready;	// @[HasTiles.scala:250:38]
  ...
  wire [4:0]   _subsystem_l2_wrapper_auto_coupler_to_bus_named_subsystem_mbus_bus_xing_out_a_bits_source;	// @[BankedL2Params.scala:47:31]
  ...
  wire [3:0]   _subsystem_l2_wrapper_auto_coherent_jbar_in_d_bits_sink;	// @[BankedL2Params.scala:47:31]
  wire         _subsystem_l2_wrapper_auto_coherent_jbar_in_d_bits_denied;	// @[BankedL2Params.scala:47:31]
  wire [127:0] _subsystem_l2_wrapper_auto_coherent_jbar_in_d_bits_data;	// @[BankedL2Params.scala:47:31]
  ...
  wire         _subsystem_mbus_auto_coupler_to_port_named_serial_tl_mem_tlserial_manager_crossing_out_a_valid;	// @[MemoryBus.scala:25:26]
  wire [2:0]   _subsystem_mbus_auto_coupler_to_port_named_serial_tl_mem_tlserial_manager_crossing_out_a_bits_opcode;	// @[MemoryBus.scala:25:26]
  wire [2:0]   _subsystem_mbus_auto_coupler_to_port_named_serial_tl_mem_tlserial_manager_crossing_out_a_bits_param;	// @[MemoryBus.scala:25:26]
  wire [2:0]   _subsystem_mbus_auto_coupler_to_port_named_serial_tl_mem_tlserial_manager_crossing_out_a_bits_size;	// @[MemoryBus.scala:25:26]
  wire [3:0]   _subsystem_mbus_auto_coupler_to_port_named_serial_tl_mem_tlserial_manager_crossing_out_a_bits_source;	// @[MemoryBus.scala:25:26]
  wire [28:0]  _subsystem_mbus_auto_coupler_to_port_named_serial_tl_mem_tlserial_manager_crossing_out_a_bits_address;	// @[MemoryBus.scala:25:26]
  wire [7:0]   _subsystem_mbus_auto_coupler_to_port_named_serial_tl_mem_tlserial_manager_crossing_out_a_bits_mask;	// @[MemoryBus.scala:25:26]
  wire [63:0]  _subsystem_mbus_auto_coupler_to_port_named_serial_tl_mem_tlserial_manager_crossing_out_a_bits_data;	// @[MemoryBus.scala:25:26]
  wire         _subsystem_mbus_auto_coupler_to_port_named_serial_tl_mem_tlserial_manager_crossing_out_a_bits_corrupt;	// @[MemoryBus.scala:25:26]
  wire         _subsystem_mbus_auto_coupler_to_port_named_serial_tl_mem_tlserial_manager_crossing_out_d_ready;	// @[MemoryBus.scala:25:26]
  ...
  wire [4:0]   _subsystem_mbus_auto_bus_xing_in_d_bits_source;	// @[MemoryBus.scala:25:26]
  ...
  wire         _subsystem_cbus_auto_coupler_to_slave_named_tileresetsetter_buffer_out_a_valid;	// @[PeripheryBus.scala:31:26]
  wire [2:0]   _subsystem_cbus_auto_coupler_to_slave_named_tileresetsetter_buffer_out_a_bits_opcode;	// @[PeripheryBus.scala:31:26]
  wire [2:0]   _subsystem_cbus_auto_coupler_to_slave_named_tileresetsetter_buffer_out_a_bits_param;	// @[PeripheryBus.scala:31:26]
  wire [1:0]   _subsystem_cbus_auto_coupler_to_slave_named_tileresetsetter_buffer_out_a_bits_size;	// @[PeripheryBus.scala:31:26]
  wire [10:0]  _subsystem_cbus_auto_coupler_to_slave_named_tileresetsetter_buffer_out_a_bits_source;	// @[PeripheryBus.scala:31:26]
  wire [20:0]  _subsystem_cbus_auto_coupler_to_slave_named_tileresetsetter_buffer_out_a_bits_address;	// @[PeripheryBus.scala:31:26]
  wire [7:0]   _subsystem_cbus_auto_coupler_to_slave_named_tileresetsetter_buffer_out_a_bits_mask;	// @[PeripheryBus.scala:31:26]
  wire         _subsystem_cbus_auto_coupler_to_slave_named_tileresetsetter_buffer_out_a_bits_corrupt;	// @[PeripheryBus.scala:31:26]
  wire         _subsystem_cbus_auto_coupler_to_slave_named_tileresetsetter_buffer_out_d_ready;	// @[PeripheryBus.scala:31:26]
  wire         _subsystem_cbus_auto_coupler_to_slave_named_clockgater_buffer_out_a_valid;	// @[PeripheryBus.scala:31:26]
  wire [2:0]   _subsystem_cbus_auto_coupler_to_slave_named_clockgater_buffer_out_a_bits_opcode;	// @[PeripheryBus.scala:31:26]
  wire [2:0]   _subsystem_cbus_auto_coupler_to_slave_named_clockgater_buffer_out_a_bits_param;	// @[PeripheryBus.scala:31:26]
  wire [1:0]   _subsystem_cbus_auto_coupler_to_slave_named_clockgater_buffer_out_a_bits_size;	// @[PeripheryBus.scala:31:26]
  wire [10:0]  _subsystem_cbus_auto_coupler_to_slave_named_clockgater_buffer_out_a_bits_source;	// @[PeripheryBus.scala:31:26]
  wire [20:0]  _subsystem_cbus_auto_coupler_to_slave_named_clockgater_buffer_out_a_bits_address;	// @[PeripheryBus.scala:31:26]
  wire [7:0]   _subsystem_cbus_auto_coupler_to_slave_named_clockgater_buffer_out_a_bits_mask;	// @[PeripheryBus.scala:31:26]
  wire [63:0]  _subsystem_cbus_auto_coupler_to_slave_named_clockgater_buffer_out_a_bits_data;	// @[PeripheryBus.scala:31:26]
  wire         _subsystem_cbus_auto_coupler_to_slave_named_clockgater_buffer_out_a_bits_corrupt;	// @[PeripheryBus.scala:31:26]
  ...
  wire         _subsystem_fbus_coupler_from_port_named_serial_tl_ctrl_auto_buffer_in_a_ready;	// @[LazyModule.scala:489:27]
  wire         _subsystem_fbus_coupler_from_port_named_serial_tl_ctrl_auto_buffer_in_d_valid;	// @[LazyModule.scala:489:27]
  wire [2:0]   _subsystem_fbus_coupler_from_port_named_serial_tl_ctrl_auto_buffer_in_d_bits_opcode;	// @[LazyModule.scala:489:27]
  wire [1:0]   _subsystem_fbus_coupler_from_port_named_serial_tl_ctrl_auto_buffer_in_d_bits_param;	// @[LazyModule.scala:489:27]
  wire [3:0]   _subsystem_fbus_coupler_from_port_named_serial_tl_ctrl_auto_buffer_in_d_bits_size;	// @[LazyModule.scala:489:27]
  wire         _subsystem_fbus_coupler_from_port_named_serial_tl_ctrl_auto_buffer_in_d_bits_source;	// @[LazyModule.scala:489:27]
  wire [3:0]   _subsystem_fbus_coupler_from_port_named_serial_tl_ctrl_auto_buffer_in_d_bits_sink;	// @[LazyModule.scala:489:27]
  wire         _subsystem_fbus_coupler_from_port_named_serial_tl_ctrl_auto_buffer_in_d_bits_denied;	// @[LazyModule.scala:489:27]
  wire [63:0]  _subsystem_fbus_coupler_from_port_named_serial_tl_ctrl_auto_buffer_in_d_bits_data;	// @[LazyModule.scala:489:27]
  wire         _subsystem_fbus_coupler_from_port_named_serial_tl_ctrl_auto_buffer_in_d_bits_corrupt;	// @[LazyModule.scala:489:27]
  wire         _subsystem_fbus_coupler_from_port_named_serial_tl_ctrl_auto_tl_out_a_valid;	// @[LazyModule.scala:489:27]
  wire [2:0]   _subsystem_fbus_coupler_from_port_named_serial_tl_ctrl_auto_tl_out_a_bits_opcode;	// @[LazyModule.scala:489:27]
  wire [2:0]   _subsystem_fbus_coupler_from_port_named_serial_tl_ctrl_auto_tl_out_a_bits_param;	// @[LazyModule.scala:489:27]
  wire [3:0]   _subsystem_fbus_coupler_from_port_named_serial_tl_ctrl_auto_tl_out_a_bits_size;	// @[LazyModule.scala:489:27]
  wire         _subsystem_fbus_coupler_from_port_named_serial_tl_ctrl_auto_tl_out_a_bits_source;	// @[LazyModule.scala:489:27]
  wire [31:0]  _subsystem_fbus_coupler_from_port_named_serial_tl_ctrl_auto_tl_out_a_bits_address;	// @[LazyModule.scala:489:27]
  wire [7:0]   _subsystem_fbus_coupler_from_port_named_serial_tl_ctrl_auto_tl_out_a_bits_mask;	// @[LazyModule.scala:489:27]
  wire [63:0]  _subsystem_fbus_coupler_from_port_named_serial_tl_ctrl_auto_tl_out_a_bits_data;	// @[LazyModule.scala:489:27]
  wire         _subsystem_fbus_coupler_from_port_named_serial_tl_ctrl_auto_tl_out_a_bits_corrupt;	// @[LazyModule.scala:489:27]
  wire         _subsystem_fbus_coupler_from_port_named_serial_tl_ctrl_auto_tl_out_d_ready;	// @[LazyModule.scala:489:27]
  wire         _subsystem_fbus_buffer_auto_in_a_ready;	// @[Buffer.scala:69:28]
  wire         _subsystem_fbus_buffer_auto_in_d_valid;	// @[Buffer.scala:69:28]
  wire [2:0]   _subsystem_fbus_buffer_auto_in_d_bits_opcode;	// @[Buffer.scala:69:28]
  wire [1:0]   _subsystem_fbus_buffer_auto_in_d_bits_param;	// @[Buffer.scala:69:28]
  wire [3:0]   _subsystem_fbus_buffer_auto_in_d_bits_size;	// @[Buffer.scala:69:28]
  wire [3:0]   _subsystem_fbus_buffer_auto_in_d_bits_sink;	// @[Buffer.scala:69:28]
  wire         _subsystem_fbus_buffer_auto_in_d_bits_denied;	// @[Buffer.scala:69:28]
  wire [63:0]  _subsystem_fbus_buffer_auto_in_d_bits_data;	// @[Buffer.scala:69:28]
  wire         _subsystem_fbus_buffer_auto_in_d_bits_corrupt;	// @[Buffer.scala:69:28]
  wire         _subsystem_fbus_buffer_auto_out_a_valid;	// @[Buffer.scala:69:28]
  wire [2:0]   _subsystem_fbus_buffer_auto_out_a_bits_opcode;	// @[Buffer.scala:69:28]
  wire [2:0]   _subsystem_fbus_buffer_auto_out_a_bits_param;	// @[Buffer.scala:69:28]
  wire [3:0]   _subsystem_fbus_buffer_auto_out_a_bits_size;	// @[Buffer.scala:69:28]
  wire         _subsystem_fbus_buffer_auto_out_a_bits_source;	// @[Buffer.scala:69:28]
  wire [31:0]  _subsystem_fbus_buffer_auto_out_a_bits_address;	// @[Buffer.scala:69:28]
  wire [7:0]   _subsystem_fbus_buffer_auto_out_a_bits_mask;	// @[Buffer.scala:69:28]
  wire [63:0]  _subsystem_fbus_buffer_auto_out_a_bits_data;	// @[Buffer.scala:69:28]
  wire         _subsystem_fbus_buffer_auto_out_a_bits_corrupt;	// @[Buffer.scala:69:28]
  wire         _subsystem_fbus_buffer_auto_out_d_ready;	// @[Buffer.scala:69:28]
  wire         _subsystem_fbus_fixedClockNode_auto_out_1_clock;	// @[ClockGroup.scala:110:107]
  wire         _subsystem_fbus_fixedClockNode_auto_out_1_reset;	// @[ClockGroup.scala:110:107]
  wire         _subsystem_fbus_fixedClockNode_auto_out_0_clock;	// @[ClockGroup.scala:110:107]
  wire         _subsystem_fbus_fixedClockNode_auto_out_0_reset;	// @[ClockGroup.scala:110:107]
  ...
  wire [2:0]   _subsystem_pbus_auto_coupler_to_device_named_uart_0_control_xing_out_a_bits_param;	// @[PeripheryBus.scala:31:26]
  ...
  wire         _subsystem_pbus_auto_coupler_to_device_named_uart_0_control_xing_out_a_bits_corrupt;	// @[PeripheryBus.scala:31:26]
  ...
  wire [1:0]   _subsystem_sbus_auto_coupler_from_tile_tl_master_clock_xing_in_1_b_bits_param;	// @[SystemBus.scala:24:26]
  wire [3:0]   _subsystem_sbus_auto_coupler_from_tile_tl_master_clock_xing_in_1_b_bits_size;	// @[SystemBus.scala:24:26]
  wire [1:0]   _subsystem_sbus_auto_coupler_from_tile_tl_master_clock_xing_in_1_b_bits_source;	// @[SystemBus.scala:24:26]
  wire [31:0]  _subsystem_sbus_auto_coupler_from_tile_tl_master_clock_xing_in_1_b_bits_address;	// @[SystemBus.scala:24:26]
  ...
  wire [2:0]   _subsystem_sbus_auto_coupler_from_tile_tl_master_clock_xing_in_1_d_bits_opcode;	// @[SystemBus.scala:24:26]
  wire [1:0]   _subsystem_sbus_auto_coupler_from_tile_tl_master_clock_xing_in_1_d_bits_param;	// @[SystemBus.scala:24:26]
  wire [3:0]   _subsystem_sbus_auto_coupler_from_tile_tl_master_clock_xing_in_1_d_bits_size;	// @[SystemBus.scala:24:26]
  wire [1:0]   _subsystem_sbus_auto_coupler_from_tile_tl_master_clock_xing_in_1_d_bits_source;	// @[SystemBus.scala:24:26]
  wire [3:0]   _subsystem_sbus_auto_coupler_from_tile_tl_master_clock_xing_in_1_d_bits_sink;	// @[SystemBus.scala:24:26]
  wire         _subsystem_sbus_auto_coupler_from_tile_tl_master_clock_xing_in_1_d_bits_denied;	// @[SystemBus.scala:24:26]
  wire [127:0] _subsystem_sbus_auto_coupler_from_tile_tl_master_clock_xing_in_1_d_bits_data;	// @[SystemBus.scala:24:26]
  wire         _subsystem_sbus_auto_coupler_from_tile_tl_master_clock_xing_in_1_d_bits_corrupt;	// @[SystemBus.scala:24:26]
  ...
  wire [2:0]   _subsystem_sbus_auto_coupler_from_tile_tl_master_clock_xing_in_0_d_bits_opcode;	// @[SystemBus.scala:24:26]
  wire [1:0]   _subsystem_sbus_auto_coupler_from_tile_tl_master_clock_xing_in_0_d_bits_param;	// @[SystemBus.scala:24:26]
  wire [3:0]   _subsystem_sbus_auto_coupler_from_tile_tl_master_clock_xing_in_0_d_bits_size;	// @[SystemBus.scala:24:26]
  wire [4:0]   _subsystem_sbus_auto_coupler_from_tile_tl_master_clock_xing_in_0_d_bits_source;	// @[SystemBus.scala:24:26]
  wire [3:0]   _subsystem_sbus_auto_coupler_from_tile_tl_master_clock_xing_in_0_d_bits_sink;	// @[SystemBus.scala:24:26]
  wire         _subsystem_sbus_auto_coupler_from_tile_tl_master_clock_xing_in_0_d_bits_denied;	// @[SystemBus.scala:24:26]
  wire [127:0] _subsystem_sbus_auto_coupler_from_tile_tl_master_clock_xing_in_0_d_bits_data;	// @[SystemBus.scala:24:26]
  wire         _subsystem_sbus_auto_coupler_from_tile_tl_master_clock_xing_in_0_d_bits_corrupt;	// @[SystemBus.scala:24:26]
  ...
  wire [15:0]  _subsystem_sbus_auto_coupler_to_bus_named_subsystem_l2_widget_out_a_bits_mask;	// @[SystemBus.scala:24:26]
  wire [127:0] _subsystem_sbus_auto_coupler_to_bus_named_subsystem_l2_widget_out_a_bits_data;	// @[SystemBus.scala:24:26]
  ...
  wire [127:0] _subsystem_sbus_auto_coupler_to_bus_named_subsystem_l2_widget_out_c_bits_data;	// @[SystemBus.scala:24:26]
  ...
  wire [3:0]   _subsystem_sbus_auto_coupler_to_bus_named_subsystem_l2_widget_out_e_bits_sink;	// @[SystemBus.scala:24:26]
  ...
  wire         _subsystem_sbus_auto_coupler_from_bus_named_subsystem_fbus_bus_xing_in_d_bits_source;	// @[SystemBus.scala:24:26]
  wire [3:0]   _subsystem_sbus_auto_coupler_from_bus_named_subsystem_fbus_bus_xing_in_d_bits_sink;	// @[SystemBus.scala:24:26]
  ...
  IntXbar ibus_int_bus (	// @[InterruptBus.scala:14:27]
    .auto_int_in_0  (_intsink_4_auto_out_0),	// @[Crossing.scala:99:29]
    .auto_int_out_0 (_ibus_int_bus_auto_int_out_0)
  );
  SystemBus subsystem_sbus (	// @[SystemBus.scala:24:26]
    .auto_coupler_from_tile_tl_master_clock_xing_in_1_a_valid              (_tile_prci_domain_auto_tl_master_clock_xing_out_1_a_valid),	// @[HasTiles.scala:250:38]
    .auto_coupler_from_tile_tl_master_clock_xing_in_1_a_bits_opcode        (_tile_prci_domain_auto_tl_master_clock_xing_out_1_a_bits_opcode),	// @[HasTiles.scala:250:38]
    .auto_coupler_from_tile_tl_master_clock_xing_in_1_a_bits_param         (_tile_prci_domain_auto_tl_master_clock_xing_out_1_a_bits_param),	// @[HasTiles.scala:250:38]
    .auto_coupler_from_tile_tl_master_clock_xing_in_1_a_bits_size          (_tile_prci_domain_auto_tl_master_clock_xing_out_1_a_bits_size),	// @[HasTiles.scala:250:38]
    .auto_coupler_from_tile_tl_master_clock_xing_in_1_a_bits_source        (_tile_prci_domain_auto_tl_master_clock_xing_out_1_a_bits_source),	// @[HasTiles.scala:250:38]
    .auto_coupler_from_tile_tl_master_clock_xing_in_1_a_bits_address       (_tile_prci_domain_auto_tl_master_clock_xing_out_1_a_bits_address),	// @[HasTiles.scala:250:38]
    .auto_coupler_from_tile_tl_master_clock_xing_in_1_a_bits_mask          (_tile_prci_domain_auto_tl_master_clock_xing_out_1_a_bits_mask),	// @[HasTiles.scala:250:38]
    .auto_coupler_from_tile_tl_master_clock_xing_in_1_a_bits_data          (_tile_prci_domain_auto_tl_master_clock_xing_out_1_a_bits_data),	// @[HasTiles.scala:250:38]
    .auto_coupler_from_tile_tl_master_clock_xing_in_1_a_bits_corrupt       (_tile_prci_domain_auto_tl_master_clock_xing_out_1_a_bits_corrupt),	// @[HasTiles.scala:250:38]
    .auto_coupler_from_tile_tl_master_clock_xing_in_1_b_ready              (_tile_prci_domain_auto_tl_master_clock_xing_out_1_b_ready),	// @[HasTiles.scala:250:38]
    .auto_coupler_from_tile_tl_master_clock_xing_in_1_c_valid              (_tile_prci_domain_auto_tl_master_clock_xing_out_1_c_valid),	// @[HasTiles.scala:250:38]
    .auto_coupler_from_tile_tl_master_clock_xing_in_1_c_bits_opcode        (_tile_prci_domain_auto_tl_master_clock_xing_out_1_c_bits_opcode),	// @[HasTiles.scala:250:38]
    .auto_coupler_from_tile_tl_master_clock_xing_in_1_c_bits_param         (_tile_prci_domain_auto_tl_master_clock_xing_out_1_c_bits_param),	// @[HasTiles.scala:250:38]
    .auto_coupler_from_tile_tl_master_clock_xing_in_1_c_bits_size          (_tile_prci_domain_auto_tl_master_clock_xing_out_1_c_bits_size),	// @[HasTiles.scala:250:38]
    .auto_coupler_from_tile_tl_master_clock_xing_in_1_c_bits_source        (_tile_prci_domain_auto_tl_master_clock_xing_out_1_c_bits_source),	// @[HasTiles.scala:250:38]
    .auto_coupler_from_tile_tl_master_clock_xing_in_1_c_bits_address       (_tile_prci_domain_auto_tl_master_clock_xing_out_1_c_bits_address),	// @[HasTiles.scala:250:38]
    .auto_coupler_from_tile_tl_master_clock_xing_in_1_c_bits_data          (_tile_prci_domain_auto_tl_master_clock_xing_out_1_c_bits_data),	// @[HasTiles.scala:250:38]
    .auto_coupler_from_tile_tl_master_clock_xing_in_1_c_bits_corrupt       (_tile_prci_domain_auto_tl_master_clock_xing_out_1_c_bits_corrupt),	// @[HasTiles.scala:250:38]
    .auto_coupler_from_tile_tl_master_clock_xing_in_1_d_ready              (_tile_prci_domain_auto_tl_master_clock_xing_out_1_d_ready),	// @[HasTiles.scala:250:38]
    .auto_coupler_from_tile_tl_master_clock_xing_in_1_e_valid              (_tile_prci_domain_auto_tl_master_clock_xing_out_1_e_valid),	// @[HasTiles.scala:250:38]
    .auto_coupler_from_tile_tl_master_clock_xing_in_1_e_bits_sink          (_tile_prci_domain_auto_tl_master_clock_xing_out_1_e_bits_sink),	// @[HasTiles.scala:250:38]
    .auto_coupler_from_tile_tl_master_clock_xing_in_0_a_valid              (_tile_prci_domain_auto_tl_master_clock_xing_out_0_a_valid),	// @[HasTiles.scala:250:38]
    .auto_coupler_from_tile_tl_master_clock_xing_in_0_a_bits_opcode        (_tile_prci_domain_auto_tl_master_clock_xing_out_0_a_bits_opcode),	// @[HasTiles.scala:250:38]
    .auto_coupler_from_tile_tl_master_clock_xing_in_0_a_bits_param         (_tile_prci_domain_auto_tl_master_clock_xing_out_0_a_bits_param),	// @[HasTiles.scala:250:38]
    .auto_coupler_from_tile_tl_master_clock_xing_in_0_a_bits_size          (_tile_prci_domain_auto_tl_master_clock_xing_out_0_a_bits_size),	// @[HasTiles.scala:250:38]
    .auto_coupler_from_tile_tl_master_clock_xing_in_0_a_bits_source        (_tile_prci_domain_auto_tl_master_clock_xing_out_0_a_bits_source),	// @[HasTiles.scala:250:38]
    .auto_coupler_from_tile_tl_master_clock_xing_in_0_a_bits_address       (_tile_prci_domain_auto_tl_master_clock_xing_out_0_a_bits_address),	// @[HasTiles.scala:250:38]
    .auto_coupler_from_tile_tl_master_clock_xing_in_0_a_bits_mask          (_tile_prci_domain_auto_tl_master_clock_xing_out_0_a_bits_mask),	// @[HasTiles.scala:250:38]
    .auto_coupler_from_tile_tl_master_clock_xing_in_0_a_bits_data          (_tile_prci_domain_auto_tl_master_clock_xing_out_0_a_bits_data),	// @[HasTiles.scala:250:38]
    .auto_coupler_from_tile_tl_master_clock_xing_in_0_a_bits_corrupt       (_tile_prci_domain_auto_tl_master_clock_xing_out_0_a_bits_corrupt),	// @[HasTiles.scala:250:38]
    .auto_coupler_from_tile_tl_master_clock_xing_in_0_d_ready              (_tile_prci_domain_auto_tl_master_clock_xing_out_0_d_ready),	// @[HasTiles.scala:250:38]
    ...
    .auto_coupler_from_bus_named_subsystem_fbus_bus_xing_in_a_valid        (_subsystem_fbus_buffer_auto_out_a_valid),	// @[Buffer.scala:69:28]
    .auto_coupler_from_bus_named_subsystem_fbus_bus_xing_in_a_bits_opcode  (_subsystem_fbus_buffer_auto_out_a_bits_opcode),	// @[Buffer.scala:69:28]
    .auto_coupler_from_bus_named_subsystem_fbus_bus_xing_in_a_bits_param   (_subsystem_fbus_buffer_auto_out_a_bits_param),	// @[Buffer.scala:69:28]
    .auto_coupler_from_bus_named_subsystem_fbus_bus_xing_in_a_bits_size    (_subsystem_fbus_buffer_auto_out_a_bits_size),	// @[Buffer.scala:69:28]
    .auto_coupler_from_bus_named_subsystem_fbus_bus_xing_in_a_bits_source  (_subsystem_fbus_buffer_auto_out_a_bits_source),	// @[Buffer.scala:69:28]
    .auto_coupler_from_bus_named_subsystem_fbus_bus_xing_in_a_bits_address (_subsystem_fbus_buffer_auto_out_a_bits_address),	// @[Buffer.scala:69:28]
    .auto_coupler_from_bus_named_subsystem_fbus_bus_xing_in_a_bits_mask    (_subsystem_fbus_buffer_auto_out_a_bits_mask),	// @[Buffer.scala:69:28]
    .auto_coupler_from_bus_named_subsystem_fbus_bus_xing_in_a_bits_data    (_subsystem_fbus_buffer_auto_out_a_bits_data),	// @[Buffer.scala:69:28]
    .auto_coupler_from_bus_named_subsystem_fbus_bus_xing_in_a_bits_corrupt (_subsystem_fbus_buffer_auto_out_a_bits_corrupt),	// @[Buffer.scala:69:28]
    .auto_coupler_from_bus_named_subsystem_fbus_bus_xing_in_d_ready        (_subsystem_fbus_buffer_auto_out_d_ready),	// @[Buffer.scala:69:28]
  ...
  PeripheryBus subsystem_pbus (	// @[PeripheryBus.scala:31:26]
    .auto_coupler_to_device_named_uart_0_control_xing_out_a_ready        (_uartClockDomainWrapper_auto_uart_0_control_xing_in_a_ready),	// @[UART.scala:218:44]
    .auto_coupler_to_device_named_uart_0_control_xing_out_d_valid        (_uartClockDomainWrapper_auto_uart_0_control_xing_in_d_valid),	// @[UART.scala:218:44]
    .auto_coupler_to_device_named_uart_0_control_xing_out_d_bits_opcode  (_uartClockDomainWrapper_auto_uart_0_control_xing_in_d_bits_opcode),	// @[UART.scala:218:44]
    .auto_coupler_to_device_named_uart_0_control_xing_out_d_bits_size    (_uartClockDomainWrapper_auto_uart_0_control_xing_in_d_bits_size),	// @[UART.scala:218:44]
    .auto_coupler_to_device_named_uart_0_control_xing_out_d_bits_source  (_uartClockDomainWrapper_auto_uart_0_control_xing_in_d_bits_source),	// @[UART.scala:218:44]
    .auto_coupler_to_device_named_uart_0_control_xing_out_d_bits_data    (_uartClockDomainWrapper_auto_uart_0_control_xing_in_d_bits_data),	// @[UART.scala:218:44]
  ...
  FixedClockBroadcast_1 subsystem_fbus_fixedClockNode (	// @[ClockGroup.scala:110:107]
    .auto_in_clock    (_clockNamePrefixer_auto_clock_name_prefixer_out_2_member_subsystem_fbus_0_clock),	// @[ClockGroupNamePrefixer.scala:45:15]
    .auto_in_reset    (_clockNamePrefixer_auto_clock_name_prefixer_out_2_member_subsystem_fbus_0_reset),	// @[ClockGroupNamePrefixer.scala:45:15]
    .auto_out_1_clock (_subsystem_fbus_fixedClockNode_auto_out_1_clock),
    .auto_out_1_reset (_subsystem_fbus_fixedClockNode_auto_out_1_reset),
    .auto_out_0_clock (_subsystem_fbus_fixedClockNode_auto_out_0_clock),
    .auto_out_0_reset (_subsystem_fbus_fixedClockNode_auto_out_0_reset)
  );
  TLBuffer_3 subsystem_fbus_buffer (	// @[Buffer.scala:69:28]
    .clock                   (_subsystem_fbus_fixedClockNode_auto_out_0_clock),	// @[ClockGroup.scala:110:107]
    .reset                   (_subsystem_fbus_fixedClockNode_auto_out_0_reset),	// @[ClockGroup.scala:110:107]
    .auto_in_a_valid         (_subsystem_fbus_coupler_from_port_named_serial_tl_ctrl_auto_tl_out_a_valid),	// @[LazyModule.scala:489:27]
    .auto_in_a_bits_opcode   (_subsystem_fbus_coupler_from_port_named_serial_tl_ctrl_auto_tl_out_a_bits_opcode),	// @[LazyModule.scala:489:27]
    .auto_in_a_bits_param    (_subsystem_fbus_coupler_from_port_named_serial_tl_ctrl_auto_tl_out_a_bits_param),	// @[LazyModule.scala:489:27]
    .auto_in_a_bits_size     (_subsystem_fbus_coupler_from_port_named_serial_tl_ctrl_auto_tl_out_a_bits_size),	// @[LazyModule.scala:489:27]
    .auto_in_a_bits_source   (_subsystem_fbus_coupler_from_port_named_serial_tl_ctrl_auto_tl_out_a_bits_source),	// @[LazyModule.scala:489:27]
    .auto_in_a_bits_address  (_subsystem_fbus_coupler_from_port_named_serial_tl_ctrl_auto_tl_out_a_bits_address),	// @[LazyModule.scala:489:27]
    .auto_in_a_bits_mask     (_subsystem_fbus_coupler_from_port_named_serial_tl_ctrl_auto_tl_out_a_bits_mask),	// @[LazyModule.scala:489:27]
    .auto_in_a_bits_data     (_subsystem_fbus_coupler_from_port_named_serial_tl_ctrl_auto_tl_out_a_bits_data),	// @[LazyModule.scala:489:27]
    .auto_in_a_bits_corrupt  (_subsystem_fbus_coupler_from_port_named_serial_tl_ctrl_auto_tl_out_a_bits_corrupt),	// @[LazyModule.scala:489:27]
    .auto_in_d_ready         (_subsystem_fbus_coupler_from_port_named_serial_tl_ctrl_auto_tl_out_d_ready),	// @[LazyModule.scala:489:27]
    .auto_out_a_ready        (_subsystem_sbus_auto_coupler_from_bus_named_subsystem_fbus_bus_xing_in_a_ready),	// @[SystemBus.scala:24:26]
    .auto_out_d_valid        (_subsystem_sbus_auto_coupler_from_bus_named_subsystem_fbus_bus_xing_in_d_valid),	// @[SystemBus.scala:24:26]
    .auto_out_d_bits_opcode  (_subsystem_sbus_auto_coupler_from_bus_named_subsystem_fbus_bus_xing_in_d_bits_opcode),	// @[SystemBus.scala:24:26]
    .auto_out_d_bits_param   (_subsystem_sbus_auto_coupler_from_bus_named_subsystem_fbus_bus_xing_in_d_bits_param),	// @[SystemBus.scala:24:26]
    .auto_out_d_bits_size    (_subsystem_sbus_auto_coupler_from_bus_named_subsystem_fbus_bus_xing_in_d_bits_size),	// @[SystemBus.scala:24:26]
    .auto_out_d_bits_source  (_subsystem_sbus_auto_coupler_from_bus_named_subsystem_fbus_bus_xing_in_d_bits_source),	// @[SystemBus.scala:24:26]
    .auto_out_d_bits_sink    (_subsystem_sbus_auto_coupler_from_bus_named_subsystem_fbus_bus_xing_in_d_bits_sink),	// @[SystemBus.scala:24:26]
    .auto_out_d_bits_denied  (_subsystem_sbus_auto_coupler_from_bus_named_subsystem_fbus_bus_xing_in_d_bits_denied),	// @[SystemBus.scala:24:26]
    .auto_out_d_bits_data    (_subsystem_sbus_auto_coupler_from_bus_named_subsystem_fbus_bus_xing_in_d_bits_data),	// @[SystemBus.scala:24:26]
    .auto_out_d_bits_corrupt (_subsystem_sbus_auto_coupler_from_bus_named_subsystem_fbus_bus_xing_in_d_bits_corrupt),	// @[SystemBus.scala:24:26]
  ...
  TLInterconnectCoupler_6 subsystem_fbus_coupler_from_port_named_serial_tl_ctrl (	// @[LazyModule.scala:489:27]
    .clock                         (_subsystem_fbus_fixedClockNode_auto_out_0_clock),	// @[ClockGroup.scala:110:107]
    .reset                         (_subsystem_fbus_fixedClockNode_auto_out_0_reset),	// @[ClockGroup.scala:110:107]
    .auto_buffer_in_a_valid        (_tsi_domain_auto_serdesser_client_out_a_valid),	// @[SerialAdapter.scala:381:32]
    .auto_buffer_in_a_bits_opcode  (_tsi_domain_auto_serdesser_client_out_a_bits_opcode),	// @[SerialAdapter.scala:381:32]
    .auto_buffer_in_a_bits_param   (_tsi_domain_auto_serdesser_client_out_a_bits_param),	// @[SerialAdapter.scala:381:32]
    .auto_buffer_in_a_bits_size    (_tsi_domain_auto_serdesser_client_out_a_bits_size),	// @[SerialAdapter.scala:381:32]
    .auto_buffer_in_a_bits_source  (_tsi_domain_auto_serdesser_client_out_a_bits_source),	// @[SerialAdapter.scala:381:32]
    .auto_buffer_in_a_bits_address (_tsi_domain_auto_serdesser_client_out_a_bits_address),	// @[SerialAdapter.scala:381:32]
    .auto_buffer_in_a_bits_mask    (_tsi_domain_auto_serdesser_client_out_a_bits_mask),	// @[SerialAdapter.scala:381:32]
    .auto_buffer_in_a_bits_data    (_tsi_domain_auto_serdesser_client_out_a_bits_data),	// @[SerialAdapter.scala:381:32]
    .auto_buffer_in_a_bits_corrupt (_tsi_domain_auto_serdesser_client_out_a_bits_corrupt),	// @[SerialAdapter.scala:381:32]
    .auto_buffer_in_d_ready        (_tsi_domain_auto_serdesser_client_out_d_ready),	// @[SerialAdapter.scala:381:32]
    .auto_tl_out_a_ready           (_subsystem_fbus_buffer_auto_in_a_ready),	// @[Buffer.scala:69:28]
    .auto_tl_out_d_valid           (_subsystem_fbus_buffer_auto_in_d_valid),	// @[Buffer.scala:69:28]
    .auto_tl_out_d_bits_opcode     (_subsystem_fbus_buffer_auto_in_d_bits_opcode),	// @[Buffer.scala:69:28]
    .auto_tl_out_d_bits_param      (_subsystem_fbus_buffer_auto_in_d_bits_param),	// @[Buffer.scala:69:28]
    .auto_tl_out_d_bits_size       (_subsystem_fbus_buffer_auto_in_d_bits_size),	// @[Buffer.scala:69:28]
    .auto_tl_out_d_bits_sink       (_subsystem_fbus_buffer_auto_in_d_bits_sink),	// @[Buffer.scala:69:28]
    .auto_tl_out_d_bits_denied     (_subsystem_fbus_buffer_auto_in_d_bits_denied),	// @[Buffer.scala:69:28]
    .auto_tl_out_d_bits_data       (_subsystem_fbus_buffer_auto_in_d_bits_data),	// @[Buffer.scala:69:28]
    .auto_tl_out_d_bits_corrupt    (_subsystem_fbus_buffer_auto_in_d_bits_corrupt),	// @[Buffer.scala:69:28]
    .auto_buffer_in_a_ready        (_subsystem_fbus_coupler_from_port_named_serial_tl_ctrl_auto_buffer_in_a_ready),
    .auto_buffer_in_d_valid        (_subsystem_fbus_coupler_from_port_named_serial_tl_ctrl_auto_buffer_in_d_valid),
    .auto_buffer_in_d_bits_opcode  (_subsystem_fbus_coupler_from_port_named_serial_tl_ctrl_auto_buffer_in_d_bits_opcode),
    .auto_buffer_in_d_bits_param   (_subsystem_fbus_coupler_from_port_named_serial_tl_ctrl_auto_buffer_in_d_bits_param),
    .auto_buffer_in_d_bits_size    (_subsystem_fbus_coupler_from_port_named_serial_tl_ctrl_auto_buffer_in_d_bits_size),
    .auto_buffer_in_d_bits_source  (_subsystem_fbus_coupler_from_port_named_serial_tl_ctrl_auto_buffer_in_d_bits_source),
    .auto_buffer_in_d_bits_sink    (_subsystem_fbus_coupler_from_port_named_serial_tl_ctrl_auto_buffer_in_d_bits_sink),
    .auto_buffer_in_d_bits_denied  (_subsystem_fbus_coupler_from_port_named_serial_tl_ctrl_auto_buffer_in_d_bits_denied),
    .auto_buffer_in_d_bits_data    (_subsystem_fbus_coupler_from_port_named_serial_tl_ctrl_auto_buffer_in_d_bits_data),
    .auto_buffer_in_d_bits_corrupt (_subsystem_fbus_coupler_from_port_named_serial_tl_ctrl_auto_buffer_in_d_bits_corrupt),
    .auto_tl_out_a_valid           (_subsystem_fbus_coupler_from_port_named_serial_tl_ctrl_auto_tl_out_a_valid),
    .auto_tl_out_a_bits_opcode     (_subsystem_fbus_coupler_from_port_named_serial_tl_ctrl_auto_tl_out_a_bits_opcode),
    .auto_tl_out_a_bits_param      (_subsystem_fbus_coupler_from_port_named_serial_tl_ctrl_auto_tl_out_a_bits_param),
    .auto_tl_out_a_bits_size       (_subsystem_fbus_coupler_from_port_named_serial_tl_ctrl_auto_tl_out_a_bits_size),
    .auto_tl_out_a_bits_source     (_subsystem_fbus_coupler_from_port_named_serial_tl_ctrl_auto_tl_out_a_bits_source),
    .auto_tl_out_a_bits_address    (_subsystem_fbus_coupler_from_port_named_serial_tl_ctrl_auto_tl_out_a_bits_address),
    .auto_tl_out_a_bits_mask       (_subsystem_fbus_coupler_from_port_named_serial_tl_ctrl_auto_tl_out_a_bits_mask),
    .auto_tl_out_a_bits_data       (_subsystem_fbus_coupler_from_port_named_serial_tl_ctrl_auto_tl_out_a_bits_data),
    .auto_tl_out_a_bits_corrupt    (_subsystem_fbus_coupler_from_port_named_serial_tl_ctrl_auto_tl_out_a_bits_corrupt),
    .auto_tl_out_d_ready           (_subsystem_fbus_coupler_from_port_named_serial_tl_ctrl_auto_tl_out_d_ready)
  );
  PeripheryBus_1 subsystem_cbus (	// @[PeripheryBus.scala:31:26]
    .auto_coupler_to_slave_named_tileresetsetter_buffer_out_a_ready        (_prci_ctrl_domain_auto_tileResetSetter_tl_in_a_ready),	// @[HasChipyardPRCI.scala:36:36]
    .auto_coupler_to_slave_named_tileresetsetter_buffer_out_d_valid        (_prci_ctrl_domain_auto_tileResetSetter_tl_in_d_valid),	// @[HasChipyardPRCI.scala:36:36]
    .auto_coupler_to_slave_named_tileresetsetter_buffer_out_d_bits_opcode  (_prci_ctrl_domain_auto_tileResetSetter_tl_in_d_bits_opcode),	// @[HasChipyardPRCI.scala:36:36]
    .auto_coupler_to_slave_named_tileresetsetter_buffer_out_d_bits_size    (_prci_ctrl_domain_auto_tileResetSetter_tl_in_d_bits_size),	// @[HasChipyardPRCI.scala:36:36]
    .auto_coupler_to_slave_named_tileresetsetter_buffer_out_d_bits_source  (_prci_ctrl_domain_auto_tileResetSetter_tl_in_d_bits_source),	// @[HasChipyardPRCI.scala:36:36]
    .auto_coupler_to_slave_named_tileresetsetter_buffer_out_d_bits_data    (_prci_ctrl_domain_auto_tileResetSetter_tl_in_d_bits_data),	// @[HasChipyardPRCI.scala:36:36]
    .auto_coupler_to_slave_named_clockgater_buffer_out_a_ready             (_prci_ctrl_domain_auto_tileClockGater_tile_clock_gater_in_a_ready),	// @[HasChipyardPRCI.scala:36:36]
    .auto_coupler_to_slave_named_clockgater_buffer_out_d_valid             (_prci_ctrl_domain_auto_tileClockGater_tile_clock_gater_in_d_valid),	// @[HasChipyardPRCI.scala:36:36]
    .auto_coupler_to_slave_named_clockgater_buffer_out_d_bits_opcode       (_prci_ctrl_domain_auto_tileClockGater_tile_clock_gater_in_d_bits_opcode),	// @[HasChipyardPRCI.scala:36:36]
    .auto_coupler_to_slave_named_clockgater_buffer_out_d_bits_size         (_prci_ctrl_domain_auto_tileClockGater_tile_clock_gater_in_d_bits_size),	// @[HasChipyardPRCI.scala:36:36]
    .auto_coupler_to_slave_named_clockgater_buffer_out_d_bits_source       (_prci_ctrl_domain_auto_tileClockGater_tile_clock_gater_in_d_bits_source),	// @[HasChipyardPRCI.scala:36:36]
    .auto_coupler_to_slave_named_clockgater_buffer_out_d_bits_data         (_prci_ctrl_domain_auto_tileClockGater_tile_clock_gater_in_d_bits_data),	// @[HasChipyardPRCI.scala:36:36]
    ...
    .auto_coupler_to_debug_fragmenter_out_a_ready                          (_tlDM_auto_dmInner_dmInner_tl_in_a_ready),	// @[Periphery.scala:84:26]
    .auto_coupler_to_debug_fragmenter_out_d_valid                          (_tlDM_auto_dmInner_dmInner_tl_in_d_valid),	// @[Periphery.scala:84:26]
    .auto_coupler_to_debug_fragmenter_out_d_bits_opcode                    (_tlDM_auto_dmInner_dmInner_tl_in_d_bits_opcode),	// @[Periphery.scala:84:26]
    .auto_coupler_to_debug_fragmenter_out_d_bits_size                      (_tlDM_auto_dmInner_dmInner_tl_in_d_bits_size),	// @[Periphery.scala:84:26]
    .auto_coupler_to_debug_fragmenter_out_d_bits_source                    (_tlDM_auto_dmInner_dmInner_tl_in_d_bits_source),	// @[Periphery.scala:84:26]
    .auto_coupler_to_debug_fragmenter_out_d_bits_data                      (_tlDM_auto_dmInner_dmInner_tl_in_d_bits_data),	// @[Periphery.scala:84:26]
  ...
  MemoryBus subsystem_mbus (	// @[MemoryBus.scala:25:26]
    .auto_coupler_to_port_named_serial_tl_mem_tlserial_manager_crossing_out_a_ready        (_tsi_domain_auto_tlserial_manager_crossing_in_a_ready),	// @[SerialAdapter.scala:381:32]
    .auto_coupler_to_port_named_serial_tl_mem_tlserial_manager_crossing_out_d_valid        (_tsi_domain_auto_tlserial_manager_crossing_in_d_valid),	// @[SerialAdapter.scala:381:32]
    .auto_coupler_to_port_named_serial_tl_mem_tlserial_manager_crossing_out_d_bits_opcode  (_tsi_domain_auto_tlserial_manager_crossing_in_d_bits_opcode),	// @[SerialAdapter.scala:381:32]
    .auto_coupler_to_port_named_serial_tl_mem_tlserial_manager_crossing_out_d_bits_param   (_tsi_domain_auto_tlserial_manager_crossing_in_d_bits_param),	// @[SerialAdapter.scala:381:32]
    .auto_coupler_to_port_named_serial_tl_mem_tlserial_manager_crossing_out_d_bits_size    (_tsi_domain_auto_tlserial_manager_crossing_in_d_bits_size),	// @[SerialAdapter.scala:381:32]
    .auto_coupler_to_port_named_serial_tl_mem_tlserial_manager_crossing_out_d_bits_source  (_tsi_domain_auto_tlserial_manager_crossing_in_d_bits_source),	// @[SerialAdapter.scala:381:32]
    .auto_coupler_to_port_named_serial_tl_mem_tlserial_manager_crossing_out_d_bits_sink    (_tsi_domain_auto_tlserial_manager_crossing_in_d_bits_sink),	// @[SerialAdapter.scala:381:32]
    .auto_coupler_to_port_named_serial_tl_mem_tlserial_manager_crossing_out_d_bits_denied  (_tsi_domain_auto_tlserial_manager_crossing_in_d_bits_denied),	// @[SerialAdapter.scala:381:32]
    .auto_coupler_to_port_named_serial_tl_mem_tlserial_manager_crossing_out_d_bits_data    (_tsi_domain_auto_tlserial_manager_crossing_in_d_bits_data),	// @[SerialAdapter.scala:381:32]
    .auto_coupler_to_port_named_serial_tl_mem_tlserial_manager_crossing_out_d_bits_corrupt (_tsi_domain_auto_tlserial_manager_crossing_in_d_bits_corrupt),	// @[SerialAdapter.scala:381:32]
    ...
    .auto_coupler_to_port_named_serial_tl_mem_tlserial_manager_crossing_out_a_valid        (_subsystem_mbus_auto_coupler_to_port_named_serial_tl_mem_tlserial_manager_crossing_out_a_valid),
    .auto_coupler_to_port_named_serial_tl_mem_tlserial_manager_crossing_out_a_bits_opcode  (_subsystem_mbus_auto_coupler_to_port_named_serial_tl_mem_tlserial_manager_crossing_out_a_bits_opcode),
    .auto_coupler_to_port_named_serial_tl_mem_tlserial_manager_crossing_out_a_bits_param   (_subsystem_mbus_auto_coupler_to_port_named_serial_tl_mem_tlserial_manager_crossing_out_a_bits_param),
    .auto_coupler_to_port_named_serial_tl_mem_tlserial_manager_crossing_out_a_bits_size    (_subsystem_mbus_auto_coupler_to_port_named_serial_tl_mem_tlserial_manager_crossing_out_a_bits_size),
    .auto_coupler_to_port_named_serial_tl_mem_tlserial_manager_crossing_out_a_bits_source  (_subsystem_mbus_auto_coupler_to_port_named_serial_tl_mem_tlserial_manager_crossing_out_a_bits_source),
    .auto_coupler_to_port_named_serial_tl_mem_tlserial_manager_crossing_out_a_bits_address (_subsystem_mbus_auto_coupler_to_port_named_serial_tl_mem_tlserial_manager_crossing_out_a_bits_address),
    .auto_coupler_to_port_named_serial_tl_mem_tlserial_manager_crossing_out_a_bits_mask    (_subsystem_mbus_auto_coupler_to_port_named_serial_tl_mem_tlserial_manager_crossing_out_a_bits_mask),
    .auto_coupler_to_port_named_serial_tl_mem_tlserial_manager_crossing_out_a_bits_data    (_subsystem_mbus_auto_coupler_to_port_named_serial_tl_mem_tlserial_manager_crossing_out_a_bits_data),
    .auto_coupler_to_port_named_serial_tl_mem_tlserial_manager_crossing_out_a_bits_corrupt (_subsystem_mbus_auto_coupler_to_port_named_serial_tl_mem_tlserial_manager_crossing_out_a_bits_corrupt),
    .auto_coupler_to_port_named_serial_tl_mem_tlserial_manager_crossing_out_d_ready        (_subsystem_mbus_auto_coupler_to_port_named_serial_tl_mem_tlserial_manager_crossing_out_d_ready),
  ...
  CoherenceManagerWrapper subsystem_l2_wrapper (	// @[BankedL2Params.scala:47:31]
    ...
    .auto_coupler_to_bus_named_subsystem_mbus_bus_xing_out_d_bits_sink    (_subsystem_mbus_auto_bus_xing_in_d_bits_sink),	// @[MemoryBus.scala:25:26]
    ...
    .auto_l2_ctl_in_a_bits_param                                          (_subsystem_cbus_auto_coupler_to_l2_ctrl_buffer_out_a_bits_param),	// @[PeripheryBus.scala:31:26]
    ...
    .auto_l2_ctl_in_a_bits_corrupt                                        (_subsystem_cbus_auto_coupler_to_l2_ctrl_buffer_out_a_bits_corrupt),	// @[PeripheryBus.scala:31:26]
  ...
  TilePRCIDomain tile_prci_domain (	// @[HasTiles.scala:250:38]
    .auto_intsink_in_sync_0                         (_tlDM_auto_dmOuter_intsource_out_sync_0),	// @[Periphery.scala:84:26]
    .auto_tile_reset_domain_tile_hartid_in          (_tileHartIdNexusNode_auto_out),	// @[HasTiles.scala:158:39]
    ...
    .auto_tl_master_clock_xing_out_1_a_ready        (_subsystem_sbus_auto_coupler_from_tile_tl_master_clock_xing_in_1_a_ready),	// @[SystemBus.scala:24:26]
    .auto_tl_master_clock_xing_out_1_b_valid        (_subsystem_sbus_auto_coupler_from_tile_tl_master_clock_xing_in_1_b_valid),	// @[SystemBus.scala:24:26]
    .auto_tl_master_clock_xing_out_1_b_bits_param   (_subsystem_sbus_auto_coupler_from_tile_tl_master_clock_xing_in_1_b_bits_param),	// @[SystemBus.scala:24:26]
    .auto_tl_master_clock_xing_out_1_b_bits_size    (_subsystem_sbus_auto_coupler_from_tile_tl_master_clock_xing_in_1_b_bits_size),	// @[SystemBus.scala:24:26]
    .auto_tl_master_clock_xing_out_1_b_bits_source  (_subsystem_sbus_auto_coupler_from_tile_tl_master_clock_xing_in_1_b_bits_source),	// @[SystemBus.scala:24:26]
    .auto_tl_master_clock_xing_out_1_b_bits_address (_subsystem_sbus_auto_coupler_from_tile_tl_master_clock_xing_in_1_b_bits_address),	// @[SystemBus.scala:24:26]
    .auto_tl_master_clock_xing_out_1_c_ready        (_subsystem_sbus_auto_coupler_from_tile_tl_master_clock_xing_in_1_c_ready),	// @[SystemBus.scala:24:26]
    .auto_tl_master_clock_xing_out_1_d_valid        (_subsystem_sbus_auto_coupler_from_tile_tl_master_clock_xing_in_1_d_valid),	// @[SystemBus.scala:24:26]
    .auto_tl_master_clock_xing_out_1_d_bits_opcode  (_subsystem_sbus_auto_coupler_from_tile_tl_master_clock_xing_in_1_d_bits_opcode),	// @[SystemBus.scala:24:26]
    .auto_tl_master_clock_xing_out_1_d_bits_param   (_subsystem_sbus_auto_coupler_from_tile_tl_master_clock_xing_in_1_d_bits_param),	// @[SystemBus.scala:24:26]
    .auto_tl_master_clock_xing_out_1_d_bits_size    (_subsystem_sbus_auto_coupler_from_tile_tl_master_clock_xing_in_1_d_bits_size),	// @[SystemBus.scala:24:26]
    .auto_tl_master_clock_xing_out_1_d_bits_source  (_subsystem_sbus_auto_coupler_from_tile_tl_master_clock_xing_in_1_d_bits_source),	// @[SystemBus.scala:24:26]
    .auto_tl_master_clock_xing_out_1_d_bits_sink    (_subsystem_sbus_auto_coupler_from_tile_tl_master_clock_xing_in_1_d_bits_sink),	// @[SystemBus.scala:24:26]
    .auto_tl_master_clock_xing_out_1_d_bits_denied  (_subsystem_sbus_auto_coupler_from_tile_tl_master_clock_xing_in_1_d_bits_denied),	// @[SystemBus.scala:24:26]
    .auto_tl_master_clock_xing_out_1_d_bits_data    (_subsystem_sbus_auto_coupler_from_tile_tl_master_clock_xing_in_1_d_bits_data),	// @[SystemBus.scala:24:26]
    .auto_tl_master_clock_xing_out_1_d_bits_corrupt (_subsystem_sbus_auto_coupler_from_tile_tl_master_clock_xing_in_1_d_bits_corrupt),	// @[SystemBus.scala:24:26]
    .auto_tl_master_clock_xing_out_0_a_ready        (_subsystem_sbus_auto_coupler_from_tile_tl_master_clock_xing_in_0_a_ready),	// @[SystemBus.scala:24:26]
    .auto_tl_master_clock_xing_out_0_d_valid        (_subsystem_sbus_auto_coupler_from_tile_tl_master_clock_xing_in_0_d_valid),	// @[SystemBus.scala:24:26]
    .auto_tl_master_clock_xing_out_0_d_bits_opcode  (_subsystem_sbus_auto_coupler_from_tile_tl_master_clock_xing_in_0_d_bits_opcode),	// @[SystemBus.scala:24:26]
    .auto_tl_master_clock_xing_out_0_d_bits_param   (_subsystem_sbus_auto_coupler_from_tile_tl_master_clock_xing_in_0_d_bits_param),	// @[SystemBus.scala:24:26]
    .auto_tl_master_clock_xing_out_0_d_bits_size    (_subsystem_sbus_auto_coupler_from_tile_tl_master_clock_xing_in_0_d_bits_size),	// @[SystemBus.scala:24:26]
    .auto_tl_master_clock_xing_out_0_d_bits_source  (_subsystem_sbus_auto_coupler_from_tile_tl_master_clock_xing_in_0_d_bits_source),	// @[SystemBus.scala:24:26]
    .auto_tl_master_clock_xing_out_0_d_bits_sink    (_subsystem_sbus_auto_coupler_from_tile_tl_master_clock_xing_in_0_d_bits_sink),	// @[SystemBus.scala:24:26]
    .auto_tl_master_clock_xing_out_0_d_bits_denied  (_subsystem_sbus_auto_coupler_from_tile_tl_master_clock_xing_in_0_d_bits_denied),	// @[SystemBus.scala:24:26]
    .auto_tl_master_clock_xing_out_0_d_bits_data    (_subsystem_sbus_auto_coupler_from_tile_tl_master_clock_xing_in_0_d_bits_data),	// @[SystemBus.scala:24:26]
    .auto_tl_master_clock_xing_out_0_d_bits_corrupt (_subsystem_sbus_auto_coupler_from_tile_tl_master_clock_xing_in_0_d_bits_corrupt),	// @[SystemBus.scala:24:26]
  ...
  ClockSinkDomain plicDomainWrapper (	// @[Plic.scala:359:39]
    ...
    .auto_plic_in_a_bits_param   (_subsystem_cbus_auto_coupler_to_plic_fragmenter_out_a_bits_param),	// @[PeripheryBus.scala:31:26]
    ...
    .auto_plic_in_a_bits_corrupt (_subsystem_cbus_auto_coupler_to_plic_fragmenter_out_a_bits_corrupt),	// @[PeripheryBus.scala:31:26]
  ...
  CLINT clint (	// @[CLINT.scala:107:27]
    ...
    .auto_in_a_bits_param   (_subsystem_cbus_auto_coupler_to_clint_fragmenter_out_a_bits_param),	// @[PeripheryBus.scala:31:26]
    ...
    .auto_in_a_bits_corrupt (_subsystem_cbus_auto_coupler_to_clint_fragmenter_out_a_bits_corrupt),	// @[PeripheryBus.scala:31:26]
  ...
  TLDebugModule tlDM (	// @[Periphery.scala:84:26]
    ...
    .auto_dmInner_dmInner_tl_in_a_bits_param   (_subsystem_cbus_auto_coupler_to_debug_fragmenter_out_a_bits_param),	// @[PeripheryBus.scala:31:26]
    ...
    .auto_dmInner_dmInner_tl_in_a_bits_corrupt (_subsystem_cbus_auto_coupler_to_debug_fragmenter_out_a_bits_corrupt),	// @[PeripheryBus.scala:31:26]
    ...
    .io_dmi_dmi_req_valid                      (_dtm_io_dmi_req_valid),	// @[Periphery.scala:159:21]
    .io_dmi_dmi_req_bits_addr                  (_dtm_io_dmi_req_bits_addr),	// @[Periphery.scala:159:21]
    .io_dmi_dmi_req_bits_data                  (_dtm_io_dmi_req_bits_data),	// @[Periphery.scala:159:21]
    .io_dmi_dmi_req_bits_op                    (_dtm_io_dmi_req_bits_op),	// @[Periphery.scala:159:21]
    .io_dmi_dmi_resp_ready                     (_dtm_io_dmi_resp_ready),	// @[Periphery.scala:159:21]
  ...
  IntXbar xbar (	// @[Xbar.scala:30:26]
    .auto_int_in_0  (_intsink_1_auto_out_0),	// @[Crossing.scala:99:29]
    .auto_int_out_0 (_xbar_auto_int_out_0)
  );
  IntXbar xbar_1 (	// @[Xbar.scala:30:26]
    .auto_int_in_0  (_intsink_2_auto_out_0),	// @[Crossing.scala:99:29]
    .auto_int_out_0 (_xbar_1_auto_int_out_0)
  );
  IntXbar xbar_2 (	// @[Xbar.scala:30:26]
    .auto_int_in_0  (_intsink_3_auto_out_0),	// @[Crossing.scala:99:29]
    .auto_int_out_0 (_xbar_2_auto_int_out_0)
  );
  ...
  ClockSinkDomain_1 bootROMDomainWrapper (	// @[BootROM.scala:72:42]
    ...
    .auto_bootrom_in_a_bits_opcode  (_subsystem_cbus_auto_coupler_to_bootrom_fragmenter_out_a_bits_opcode),	// @[PeripheryBus.scala:31:26]
    .auto_bootrom_in_a_bits_param   (_subsystem_cbus_auto_coupler_to_bootrom_fragmenter_out_a_bits_param),	// @[PeripheryBus.scala:31:26]
    ...
    .auto_bootrom_in_a_bits_mask    (_subsystem_cbus_auto_coupler_to_bootrom_fragmenter_out_a_bits_mask),	// @[PeripheryBus.scala:31:26]
    .auto_bootrom_in_a_bits_corrupt (_subsystem_cbus_auto_coupler_to_bootrom_fragmenter_out_a_bits_corrupt),	// @[PeripheryBus.scala:31:26]
  ...
  ClockSinkDomain_2 tsi_domain (	// @[SerialAdapter.scala:381:32]
    .auto_serdesser_client_out_a_ready                (_subsystem_fbus_coupler_from_port_named_serial_tl_ctrl_auto_buffer_in_a_ready),	// @[LazyModule.scala:489:27]
    .auto_serdesser_client_out_d_valid                (_subsystem_fbus_coupler_from_port_named_serial_tl_ctrl_auto_buffer_in_d_valid),	// @[LazyModule.scala:489:27]
    .auto_serdesser_client_out_d_bits_opcode          (_subsystem_fbus_coupler_from_port_named_serial_tl_ctrl_auto_buffer_in_d_bits_opcode),	// @[LazyModule.scala:489:27]
    .auto_serdesser_client_out_d_bits_param           (_subsystem_fbus_coupler_from_port_named_serial_tl_ctrl_auto_buffer_in_d_bits_param),	// @[LazyModule.scala:489:27]
    .auto_serdesser_client_out_d_bits_size            (_subsystem_fbus_coupler_from_port_named_serial_tl_ctrl_auto_buffer_in_d_bits_size),	// @[LazyModule.scala:489:27]
    .auto_serdesser_client_out_d_bits_source          (_subsystem_fbus_coupler_from_port_named_serial_tl_ctrl_auto_buffer_in_d_bits_source),	// @[LazyModule.scala:489:27]
    .auto_serdesser_client_out_d_bits_sink            (_subsystem_fbus_coupler_from_port_named_serial_tl_ctrl_auto_buffer_in_d_bits_sink),	// @[LazyModule.scala:489:27]
    .auto_serdesser_client_out_d_bits_denied          (_subsystem_fbus_coupler_from_port_named_serial_tl_ctrl_auto_buffer_in_d_bits_denied),	// @[LazyModule.scala:489:27]
    .auto_serdesser_client_out_d_bits_data            (_subsystem_fbus_coupler_from_port_named_serial_tl_ctrl_auto_buffer_in_d_bits_data),	// @[LazyModule.scala:489:27]
    .auto_serdesser_client_out_d_bits_corrupt         (_subsystem_fbus_coupler_from_port_named_serial_tl_ctrl_auto_buffer_in_d_bits_corrupt),	// @[LazyModule.scala:489:27]
    .auto_tlserial_manager_crossing_in_a_valid        (_subsystem_mbus_auto_coupler_to_port_named_serial_tl_mem_tlserial_manager_crossing_out_a_valid),	// @[MemoryBus.scala:25:26]
    .auto_tlserial_manager_crossing_in_a_bits_opcode  (_subsystem_mbus_auto_coupler_to_port_named_serial_tl_mem_tlserial_manager_crossing_out_a_bits_opcode),	// @[MemoryBus.scala:25:26]
    .auto_tlserial_manager_crossing_in_a_bits_param   (_subsystem_mbus_auto_coupler_to_port_named_serial_tl_mem_tlserial_manager_crossing_out_a_bits_param),	// @[MemoryBus.scala:25:26]
    .auto_tlserial_manager_crossing_in_a_bits_size    (_subsystem_mbus_auto_coupler_to_port_named_serial_tl_mem_tlserial_manager_crossing_out_a_bits_size),	// @[MemoryBus.scala:25:26]
    .auto_tlserial_manager_crossing_in_a_bits_source  (_subsystem_mbus_auto_coupler_to_port_named_serial_tl_mem_tlserial_manager_crossing_out_a_bits_source),	// @[MemoryBus.scala:25:26]
    .auto_tlserial_manager_crossing_in_a_bits_address (_subsystem_mbus_auto_coupler_to_port_named_serial_tl_mem_tlserial_manager_crossing_out_a_bits_address),	// @[MemoryBus.scala:25:26]
    .auto_tlserial_manager_crossing_in_a_bits_mask    (_subsystem_mbus_auto_coupler_to_port_named_serial_tl_mem_tlserial_manager_crossing_out_a_bits_mask),	// @[MemoryBus.scala:25:26]
    .auto_tlserial_manager_crossing_in_a_bits_data    (_subsystem_mbus_auto_coupler_to_port_named_serial_tl_mem_tlserial_manager_crossing_out_a_bits_data),	// @[MemoryBus.scala:25:26]
    .auto_tlserial_manager_crossing_in_a_bits_corrupt (_subsystem_mbus_auto_coupler_to_port_named_serial_tl_mem_tlserial_manager_crossing_out_a_bits_corrupt),	// @[MemoryBus.scala:25:26]
    .auto_tlserial_manager_crossing_in_d_ready        (_subsystem_mbus_auto_coupler_to_port_named_serial_tl_mem_tlserial_manager_crossing_out_d_ready),	// @[MemoryBus.scala:25:26]
    .auto_clock_in_clock                              (_subsystem_fbus_fixedClockNode_auto_out_1_clock),	// @[ClockGroup.scala:110:107]
    .auto_clock_in_reset                              (_subsystem_fbus_fixedClockNode_auto_out_1_reset),	// @[ClockGroup.scala:110:107]
    ...
    .auto_serdesser_client_out_a_valid                (_tsi_domain_auto_serdesser_client_out_a_valid),
    .auto_serdesser_client_out_a_bits_opcode          (_tsi_domain_auto_serdesser_client_out_a_bits_opcode),
    .auto_serdesser_client_out_a_bits_param           (_tsi_domain_auto_serdesser_client_out_a_bits_param),
    .auto_serdesser_client_out_a_bits_size            (_tsi_domain_auto_serdesser_client_out_a_bits_size),
    .auto_serdesser_client_out_a_bits_source          (_tsi_domain_auto_serdesser_client_out_a_bits_source),
    .auto_serdesser_client_out_a_bits_address         (_tsi_domain_auto_serdesser_client_out_a_bits_address),
    .auto_serdesser_client_out_a_bits_mask            (_tsi_domain_auto_serdesser_client_out_a_bits_mask),
    .auto_serdesser_client_out_a_bits_data            (_tsi_domain_auto_serdesser_client_out_a_bits_data),
    .auto_serdesser_client_out_a_bits_corrupt         (_tsi_domain_auto_serdesser_client_out_a_bits_corrupt),
    .auto_serdesser_client_out_d_ready                (_tsi_domain_auto_serdesser_client_out_d_ready),
    .auto_tlserial_manager_crossing_in_a_ready        (_tsi_domain_auto_tlserial_manager_crossing_in_a_ready),
    .auto_tlserial_manager_crossing_in_d_valid        (_tsi_domain_auto_tlserial_manager_crossing_in_d_valid),
    .auto_tlserial_manager_crossing_in_d_bits_opcode  (_tsi_domain_auto_tlserial_manager_crossing_in_d_bits_opcode),
    .auto_tlserial_manager_crossing_in_d_bits_param   (_tsi_domain_auto_tlserial_manager_crossing_in_d_bits_param),
    .auto_tlserial_manager_crossing_in_d_bits_size    (_tsi_domain_auto_tlserial_manager_crossing_in_d_bits_size),
    .auto_tlserial_manager_crossing_in_d_bits_source  (_tsi_domain_auto_tlserial_manager_crossing_in_d_bits_source),
    .auto_tlserial_manager_crossing_in_d_bits_sink    (_tsi_domain_auto_tlserial_manager_crossing_in_d_bits_sink),
    .auto_tlserial_manager_crossing_in_d_bits_denied  (_tsi_domain_auto_tlserial_manager_crossing_in_d_bits_denied),
    .auto_tlserial_manager_crossing_in_d_bits_data    (_tsi_domain_auto_tlserial_manager_crossing_in_d_bits_data),
    .auto_tlserial_manager_crossing_in_d_bits_corrupt (_tsi_domain_auto_tlserial_manager_crossing_in_d_bits_corrupt),
  ...
  ClockSinkDomain_3 uartClockDomainWrapper (	// @[UART.scala:218:44]
    ...
    .auto_uart_0_control_xing_in_a_bits_param   (_subsystem_pbus_auto_coupler_to_device_named_uart_0_control_xing_out_a_bits_param),	// @[PeripheryBus.scala:31:26]
    ...
    .auto_uart_0_control_xing_in_a_bits_corrupt (_subsystem_pbus_auto_coupler_to_device_named_uart_0_control_xing_out_a_bits_corrupt),	// @[PeripheryBus.scala:31:26]
  ...
  IntSyncSyncCrossingSink_1 intsink_4 (	// @[Crossing.scala:99:29]
    .auto_in_sync_0 (_uartClockDomainWrapper_auto_uart_0_int_xing_out_sync_0),	// @[UART.scala:218:44]
  ...
  ClockSinkDomain_4 prci_ctrl_domain (	// @[HasChipyardPRCI.scala:36:36]
    ...
    .auto_tileResetSetter_clock_in_member_allClocks_subsystem_mbus_0_clock            (auto_prci_ctrl_domain_tileResetSetter_clock_in_member_allClocks_subsystem_mbus_0_clock),
    .auto_tileResetSetter_clock_in_member_allClocks_subsystem_mbus_0_reset            (auto_prci_ctrl_domain_tileResetSetter_clock_in_member_allClocks_subsystem_mbus_0_reset),
    ...
    .auto_tileResetSetter_clock_in_member_allClocks_subsystem_sbus_1_clock            (auto_prci_ctrl_domain_tileResetSetter_clock_in_member_allClocks_subsystem_sbus_1_clock),
    .auto_tileResetSetter_clock_in_member_allClocks_subsystem_sbus_1_reset            (auto_prci_ctrl_domain_tileResetSetter_clock_in_member_allClocks_subsystem_sbus_1_reset),
    ...
    .auto_tileResetSetter_tl_in_a_valid                                               (_subsystem_cbus_auto_coupler_to_slave_named_tileresetsetter_buffer_out_a_valid),	// @[PeripheryBus.scala:31:26]
    .auto_tileResetSetter_tl_in_a_bits_opcode                                         (_subsystem_cbus_auto_coupler_to_slave_named_tileresetsetter_buffer_out_a_bits_opcode),	// @[PeripheryBus.scala:31:26]
    .auto_tileResetSetter_tl_in_a_bits_param                                          (_subsystem_cbus_auto_coupler_to_slave_named_tileresetsetter_buffer_out_a_bits_param),	// @[PeripheryBus.scala:31:26]
    .auto_tileResetSetter_tl_in_a_bits_size                                           (_subsystem_cbus_auto_coupler_to_slave_named_tileresetsetter_buffer_out_a_bits_size),	// @[PeripheryBus.scala:31:26]
    .auto_tileResetSetter_tl_in_a_bits_source                                         (_subsystem_cbus_auto_coupler_to_slave_named_tileresetsetter_buffer_out_a_bits_source),	// @[PeripheryBus.scala:31:26]
    .auto_tileResetSetter_tl_in_a_bits_address                                        (_subsystem_cbus_auto_coupler_to_slave_named_tileresetsetter_buffer_out_a_bits_address),	// @[PeripheryBus.scala:31:26]
    .auto_tileResetSetter_tl_in_a_bits_mask                                           (_subsystem_cbus_auto_coupler_to_slave_named_tileresetsetter_buffer_out_a_bits_mask),	// @[PeripheryBus.scala:31:26]
    .auto_tileResetSetter_tl_in_a_bits_corrupt                                        (_subsystem_cbus_auto_coupler_to_slave_named_tileresetsetter_buffer_out_a_bits_corrupt),	// @[PeripheryBus.scala:31:26]
    .auto_tileResetSetter_tl_in_d_ready                                               (_subsystem_cbus_auto_coupler_to_slave_named_tileresetsetter_buffer_out_d_ready),	// @[PeripheryBus.scala:31:26]
    .auto_tileClockGater_tile_clock_gater_in_a_valid                                  (_subsystem_cbus_auto_coupler_to_slave_named_clockgater_buffer_out_a_valid),	// @[PeripheryBus.scala:31:26]
    .auto_tileClockGater_tile_clock_gater_in_a_bits_opcode                            (_subsystem_cbus_auto_coupler_to_slave_named_clockgater_buffer_out_a_bits_opcode),	// @[PeripheryBus.scala:31:26]
    .auto_tileClockGater_tile_clock_gater_in_a_bits_param                             (_subsystem_cbus_auto_coupler_to_slave_named_clockgater_buffer_out_a_bits_param),	// @[PeripheryBus.scala:31:26]
    .auto_tileClockGater_tile_clock_gater_in_a_bits_size                              (_subsystem_cbus_auto_coupler_to_slave_named_clockgater_buffer_out_a_bits_size),	// @[PeripheryBus.scala:31:26]
    .auto_tileClockGater_tile_clock_gater_in_a_bits_source                            (_subsystem_cbus_auto_coupler_to_slave_named_clockgater_buffer_out_a_bits_source),	// @[PeripheryBus.scala:31:26]
    .auto_tileClockGater_tile_clock_gater_in_a_bits_address                           (_subsystem_cbus_auto_coupler_to_slave_named_clockgater_buffer_out_a_bits_address),	// @[PeripheryBus.scala:31:26]
    .auto_tileClockGater_tile_clock_gater_in_a_bits_mask                              (_subsystem_cbus_auto_coupler_to_slave_named_clockgater_buffer_out_a_bits_mask),	// @[PeripheryBus.scala:31:26]
    .auto_tileClockGater_tile_clock_gater_in_a_bits_data                              (_subsystem_cbus_auto_coupler_to_slave_named_clockgater_buffer_out_a_bits_data),	// @[PeripheryBus.scala:31:26]
    .auto_tileClockGater_tile_clock_gater_in_a_bits_corrupt                           (_subsystem_cbus_auto_coupler_to_slave_named_clockgater_buffer_out_a_bits_corrupt),	// @[PeripheryBus.scala:31:26]
    .auto_tileClockGater_tile_clock_gater_in_d_ready                                  (_subsystem_cbus_auto_coupler_to_slave_named_clockgater_buffer_out_d_ready),	// @[PeripheryBus.scala:31:26]
    ...
    .auto_tileClockGater_tile_clock_gater_out_member_allClocks_subsystem_mbus_0_clock (_prci_ctrl_domain_auto_tileClockGater_tile_clock_gater_out_member_allClocks_subsystem_mbus_0_clock),
    .auto_tileClockGater_tile_clock_gater_out_member_allClocks_subsystem_mbus_0_reset (_prci_ctrl_domain_auto_tileClockGater_tile_clock_gater_out_member_allClocks_subsystem_mbus_0_reset),
    ...
    .auto_tileClockGater_tile_clock_gater_out_member_allClocks_subsystem_sbus_1_clock (_prci_ctrl_domain_auto_tileClockGater_tile_clock_gater_out_member_allClocks_subsystem_sbus_1_clock),
    .auto_tileClockGater_tile_clock_gater_out_member_allClocks_subsystem_sbus_1_reset (_prci_ctrl_domain_auto_tileClockGater_tile_clock_gater_out_member_allClocks_subsystem_sbus_1_reset),
  ...
  ClockGroupAggregator_6 aggregator (	// @[HasChipyardPRCI.scala:40:30]
  ...
  ClockGroupParameterModifier clockNamePrefixer (	// @[ClockGroupNamePrefixer.scala:45:15]
    .auto_clock_name_prefixer_in_4_member_subsystem_cbus_subsystem_cbus_0_clock (_aggregator_auto_out_4_member_subsystem_cbus_subsystem_cbus_0_clock),	// @[HasChipyardPRCI.scala:40:30]
    .auto_clock_name_prefixer_in_4_member_subsystem_cbus_subsystem_cbus_0_reset (_aggregator_auto_out_4_member_subsystem_cbus_subsystem_cbus_0_reset),	// @[HasChipyardPRCI.scala:40:30]
    .auto_clock_name_prefixer_in_3_member_subsystem_mbus_subsystem_mbus_0_clock (_aggregator_auto_out_3_member_subsystem_mbus_subsystem_mbus_0_clock),	// @[HasChipyardPRCI.scala:40:30]
    .auto_clock_name_prefixer_in_3_member_subsystem_mbus_subsystem_mbus_0_reset (_aggregator_auto_out_3_member_subsystem_mbus_subsystem_mbus_0_reset),	// @[HasChipyardPRCI.scala:40:30]
    .auto_clock_name_prefixer_in_2_member_subsystem_fbus_subsystem_fbus_0_clock (_aggregator_auto_out_2_member_subsystem_fbus_subsystem_fbus_0_clock),	// @[HasChipyardPRCI.scala:40:30]
    .auto_clock_name_prefixer_in_2_member_subsystem_fbus_subsystem_fbus_0_reset (_aggregator_auto_out_2_member_subsystem_fbus_subsystem_fbus_0_reset),	// @[HasChipyardPRCI.scala:40:30]
    .auto_clock_name_prefixer_in_1_member_subsystem_pbus_subsystem_pbus_0_clock (_aggregator_auto_out_1_member_subsystem_pbus_subsystem_pbus_0_clock),	// @[HasChipyardPRCI.scala:40:30]
    .auto_clock_name_prefixer_in_1_member_subsystem_pbus_subsystem_pbus_0_reset (_aggregator_auto_out_1_member_subsystem_pbus_subsystem_pbus_0_reset),	// @[HasChipyardPRCI.scala:40:30]
    .auto_clock_name_prefixer_in_0_member_subsystem_sbus_subsystem_sbus_1_clock (_aggregator_auto_out_0_member_subsystem_sbus_subsystem_sbus_1_clock),	// @[HasChipyardPRCI.scala:40:30]
    .auto_clock_name_prefixer_in_0_member_subsystem_sbus_subsystem_sbus_1_reset (_aggregator_auto_out_0_member_subsystem_sbus_subsystem_sbus_1_reset),	// @[HasChipyardPRCI.scala:40:30]
    .auto_clock_name_prefixer_in_0_member_subsystem_sbus_subsystem_sbus_0_clock (_aggregator_auto_out_0_member_subsystem_sbus_subsystem_sbus_0_clock),	// @[HasChipyardPRCI.scala:40:30]
    .auto_clock_name_prefixer_in_0_member_subsystem_sbus_subsystem_sbus_0_reset (_aggregator_auto_out_0_member_subsystem_sbus_subsystem_sbus_0_reset),	// @[HasChipyardPRCI.scala:40:30]
  ...
  ClockGroupParameterModifier_1 frequencySpecifier (	// @[ClockGroupNamePrefixer.scala:81:15]
    .auto_frequency_specifier_in_member_allClocks_implicit_clock_clock    (_clockGroupCombiner_auto_frequency_specifier_out_member_allClocks_implicit_clock_clock),	// @[ClockGroupCombiner.scala:19:15]
    .auto_frequency_specifier_in_member_allClocks_implicit_clock_reset    (_clockGroupCombiner_auto_frequency_specifier_out_member_allClocks_implicit_clock_reset),	// @[ClockGroupCombiner.scala:19:15]
    .auto_frequency_specifier_in_member_allClocks_subsystem_cbus_0_clock  (_clockGroupCombiner_auto_frequency_specifier_out_member_allClocks_subsystem_cbus_0_clock),	// @[ClockGroupCombiner.scala:19:15]
    .auto_frequency_specifier_in_member_allClocks_subsystem_cbus_0_reset  (_clockGroupCombiner_auto_frequency_specifier_out_member_allClocks_subsystem_cbus_0_reset),	// @[ClockGroupCombiner.scala:19:15]
    .auto_frequency_specifier_in_member_allClocks_subsystem_mbus_0_clock  (_clockGroupCombiner_auto_frequency_specifier_out_member_allClocks_subsystem_mbus_0_clock),	// @[ClockGroupCombiner.scala:19:15]
    .auto_frequency_specifier_in_member_allClocks_subsystem_mbus_0_reset  (_clockGroupCombiner_auto_frequency_specifier_out_member_allClocks_subsystem_mbus_0_reset),	// @[ClockGroupCombiner.scala:19:15]
    .auto_frequency_specifier_in_member_allClocks_subsystem_fbus_0_clock  (_clockGroupCombiner_auto_frequency_specifier_out_member_allClocks_subsystem_fbus_0_clock),	// @[ClockGroupCombiner.scala:19:15]
    .auto_frequency_specifier_in_member_allClocks_subsystem_fbus_0_reset  (_clockGroupCombiner_auto_frequency_specifier_out_member_allClocks_subsystem_fbus_0_reset),	// @[ClockGroupCombiner.scala:19:15]
    .auto_frequency_specifier_in_member_allClocks_subsystem_pbus_0_clock  (_clockGroupCombiner_auto_frequency_specifier_out_member_allClocks_subsystem_pbus_0_clock),	// @[ClockGroupCombiner.scala:19:15]
    .auto_frequency_specifier_in_member_allClocks_subsystem_pbus_0_reset  (_clockGroupCombiner_auto_frequency_specifier_out_member_allClocks_subsystem_pbus_0_reset),	// @[ClockGroupCombiner.scala:19:15]
    .auto_frequency_specifier_in_member_allClocks_subsystem_sbus_1_clock  (_clockGroupCombiner_auto_frequency_specifier_out_member_allClocks_subsystem_sbus_1_clock),	// @[ClockGroupCombiner.scala:19:15]
    .auto_frequency_specifier_in_member_allClocks_subsystem_sbus_1_reset  (_clockGroupCombiner_auto_frequency_specifier_out_member_allClocks_subsystem_sbus_1_reset),	// @[ClockGroupCombiner.scala:19:15]
    .auto_frequency_specifier_in_member_allClocks_subsystem_sbus_0_clock  (_clockGroupCombiner_auto_frequency_specifier_out_member_allClocks_subsystem_sbus_0_clock),	// @[ClockGroupCombiner.scala:19:15]
    .auto_frequency_specifier_in_member_allClocks_subsystem_sbus_0_reset  (_clockGroupCombiner_auto_frequency_specifier_out_member_allClocks_subsystem_sbus_0_reset),	// @[ClockGroupCombiner.scala:19:15]
  ...
  ClockGroupParameterModifier_1 clockGroupCombiner (	// @[ClockGroupCombiner.scala:19:15]
    .auto_frequency_specifier_in_member_allClocks_implicit_clock_clock    (_resetSynchronizer_auto_out_member_allClocks_implicit_clock_clock),	// @[ResetSynchronizer.scala:44:69]
    .auto_frequency_specifier_in_member_allClocks_implicit_clock_reset    (_resetSynchronizer_auto_out_member_allClocks_implicit_clock_reset),	// @[ResetSynchronizer.scala:44:69]
    .auto_frequency_specifier_in_member_allClocks_subsystem_cbus_0_clock  (_resetSynchronizer_auto_out_member_allClocks_subsystem_cbus_0_clock),	// @[ResetSynchronizer.scala:44:69]
    .auto_frequency_specifier_in_member_allClocks_subsystem_cbus_0_reset  (_resetSynchronizer_auto_out_member_allClocks_subsystem_cbus_0_reset),	// @[ResetSynchronizer.scala:44:69]
    .auto_frequency_specifier_in_member_allClocks_subsystem_mbus_0_clock  (_resetSynchronizer_auto_out_member_allClocks_subsystem_mbus_0_clock),	// @[ResetSynchronizer.scala:44:69]
    .auto_frequency_specifier_in_member_allClocks_subsystem_mbus_0_reset  (_resetSynchronizer_auto_out_member_allClocks_subsystem_mbus_0_reset),	// @[ResetSynchronizer.scala:44:69]
    .auto_frequency_specifier_in_member_allClocks_subsystem_fbus_0_clock  (_resetSynchronizer_auto_out_member_allClocks_subsystem_fbus_0_clock),	// @[ResetSynchronizer.scala:44:69]
    .auto_frequency_specifier_in_member_allClocks_subsystem_fbus_0_reset  (_resetSynchronizer_auto_out_member_allClocks_subsystem_fbus_0_reset),	// @[ResetSynchronizer.scala:44:69]
    .auto_frequency_specifier_in_member_allClocks_subsystem_pbus_0_clock  (_resetSynchronizer_auto_out_member_allClocks_subsystem_pbus_0_clock),	// @[ResetSynchronizer.scala:44:69]
    .auto_frequency_specifier_in_member_allClocks_subsystem_pbus_0_reset  (_resetSynchronizer_auto_out_member_allClocks_subsystem_pbus_0_reset),	// @[ResetSynchronizer.scala:44:69]
    .auto_frequency_specifier_in_member_allClocks_subsystem_sbus_1_clock  (_resetSynchronizer_auto_out_member_allClocks_subsystem_sbus_1_clock),	// @[ResetSynchronizer.scala:44:69]
    .auto_frequency_specifier_in_member_allClocks_subsystem_sbus_1_reset  (_resetSynchronizer_auto_out_member_allClocks_subsystem_sbus_1_reset),	// @[ResetSynchronizer.scala:44:69]
    .auto_frequency_specifier_in_member_allClocks_subsystem_sbus_0_clock  (_resetSynchronizer_auto_out_member_allClocks_subsystem_sbus_0_clock),	// @[ResetSynchronizer.scala:44:69]
    .auto_frequency_specifier_in_member_allClocks_subsystem_sbus_0_reset  (_resetSynchronizer_auto_out_member_allClocks_subsystem_sbus_0_reset),	// @[ResetSynchronizer.scala:44:69]
    .auto_frequency_specifier_out_member_allClocks_implicit_clock_clock   (_clockGroupCombiner_auto_frequency_specifier_out_member_allClocks_implicit_clock_clock),
    .auto_frequency_specifier_out_member_allClocks_implicit_clock_reset   (_clockGroupCombiner_auto_frequency_specifier_out_member_allClocks_implicit_clock_reset),
    .auto_frequency_specifier_out_member_allClocks_subsystem_cbus_0_clock (_clockGroupCombiner_auto_frequency_specifier_out_member_allClocks_subsystem_cbus_0_clock),
    .auto_frequency_specifier_out_member_allClocks_subsystem_cbus_0_reset (_clockGroupCombiner_auto_frequency_specifier_out_member_allClocks_subsystem_cbus_0_reset),
    .auto_frequency_specifier_out_member_allClocks_subsystem_mbus_0_clock (_clockGroupCombiner_auto_frequency_specifier_out_member_allClocks_subsystem_mbus_0_clock),
    .auto_frequency_specifier_out_member_allClocks_subsystem_mbus_0_reset (_clockGroupCombiner_auto_frequency_specifier_out_member_allClocks_subsystem_mbus_0_reset),
    .auto_frequency_specifier_out_member_allClocks_subsystem_fbus_0_clock (_clockGroupCombiner_auto_frequency_specifier_out_member_allClocks_subsystem_fbus_0_clock),
    .auto_frequency_specifier_out_member_allClocks_subsystem_fbus_0_reset (_clockGroupCombiner_auto_frequency_specifier_out_member_allClocks_subsystem_fbus_0_reset),
    .auto_frequency_specifier_out_member_allClocks_subsystem_pbus_0_clock (_clockGroupCombiner_auto_frequency_specifier_out_member_allClocks_subsystem_pbus_0_clock),
    .auto_frequency_specifier_out_member_allClocks_subsystem_pbus_0_reset (_clockGroupCombiner_auto_frequency_specifier_out_member_allClocks_subsystem_pbus_0_reset),
    .auto_frequency_specifier_out_member_allClocks_subsystem_sbus_1_clock (_clockGroupCombiner_auto_frequency_specifier_out_member_allClocks_subsystem_sbus_1_clock),
    .auto_frequency_specifier_out_member_allClocks_subsystem_sbus_1_reset (_clockGroupCombiner_auto_frequency_specifier_out_member_allClocks_subsystem_sbus_1_reset),
    .auto_frequency_specifier_out_member_allClocks_subsystem_sbus_0_clock (_clockGroupCombiner_auto_frequency_specifier_out_member_allClocks_subsystem_sbus_0_clock),
    .auto_frequency_specifier_out_member_allClocks_subsystem_sbus_0_reset (_clockGroupCombiner_auto_frequency_specifier_out_member_allClocks_subsystem_sbus_0_reset)
  );
  ClockGroupResetSynchronizer resetSynchronizer (	// @[ResetSynchronizer.scala:44:69]
    .auto_in_member_allClocks_implicit_clock_clock    (_prci_ctrl_domain_auto_tileClockGater_tile_clock_gater_out_member_allClocks_implicit_clock_clock),	// @[HasChipyardPRCI.scala:36:36]
    .auto_in_member_allClocks_implicit_clock_reset    (_prci_ctrl_domain_auto_tileClockGater_tile_clock_gater_out_member_allClocks_implicit_clock_reset),	// @[HasChipyardPRCI.scala:36:36]
    .auto_in_member_allClocks_subsystem_cbus_0_clock  (_prci_ctrl_domain_auto_tileClockGater_tile_clock_gater_out_member_allClocks_subsystem_cbus_0_clock),	// @[HasChipyardPRCI.scala:36:36]
    .auto_in_member_allClocks_subsystem_cbus_0_reset  (_prci_ctrl_domain_auto_tileClockGater_tile_clock_gater_out_member_allClocks_subsystem_cbus_0_reset),	// @[HasChipyardPRCI.scala:36:36]
    .auto_in_member_allClocks_subsystem_mbus_0_clock  (_prci_ctrl_domain_auto_tileClockGater_tile_clock_gater_out_member_allClocks_subsystem_mbus_0_clock),	// @[HasChipyardPRCI.scala:36:36]
    .auto_in_member_allClocks_subsystem_mbus_0_reset  (_prci_ctrl_domain_auto_tileClockGater_tile_clock_gater_out_member_allClocks_subsystem_mbus_0_reset),	// @[HasChipyardPRCI.scala:36:36]
    .auto_in_member_allClocks_subsystem_fbus_0_clock  (_prci_ctrl_domain_auto_tileClockGater_tile_clock_gater_out_member_allClocks_subsystem_fbus_0_clock),	// @[HasChipyardPRCI.scala:36:36]
    .auto_in_member_allClocks_subsystem_fbus_0_reset  (_prci_ctrl_domain_auto_tileClockGater_tile_clock_gater_out_member_allClocks_subsystem_fbus_0_reset),	// @[HasChipyardPRCI.scala:36:36]
    .auto_in_member_allClocks_subsystem_pbus_0_clock  (_prci_ctrl_domain_auto_tileClockGater_tile_clock_gater_out_member_allClocks_subsystem_pbus_0_clock),	// @[HasChipyardPRCI.scala:36:36]
    .auto_in_member_allClocks_subsystem_pbus_0_reset  (_prci_ctrl_domain_auto_tileClockGater_tile_clock_gater_out_member_allClocks_subsystem_pbus_0_reset),	// @[HasChipyardPRCI.scala:36:36]
    .auto_in_member_allClocks_subsystem_sbus_1_clock  (_prci_ctrl_domain_auto_tileClockGater_tile_clock_gater_out_member_allClocks_subsystem_sbus_1_clock),	// @[HasChipyardPRCI.scala:36:36]
    .auto_in_member_allClocks_subsystem_sbus_1_reset  (_prci_ctrl_domain_auto_tileClockGater_tile_clock_gater_out_member_allClocks_subsystem_sbus_1_reset),	// @[HasChipyardPRCI.scala:36:36]
    .auto_in_member_allClocks_subsystem_sbus_0_clock  (_prci_ctrl_domain_auto_tileClockGater_tile_clock_gater_out_member_allClocks_subsystem_sbus_0_clock),	// @[HasChipyardPRCI.scala:36:36]
    .auto_in_member_allClocks_subsystem_sbus_0_reset  (_prci_ctrl_domain_auto_tileClockGater_tile_clock_gater_out_member_allClocks_subsystem_sbus_0_reset),	// @[HasChipyardPRCI.scala:36:36]
    ...
    .auto_out_member_allClocks_subsystem_mbus_0_clock (_resetSynchronizer_auto_out_member_allClocks_subsystem_mbus_0_clock),
    .auto_out_member_allClocks_subsystem_mbus_0_reset (_resetSynchronizer_auto_out_member_allClocks_subsystem_mbus_0_reset),
    ...
    .auto_out_member_allClocks_subsystem_sbus_1_clock (_resetSynchronizer_auto_out_member_allClocks_subsystem_sbus_1_clock),
    .auto_out_member_allClocks_subsystem_sbus_1_reset (_resetSynchronizer_auto_out_member_allClocks_subsystem_sbus_1_reset),
  ...
  DebugTransportModuleJTAG dtm (	// @[Periphery.scala:159:21]
    .io_jtag_clock         (debug_systemjtag_jtag_TCK),
    .io_jtag_reset         (debug_systemjtag_reset),
    .io_dmi_req_ready      (_tlDM_io_dmi_dmi_req_ready),	// @[Periphery.scala:84:26]
    .io_dmi_resp_valid     (_tlDM_io_dmi_dmi_resp_valid),	// @[Periphery.scala:84:26]
    .io_dmi_resp_bits_data (_tlDM_io_dmi_dmi_resp_bits_data),	// @[Periphery.scala:84:26]
    .io_dmi_resp_bits_resp (_tlDM_io_dmi_dmi_resp_bits_resp),	// @[Periphery.scala:84:26]
