...
module TLXbar_8(
  ...
  wire        requestDOI_0_1 = auto_out_d_bits_source == 2'h2;	// @[Parameters.scala:46:9, Xbar.scala:426:24]
  wire        out_8_valid = auto_out_b_valid & ~(auto_out_b_bits_source[1]);	// @[Parameters.scala:54:{10,32}, Xbar.scala:181:40]
  wire        out_10_valid = auto_out_d_valid & ~(auto_out_d_bits_source[1]);	// @[Parameters.scala:54:{10,32}, Xbar.scala:181:40]
  wire        out_13_valid = auto_out_d_valid & requestDOI_0_1;	// @[Parameters.scala:46:9, Xbar.scala:181:40]
  reg  [7:0]  beatsLeft;	// @[Arbiter.scala:87:30]
  wire        idle = beatsLeft == 8'h0;	// @[Arbiter.scala:87:30, :88:28, :111:73, Edges.scala:220:14]
  ...
  wire [1:0]  readys_readys = ~({readys_mask[1], _readys_filter_T_1[1] | readys_mask[0]} & {|_readys_filter_T_1, auto_in_1_a_valid | _readys_filter_T_1[0]});	// @[Arbiter.scala:23:23, :24:28, :25:58, :26:{18,29,39,48}, package.scala:254:43]
  wire        earlyWinner_0 = readys_readys[0] & auto_in_0_a_valid;	// @[Arbiter.scala:26:18, :95:86, :97:79]
  ...
  wire        portsAOI_filtered_0_ready = auto_out_a_ready & (idle ? readys_readys[0] : state_0);	// @[Arbiter.scala:26:18, :88:28, :95:86, :116:26, :121:24, :123:31]
  wire        portsAOI_filtered_1_0_ready = auto_out_a_ready & (idle ? readys_readys[1] : state_1);	// @[Arbiter.scala:26:18, :88:28, :95:86, :116:26, :121:24, :123:31]
  wire        x1_out_1_valid = idle ? _out_0_a_earlyValid_T : state_0 & auto_in_0_a_valid | state_1 & auto_in_1_a_valid;	// @[Arbiter.scala:88:28, :107:36, :116:26, :125:29, Mux.scala:27:73]
  ...
  wire        latch = idle & auto_out_a_ready;	// @[Arbiter.scala:88:28, :89:24]
  wire        winnerQual_0 = readys_readys[0] & auto_in_0_a_valid;	// @[Arbiter.scala:26:18, :95:86, :98:79]
  always @(posedge clock) begin
    if (reset) begin
      beatsLeft <= 8'h0;	// @[Arbiter.scala:87:30, :111:73, Edges.scala:220:14]
      ...
      if (latch) begin	// @[Arbiter.scala:89:24]
        if (winnerQual_0 & ~(auto_in_0_a_bits_opcode[2]))	// @[Arbiter.scala:98:79, :111:73, Edges.scala:91:{28,37}, :220:14]
          beatsLeft <= ~(_beatsAI_decode_T_1[11:4]);	// @[Arbiter.scala:87:30, package.scala:235:{46,71,76}]
        else	// @[Arbiter.scala:111:73, Edges.scala:220:14]
          beatsLeft <= 8'h0;	// @[Arbiter.scala:87:30, :111:73, Edges.scala:220:14]
      end
      else	// @[Arbiter.scala:89:24]
        beatsLeft <= beatsLeft - {7'h0, auto_out_a_ready & x1_out_1_valid};	// @[Arbiter.scala:87:30, :113:52, :125:29, ReadyValidCancel.scala:49:33]
  ...
  TLMonitor_47 monitor (	// @[Nodes.scala:24:25]
    ...
    .io_in_d_valid        (out_10_valid),	// @[Xbar.scala:181:40]
    .io_in_d_bits_opcode  (auto_out_d_bits_opcode),
    .io_in_d_bits_param   (auto_out_d_bits_param),
    .io_in_d_bits_size    (auto_out_d_bits_size),
    .io_in_d_bits_source  (auto_out_d_bits_source[0]),	// @[Xbar.scala:230:69]
  ...
  TLMonitor_48 monitor_1 (	// @[Nodes.scala:24:25]
    .clock                (clock),
    .reset                (reset),
    ...
    .io_in_d_valid        (out_13_valid),	// @[Xbar.scala:181:40]
    .io_in_d_bits_opcode  (auto_out_d_bits_opcode),
    .io_in_d_bits_param   (auto_out_d_bits_param),
    .io_in_d_bits_size    (auto_out_d_bits_size),
    .io_in_d_bits_sink    (auto_out_d_bits_sink),
  ...
  assign auto_in_1_d_valid = out_13_valid;	// @[Xbar.scala:181:40]
  ...
  assign auto_in_0_b_valid = out_8_valid;	// @[Xbar.scala:181:40]
  assign auto_in_0_b_bits_param = auto_out_b_bits_param;
  assign auto_in_0_b_bits_size = auto_out_b_bits_size;
  assign auto_in_0_b_bits_source = auto_out_b_bits_source[0];	// @[Xbar.scala:230:69]
  assign auto_in_0_b_bits_address = auto_out_b_bits_address;
  assign auto_in_0_c_ready = auto_out_c_ready;
  assign auto_in_0_d_valid = out_10_valid;	// @[Xbar.scala:181:40]
  assign auto_in_0_d_bits_opcode = auto_out_d_bits_opcode;
  assign auto_in_0_d_bits_param = auto_out_d_bits_param;
  assign auto_in_0_d_bits_size = auto_out_d_bits_size;
  assign auto_in_0_d_bits_source = auto_out_d_bits_source[0];	// @[Xbar.scala:230:69]
  assign auto_in_0_d_bits_sink = auto_out_d_bits_sink;
  assign auto_in_0_d_bits_denied = auto_out_d_bits_denied;
  assign auto_in_0_d_bits_data = auto_out_d_bits_data;
  assign auto_in_0_e_ready = auto_out_e_ready;
  assign auto_out_a_valid = x1_out_1_valid;	// @[Arbiter.scala:125:29]
  assign auto_out_a_bits_opcode = (muxStateEarly_0 ? auto_in_0_a_bits_opcode : 3'h0) | {muxStateEarly_1, 2'h0};	// @[Arbiter.scala:117:30, Bundles.scala:259:74, Mux.scala:27:73]
  assign auto_out_a_bits_param = muxStateEarly_0 ? auto_in_0_a_bits_param : 3'h0;	// @[Arbiter.scala:117:30, Mux.scala:27:73]
  assign auto_out_a_bits_size = (muxStateEarly_0 ? auto_in_0_a_bits_size : 4'h0) | (muxStateEarly_1 ? 4'h6 : 4'h0);	// @[Arbiter.scala:117:30, Bundles.scala:259:74, Mux.scala:27:73]
  assign auto_out_a_bits_source = (muxStateEarly_0 ? {1'h0, auto_in_0_a_bits_source} : 2'h0) | {muxStateEarly_1, 1'h0};	// @[Arbiter.scala:117:30, Bundles.scala:259:74, Mux.scala:27:73, Xbar.scala:239:29]
  assign auto_out_a_bits_address = (muxStateEarly_0 ? auto_in_0_a_bits_address : 32'h0) | (muxStateEarly_1 ? auto_in_1_a_bits_address : 32'h0);	// @[Arbiter.scala:117:30, Bundles.scala:259:74, Mux.scala:27:73]
  assign auto_out_a_bits_mask = (muxStateEarly_0 ? auto_in_0_a_bits_mask : 16'h0) | {16{muxStateEarly_1}};	// @[Arbiter.scala:117:30, Bundles.scala:259:74, Mux.scala:27:73]
  assign auto_out_a_bits_data = muxStateEarly_0 ? auto_in_0_a_bits_data : 128'h0;	// @[Arbiter.scala:117:30, Mux.scala:27:73]
  assign auto_out_b_ready = ~(auto_out_b_bits_source[1]) & auto_in_0_b_ready;	// @[Mux.scala:27:73, Parameters.scala:54:{10,32}]
  ...
  assign auto_out_c_bits_source = {1'h0, auto_in_0_c_bits_source};	// @[Xbar.scala:261:29]
  assign auto_out_c_bits_address = auto_in_0_c_bits_address;
  assign auto_out_c_bits_data = auto_in_0_c_bits_data;
  assign auto_out_d_ready = ~(auto_out_d_bits_source[1]) & auto_in_0_d_ready | requestDOI_0_1;	// @[Mux.scala:27:73, Parameters.scala:46:9, :54:{10,32}]
