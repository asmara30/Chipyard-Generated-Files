...
module Queue_73(
  ...
  wire [187:0] _ram_ext_R0_data;	// @[Decoupled.scala:273:95]
  ...
  ram_combMem_37 ram_ext (	// @[Decoupled.scala:273:95]
    ...
    .W0_clk  (clock),
    .W0_data ({145'hFFFF, io_enq_bits_address, io_enq_bits_source, io_enq_bits_size, io_enq_bits_param, 3'h6}),	// @[Decoupled.scala:273:95]
  ...
  assign io_deq_bits_source = _ram_ext_R0_data[10:9];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_address = _ram_ext_R0_data[42:11];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_mask = _ram_ext_R0_data[58:43];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_corrupt = _ram_ext_R0_data[187];	// @[Decoupled.scala:273:95]
endmodule
