...
module Queue_72(
  ...
  wire [144:0] _ram_ext_R0_data;	// @[Decoupled.scala:273:95]
  ...
  assign io_deq_bits_sink = _ram_ext_R0_data[14:11];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_denied = _ram_ext_R0_data[15];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_data = _ram_ext_R0_data[143:16];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_corrupt = _ram_ext_R0_data[144];	// @[Decoupled.scala:273:95]
endmodule
