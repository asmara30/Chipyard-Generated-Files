...
module Queue_45(
  ...
  output [2:0]  io_deq_bits_laddr_norm_cmd,
  output [10:0] io_deq_bits_laddr_garbage,
  output        io_deq_bits_laddr_garbage_bit,
  output [13:0] io_deq_bits_laddr_data,
  output [2:0]  io_deq_bits_acc_act,
  output [31:0] io_deq_bits_acc_scale,
                io_deq_bits_acc_igelu_qb,
                io_deq_bits_acc_igelu_qc,
                io_deq_bits_acc_iexp_qln2,
                io_deq_bits_acc_iexp_qln2_inv,
  output [7:0]  io_deq_bits_acc_norm_stats_id,
  ...
  ram_combMem_47 ram_ext (	// @[Decoupled.scala:273:95]
  ...
  assign io_deq_bits_laddr_norm_cmd = _ram_ext_R0_data[45:43];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_laddr_garbage = _ram_ext_R0_data[56:46];	// @[Decoupled.scala:273:95]
  ...
  assign io_deq_bits_acc_act = _ram_ext_R0_data[74:72];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_acc_scale = _ram_ext_R0_data[106:75];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_acc_igelu_qb = _ram_ext_R0_data[138:107];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_acc_igelu_qc = _ram_ext_R0_data[170:139];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_acc_iexp_qln2 = _ram_ext_R0_data[202:171];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_acc_iexp_qln2_inv = _ram_ext_R0_data[234:203];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_acc_norm_stats_id = _ram_ext_R0_data[242:235];	// @[Decoupled.scala:273:95]
  ...
  assign io_deq_bits_cmd_id = _ram_ext_R0_data[274:267];	// @[Decoupled.scala:273:95]
