...
module Scratchpad(
  ...
  wire         _xbar_auto_in_1_a_ready;	// @[Xbar.scala:144:26]
  wire         _xbar_auto_in_1_d_valid;	// @[Xbar.scala:144:26]
  wire [2:0]   _xbar_auto_in_1_d_bits_opcode;	// @[Xbar.scala:144:26]
  wire [1:0]   _xbar_auto_in_1_d_bits_param;	// @[Xbar.scala:144:26]
  wire [3:0]   _xbar_auto_in_1_d_bits_size;	// @[Xbar.scala:144:26]
  wire [3:0]   _xbar_auto_in_1_d_bits_source;	// @[Xbar.scala:144:26]
  wire [3:0]   _xbar_auto_in_1_d_bits_sink;	// @[Xbar.scala:144:26]
  wire         _xbar_auto_in_1_d_bits_denied;	// @[Xbar.scala:144:26]
  wire [127:0] _xbar_auto_in_1_d_bits_data;	// @[Xbar.scala:144:26]
  wire         _xbar_auto_in_1_d_bits_corrupt;	// @[Xbar.scala:144:26]
  wire         _xbar_auto_in_0_a_ready;	// @[Xbar.scala:144:26]
  wire         _xbar_auto_in_0_d_valid;	// @[Xbar.scala:144:26]
  wire [2:0]   _xbar_auto_in_0_d_bits_opcode;	// @[Xbar.scala:144:26]
  wire [1:0]   _xbar_auto_in_0_d_bits_param;	// @[Xbar.scala:144:26]
  wire [3:0]   _xbar_auto_in_0_d_bits_size;	// @[Xbar.scala:144:26]
  wire [3:0]   _xbar_auto_in_0_d_bits_source;	// @[Xbar.scala:144:26]
  wire [3:0]   _xbar_auto_in_0_d_bits_sink;	// @[Xbar.scala:144:26]
  wire         _xbar_auto_in_0_d_bits_denied;	// @[Xbar.scala:144:26]
  wire [127:0] _xbar_auto_in_0_d_bits_data;	// @[Xbar.scala:144:26]
  wire         _xbar_auto_in_0_d_bits_corrupt;	// @[Xbar.scala:144:26]
  wire         _xbar_auto_out_a_valid;	// @[Xbar.scala:144:26]
  wire [2:0]   _xbar_auto_out_a_bits_opcode;	// @[Xbar.scala:144:26]
  wire [2:0]   _xbar_auto_out_a_bits_param;	// @[Xbar.scala:144:26]
  wire [3:0]   _xbar_auto_out_a_bits_size;	// @[Xbar.scala:144:26]
  wire [4:0]   _xbar_auto_out_a_bits_source;	// @[Xbar.scala:144:26]
  wire [31:0]  _xbar_auto_out_a_bits_address;	// @[Xbar.scala:144:26]
  wire [15:0]  _xbar_auto_out_a_bits_mask;	// @[Xbar.scala:144:26]
  wire [127:0] _xbar_auto_out_a_bits_data;	// @[Xbar.scala:144:26]
  wire         _xbar_auto_out_a_bits_corrupt;	// @[Xbar.scala:144:26]
  wire         _xbar_auto_out_d_ready;	// @[Xbar.scala:144:26]
  ...
  TLXbar_10 xbar (	// @[Xbar.scala:144:26]
    .clock                    (clock),
    .reset                    (reset),
  ...
  TLBuffer_17 buffer (	// @[Buffer.scala:69:28]
    ...
    .auto_out_a_ready        (_xbar_auto_in_0_a_ready),	// @[Xbar.scala:144:26]
    .auto_out_d_valid        (_xbar_auto_in_0_d_valid),	// @[Xbar.scala:144:26]
    .auto_out_d_bits_opcode  (_xbar_auto_in_0_d_bits_opcode),	// @[Xbar.scala:144:26]
    .auto_out_d_bits_param   (_xbar_auto_in_0_d_bits_param),	// @[Xbar.scala:144:26]
    .auto_out_d_bits_size    (_xbar_auto_in_0_d_bits_size),	// @[Xbar.scala:144:26]
    .auto_out_d_bits_source  (_xbar_auto_in_0_d_bits_source),	// @[Xbar.scala:144:26]
    .auto_out_d_bits_sink    (_xbar_auto_in_0_d_bits_sink),	// @[Xbar.scala:144:26]
    .auto_out_d_bits_denied  (_xbar_auto_in_0_d_bits_denied),	// @[Xbar.scala:144:26]
    .auto_out_d_bits_data    (_xbar_auto_in_0_d_bits_data),	// @[Xbar.scala:144:26]
    .auto_out_d_bits_corrupt (_xbar_auto_in_0_d_bits_corrupt),	// @[Xbar.scala:144:26]
  ...
  TLBuffer_18 buffer_1 (	// @[Buffer.scala:69:28]
    ...
    .auto_out_a_ready        (_xbar_auto_in_1_a_ready),	// @[Xbar.scala:144:26]
    .auto_out_d_valid        (_xbar_auto_in_1_d_valid),	// @[Xbar.scala:144:26]
    .auto_out_d_bits_opcode  (_xbar_auto_in_1_d_bits_opcode),	// @[Xbar.scala:144:26]
    .auto_out_d_bits_param   (_xbar_auto_in_1_d_bits_param),	// @[Xbar.scala:144:26]
    .auto_out_d_bits_size    (_xbar_auto_in_1_d_bits_size),	// @[Xbar.scala:144:26]
    .auto_out_d_bits_source  (_xbar_auto_in_1_d_bits_source),	// @[Xbar.scala:144:26]
    .auto_out_d_bits_sink    (_xbar_auto_in_1_d_bits_sink),	// @[Xbar.scala:144:26]
    .auto_out_d_bits_denied  (_xbar_auto_in_1_d_bits_denied),	// @[Xbar.scala:144:26]
    .auto_out_d_bits_data    (_xbar_auto_in_1_d_bits_data),	// @[Xbar.scala:144:26]
    .auto_out_d_bits_corrupt (_xbar_auto_in_1_d_bits_corrupt),	// @[Xbar.scala:144:26]
  ...
  TLBuffer_19 buffer_2 (	// @[Buffer.scala:69:28]
    .clock                   (clock),
    .reset                   (reset),
    .auto_in_a_valid         (_xbar_auto_out_a_valid),	// @[Xbar.scala:144:26]
    .auto_in_a_bits_opcode   (_xbar_auto_out_a_bits_opcode),	// @[Xbar.scala:144:26]
    .auto_in_a_bits_param    (_xbar_auto_out_a_bits_param),	// @[Xbar.scala:144:26]
    .auto_in_a_bits_size     (_xbar_auto_out_a_bits_size),	// @[Xbar.scala:144:26]
    .auto_in_a_bits_source   (_xbar_auto_out_a_bits_source),	// @[Xbar.scala:144:26]
    .auto_in_a_bits_address  (_xbar_auto_out_a_bits_address),	// @[Xbar.scala:144:26]
    .auto_in_a_bits_mask     (_xbar_auto_out_a_bits_mask),	// @[Xbar.scala:144:26]
    .auto_in_a_bits_data     (_xbar_auto_out_a_bits_data),	// @[Xbar.scala:144:26]
    .auto_in_a_bits_corrupt  (_xbar_auto_out_a_bits_corrupt),	// @[Xbar.scala:144:26]
    .auto_in_d_ready         (_xbar_auto_out_d_ready),	// @[Xbar.scala:144:26]
  ...
  Queue_45 write_dispatch_q (	// @[Decoupled.scala:375:21]
    .clock                               (clock),
    .reset                               (reset),
  ...
  Queue_46 write_norm_q (	// @[Scratchpad.scala:252:30]
    .clock                               (clock),
    .reset                               (reset),
  ...
  Queue_46 write_scale_q (	// @[Scratchpad.scala:253:31]
    .clock                               (clock),
    .reset                               (reset),
  ...
  Queue_48 write_issue_q (	// @[Scratchpad.scala:254:31]
    .clock                               (clock),
    .reset                               (reset),
  ...
  Queue_49 read_issue_q (	// @[Scratchpad.scala:255:30]
    .clock                               (clock),
    .reset                               (reset),
  ...
  Queue_54 norm_unit_passthru_q (	// @[Normalizer.scala:621:38]
    .clock                                   (clock),
    .reset                                   (reset),
