...
module Queue_78(
  ...
  assign io_deq_bits_sink = _ram_ext_R0_data[12];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_denied = _ram_ext_R0_data[13];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_data = _ram_ext_R0_data[77:14];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_corrupt = _ram_ext_R0_data[78];	// @[Decoupled.scala:273:95]
endmodule
