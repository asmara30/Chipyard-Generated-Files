...
module Queue_64(
  ...
  wire [56:0] _ram_ext_R0_data;	// @[Decoupled.scala:273:95]
  ...
  ram_combMem_6 ram_ext (	// @[Decoupled.scala:273:95]
    ...
    .W0_clk  (clock),
    .W0_data ({io_enq_bits_total_rows, io_enq_bits_id, 49'h0}),	// @[Decoupled.scala:273:95]
    .R0_data (_ram_ext_R0_data)
  );
  assign io_enq_ready = ~full;	// @[Decoupled.scala:279:24, :303:19]
  assign io_deq_valid = ~empty;	// @[Decoupled.scala:278:25, :302:19]
  assign io_deq_bits_id = _ram_ext_R0_data[51:49];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_total_rows = _ram_ext_R0_data[56:52];	// @[Decoupled.scala:273:95]
endmodule
