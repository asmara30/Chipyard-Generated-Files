...
module head_combMem_0(	// @[ListBuffer.scala:46:18]
  input  [5:0] R0_addr,
  input        R0_en,
               R0_clk,
  input  [5:0] W0_addr,
  ...
  reg [4:0] Memory[0:35];	// @[ListBuffer.scala:46:18]
  ...
  `ifndef SYNTHESIS	// @[ListBuffer.scala:46:18]
    `ifdef RANDOMIZE_MEM_INIT	// @[ListBuffer.scala:46:18]
      integer initvar;	// @[ListBuffer.scala:46:18]
  ...
  assign R0_data = R0_en ? Memory[R0_addr] : 5'bx;	// @[ListBuffer.scala:46:18]
endmodule
