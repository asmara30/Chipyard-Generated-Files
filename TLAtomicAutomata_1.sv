...
module TLAtomicAutomata_1(
  ...
  wire [6:0]      _GEN = {auto_in_a_bits_address[30], auto_in_a_bits_address[26:25], auto_in_a_bits_address[20], auto_in_a_bits_address[16], auto_in_a_bits_address[14:13] ^ 2'h1};	// @[AtomicAutomata.scala:199:23, Parameters.scala:137:{31,45}]
  wire [6:0]      _GEN_0 = {auto_in_a_bits_address[30], auto_in_a_bits_address[26:25], auto_in_a_bits_address[20], auto_in_a_bits_address[16], auto_in_a_bits_address[14:13] ^ 2'h2};	// @[AtomicAutomata.scala:83:44, Parameters.scala:137:{31,45}]
  wire [5:0]      _GEN_1 = auto_in_a_bits_address[30:25] ^ 6'h22;	// @[Parameters.scala:137:31]
  wire [6:0]      _GEN_2 = {_GEN_1[5], _GEN_1[1:0], auto_in_a_bits_address[20], auto_in_a_bits_address[16], auto_in_a_bits_address[14:13]};	// @[Parameters.scala:137:{31,45}]
  wire            a_isSupported = auto_in_a_bits_opcode == 3'h3 ? _a_canArithmetic_T_3 & (_GEN == 7'h0 | _GEN_0 == 7'h0 | _GEN_2 == 7'h0) : auto_in_a_bits_opcode != 3'h2 | _a_canArithmetic_T_3 & (_GEN == 7'h0 | _GEN_0 == 7'h0 | _GEN_2 == 7'h0);	// @[AtomicAutomata.scala:92:47, :93:47, :94:{32,63}, Bundles.scala:259:74, Mux.scala:81:61, Parameters.scala:92:42, :137:{45,65}, :670:56, :671:42]
  ...
  wire [6:0]      _GEN_3 = ~(cam_a_0_bits_mask[6:0]) | cam_a_0_bits_mask[7:1];	// @[AtomicAutomata.scala:79:24, :123:{25,31,39}]
  wire [6:0]      _GEN_4 = {cam_a_0_bits_data[55], cam_a_0_bits_data[47], cam_a_0_bits_data[39], cam_a_0_bits_data[31], cam_a_0_bits_data[23], cam_a_0_bits_data[15], cam_a_0_bits_data[7]} & ~_GEN_3;	// @[AtomicAutomata.scala:79:24, :115:63, :123:{23,31}, :127:38, Cat.scala:33:92]
  wire [6:0]      _GEN_5 = {cam_d_0_data[55], cam_d_0_data[47], cam_d_0_data[39], cam_d_0_data[31], cam_d_0_data[23], cam_d_0_data[15], cam_d_0_data[7]} & ~_GEN_3;	// @[AtomicAutomata.scala:80:24, :115:73, :123:{23,31}, :128:38, Cat.scala:33:92]
  wire [5:0]      _GEN_6 = _GEN_4[6:1] | _GEN_4[5:0];	// @[AtomicAutomata.scala:127:38, package.scala:245:{43,53}]
  wire [3:0]      _GEN_7 = _GEN_6[5:2] | _GEN_6[3:0];	// @[package.scala:245:{43,53}]
  wire            _signext_a_T_24 = _GEN_6[1] | _GEN_4[0];	// @[AtomicAutomata.scala:127:38, package.scala:245:43]
  wire [5:0]      _GEN_8 = _GEN_5[6:1] | _GEN_5[5:0];	// @[AtomicAutomata.scala:128:38, package.scala:245:{43,53}]
  wire [3:0]      _GEN_9 = _GEN_8[5:2] | _GEN_8[3:0];	// @[package.scala:245:{43,53}]
  wire            _signext_d_T_24 = _GEN_8[1] | _GEN_5[0];	// @[AtomicAutomata.scala:128:38, package.scala:245:43]
  ...
  wire [63:0]     a_a_ext = cam_a_0_bits_data & wide_mask | {{8{_GEN_7[3] | _signext_a_T_24}}, {8{_GEN_7[2] | _GEN_6[0]}}, {8{_GEN_7[1] | _GEN_4[0]}}, {8{_GEN_7[0]}}, {8{_signext_a_T_24}}, {8{_GEN_6[0]}}, {8{_GEN_4[0]}}, 8'h0};	// @[AtomicAutomata.scala:79:24, :127:38, :133:{28,41}, Bitwise.scala:77:12, Cat.scala:33:92, package.scala:245:43]
  wire [63:0]     a_d_ext = cam_d_0_data & wide_mask | {{8{_GEN_9[3] | _signext_d_T_24}}, {8{_GEN_9[2] | _GEN_8[0]}}, {8{_GEN_9[1] | _GEN_5[0]}}, {8{_GEN_9[0]}}, {8{_signext_d_T_24}}, {8{_GEN_8[0]}}, {8{_GEN_5[0]}}, 8'h0};	// @[AtomicAutomata.scala:80:24, :128:38, :134:{28,41}, Bitwise.scala:77:12, Cat.scala:33:92, package.scala:245:43]
  ...
  wire            bundleIn_0_a_ready = out_1_ready & a_allow;	// @[Arbiter.scala:123:31, AtomicAutomata.scala:151:35, :152:38]
  wire            out_1_earlyValid = auto_in_a_valid & a_allow;	// @[AtomicAutomata.scala:151:35, :153:38]
  wire            _source_c_bits_a_mask_T = cam_a_0_bits_size > 4'h2;	// @[AtomicAutomata.scala:79:24, Misc.scala:205:21]
  ...
  wire            earlyWinner_1 = ~winnerQual_0 & out_1_earlyValid;	// @[Arbiter.scala:16:61, :97:79, AtomicAutomata.scala:83:44, :153:38]
  wire            _sink_ACancel_earlyValid_T = winnerQual_0 | out_1_earlyValid;	// @[Arbiter.scala:107:36, AtomicAutomata.scala:83:44, :153:38]
  reg             state_0;	// @[Arbiter.scala:116:26]
  reg             state_1;	// @[Arbiter.scala:116:26]
  wire            muxStateEarly_0 = idle ? winnerQual_0 : state_0;	// @[Arbiter.scala:88:28, :116:26, :117:30, AtomicAutomata.scala:83:44]
  wire            muxStateEarly_1 = idle ? earlyWinner_1 : state_1;	// @[Arbiter.scala:88:28, :97:79, :116:26, :117:30]
  assign out_1_ready = auto_out_a_ready & (idle ? ~winnerQual_0 : state_1);	// @[Arbiter.scala:16:61, :88:28, :116:26, :121:24, :123:31, AtomicAutomata.scala:83:44]
  wire            out_2_valid = idle ? _sink_ACancel_earlyValid_T : state_0 & winnerQual_0 | state_1 & out_1_earlyValid;	// @[Arbiter.scala:88:28, :107:36, :116:26, :125:29, AtomicAutomata.scala:83:44, :153:38, Mux.scala:27:73]
  ...
  wire            d_replace = d_first & auto_out_d_bits_opcode == 3'h0 & d_cam_sel_match_0;	// @[AtomicAutomata.scala:207:83, :216:40, :235:42, Edges.scala:230:25, Misc.scala:201:34]
  ...
  wire            winnerQual_1 = ~winnerQual_0 & out_1_earlyValid;	// @[Arbiter.scala:16:61, :98:79, AtomicAutomata.scala:83:44, :153:38]
  wire [3:0][3:0] _GEN_10 = '{4'hC, 4'h8, 4'hE, 4'h6};	// @[Mux.scala:81:{58,61}]
  wire            _GEN_11 = out_1_ready & out_1_earlyValid & ~a_isSupported & cam_free_0;	// @[Arbiter.scala:123:31, AtomicAutomata.scala:79:24, :82:44, :94:32, :153:38, :155:15, :176:50, :178:23, :179:24]
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      state_0 <= 1'h0;	// @[Arbiter.scala:116:26, AtomicAutomata.scala:77:23]
      state_1 <= 1'h0;	// @[Arbiter.scala:116:26, AtomicAutomata.scala:77:23]
      ...
      else if (auto_out_a_ready & (idle | state_0) & winnerQual_0)	// @[Arbiter.scala:88:28, :116:26, :121:24, AtomicAutomata.scala:83:44, :176:50, :196:32, :198:23, :199:23]
        cam_s_0_state <= 2'h1;	// @[AtomicAutomata.scala:78:28, :199:23]
      else if (_GEN_11)	// @[AtomicAutomata.scala:79:24, :176:50, :178:23, :179:24]
        cam_s_0_state <= 2'h3;	// @[AtomicAutomata.scala:78:28, :84:49]
      if (idle & auto_out_a_ready) begin	// @[Arbiter.scala:88:28, :89:24]
        if (winnerQual_1 & ~(auto_in_a_bits_opcode[2]))	// @[Arbiter.scala:98:79, :111:73, Edges.scala:91:{28,37}, :220:14]
          beatsLeft <= ~(_decode_T_1[11:3]);	// @[Arbiter.scala:87:30, package.scala:235:{46,71,76}]
        else	// @[Arbiter.scala:111:73, Edges.scala:220:14]
          beatsLeft <= 9'h0;	// @[Arbiter.scala:87:30, Edges.scala:228:27]
      end
      else	// @[Arbiter.scala:89:24]
        beatsLeft <= beatsLeft - {8'h0, auto_out_a_ready & out_2_valid};	// @[Arbiter.scala:87:30, :113:52, :125:29, Bitwise.scala:77:12, ReadyValidCancel.scala:49:33]
      if (idle) begin	// @[Arbiter.scala:88:28]
        state_0 <= winnerQual_0;	// @[Arbiter.scala:116:26, AtomicAutomata.scala:83:44]
    ...
    if (_GEN_11) begin	// @[AtomicAutomata.scala:79:24, :176:50, :178:23, :179:24]
      ...
      cam_a_0_lut <= _GEN_10[auto_in_a_bits_param[1:0]];	// @[AtomicAutomata.scala:79:24, :181:52, Mux.scala:81:{58,61}]
    end
    cam_a_0_fifoId <= ~_GEN_11 & cam_a_0_fifoId;	// @[AtomicAutomata.scala:79:24, :176:50, :178:23, :179:24]
  ...
  `ifndef SYNTHESIS
    always @(posedge clock) begin	// @[Arbiter.scala:105:13]
      if (~reset & ~(~winnerQual_0 | ~earlyWinner_1)) begin	// @[Arbiter.scala:97:79, :105:{13,61,64,67}, AtomicAutomata.scala:83:44]
        if (`ASSERT_VERBOSE_COND_)	// @[Arbiter.scala:105:13]
          $error("Assertion failed\n    at Arbiter.scala:105 assert((prefixOR zip earlyWinner) map { case (p,w) => !p || !w } reduce {_ && _})\n");	// @[Arbiter.scala:105:13]
        if (`STOP_COND_)	// @[Arbiter.scala:105:13]
          $fatal;	// @[Arbiter.scala:105:13]
      end
      if (~reset & ~(~_sink_ACancel_earlyValid_T | winnerQual_0 | earlyWinner_1)) begin	// @[Arbiter.scala:97:79, :107:{14,15,36,41}, AtomicAutomata.scala:83:44]
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        cam_a_0_bits_source = _RANDOM_0[18:12];	// @[AtomicAutomata.scala:78:28, :79:24]
        cam_a_0_bits_address = {_RANDOM_0[31:19], _RANDOM_1[17:0]};	// @[AtomicAutomata.scala:78:28, :79:24]
        cam_a_0_bits_mask = _RANDOM_1[25:18];	// @[AtomicAutomata.scala:79:24]
        cam_a_0_bits_data = {_RANDOM_1[31:26], _RANDOM_2, _RANDOM_3[25:0]};	// @[AtomicAutomata.scala:79:24]
        cam_a_0_bits_corrupt = _RANDOM_3[26];	// @[AtomicAutomata.scala:79:24]
        cam_a_0_fifoId = _RANDOM_3[27];	// @[AtomicAutomata.scala:79:24]
        cam_a_0_lut = _RANDOM_3[31:28];	// @[AtomicAutomata.scala:79:24]
        cam_d_0_data = {_RANDOM_4, _RANDOM_5};	// @[AtomicAutomata.scala:80:24]
        cam_d_0_denied = _RANDOM_6[0];	// @[AtomicAutomata.scala:80:24]
        cam_d_0_corrupt = _RANDOM_6[1];	// @[AtomicAutomata.scala:80:24]
        beatsLeft = _RANDOM_6[10:2];	// @[Arbiter.scala:87:30, AtomicAutomata.scala:80:24]
        state_0 = _RANDOM_6[11];	// @[Arbiter.scala:116:26, AtomicAutomata.scala:80:24]
        state_1 = _RANDOM_6[12];	// @[Arbiter.scala:116:26, AtomicAutomata.scala:80:24]
        d_first_counter = _RANDOM_6[21:13];	// @[AtomicAutomata.scala:80:24, Edges.scala:228:27]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  assign auto_out_a_bits_opcode = muxStateEarly_1 ? (a_isSupported ? auto_in_a_bits_opcode : 3'h4) : 3'h0;	// @[Arbiter.scala:117:30, AtomicAutomata.scala:94:32, :154:24, :155:31, :156:32, Misc.scala:201:34, Mux.scala:27:73]
  assign auto_out_a_bits_param = muxStateEarly_1 & a_isSupported ? auto_in_a_bits_param : 3'h0;	// @[Arbiter.scala:117:30, AtomicAutomata.scala:94:32, Misc.scala:201:34, Mux.scala:27:73]
  assign auto_out_a_bits_size = (muxStateEarly_0 ? cam_a_0_bits_size : 4'h0) | (muxStateEarly_1 ? auto_in_a_bits_size : 4'h0);	// @[Arbiter.scala:117:30, AtomicAutomata.scala:79:24, Bundles.scala:259:74, Mux.scala:27:73]
  assign auto_out_a_bits_source = (muxStateEarly_0 ? cam_a_0_bits_source : 7'h0) | (muxStateEarly_1 ? auto_in_a_bits_source : 7'h0);	// @[Arbiter.scala:117:30, AtomicAutomata.scala:79:24, Bundles.scala:259:74, Mux.scala:27:73]
  assign auto_out_a_bits_address = (muxStateEarly_0 ? cam_a_0_bits_address : 31'h0) | (muxStateEarly_1 ? auto_in_a_bits_address : 31'h0);	// @[Arbiter.scala:117:30, AtomicAutomata.scala:79:24, Bundles.scala:259:74, Mux.scala:27:73]
  assign auto_out_a_bits_mask = (muxStateEarly_0 ? {source_c_bits_a_mask_acc_5 | source_c_bits_a_mask_eq_5 & cam_a_0_bits_address[0], source_c_bits_a_mask_acc_5 | source_c_bits_a_mask_eq_5 & ~(cam_a_0_bits_address[0]), source_c_bits_a_mask_acc_4 | source_c_bits_a_mask_eq_4 & cam_a_0_bits_address[0], source_c_bits_a_mask_acc_4 | source_c_bits_a_mask_eq_4 & ~(cam_a_0_bits_address[0]), source_c_bits_a_mask_acc_3 | source_c_bits_a_mask_eq_3 & cam_a_0_bits_address[0], source_c_bits_a_mask_acc_3 | source_c_bits_a_mask_eq_3 & ~(cam_a_0_bits_address[0]), source_c_bits_a_mask_acc_2 | source_c_bits_a_mask_eq_2 & cam_a_0_bits_address[0], source_c_bits_a_mask_acc_2 | source_c_bits_a_mask_eq_2 & ~(cam_a_0_bits_address[0])} : 8'h0) | (muxStateEarly_1 ? auto_in_a_bits_mask : 8'h0);	// @[Arbiter.scala:117:30, AtomicAutomata.scala:79:24, Bitwise.scala:77:12, Cat.scala:33:92, Misc.scala:209:26, :210:20, :213:27, :214:29, Mux.scala:27:73]
  assign auto_out_a_bits_data = (muxStateEarly_0 ? (cam_a_0_bits_opcode[0] ? {_logic_out_T_126[0], _logic_out_T_124[0], _logic_out_T_122[0], _logic_out_T_120[0], _logic_out_T_118[0], _logic_out_T_116[0], _logic_out_T_114[0], _logic_out_T_112[0], _logic_out_T_110[0], _logic_out_T_108[0], _logic_out_T_106[0], _logic_out_T_104[0], _logic_out_T_102[0], _logic_out_T_100[0], _logic_out_T_98[0], _logic_out_T_96[0], _logic_out_T_94[0], _logic_out_T_92[0], _logic_out_T_90[0], _logic_out_T_88[0], _logic_out_T_86[0], _logic_out_T_84[0], _logic_out_T_82[0], _logic_out_T_80[0], _logic_out_T_78[0], _logic_out_T_76[0], _logic_out_T_74[0], _logic_out_T_72[0], _logic_out_T_70[0], _logic_out_T_68[0], _logic_out_T_66[0], _logic_out_T_64[0], _logic_out_T_62[0], _logic_out_T_60[0], _logic_out_T_58[0], _logic_out_T_56[0], _logic_out_T_54[0], _logic_out_T_52[0], _logic_out_T_50[0], _logic_out_T_48[0], _logic_out_T_46[0], _logic_out_T_44[0], _logic_out_T_42[0], _logic_out_T_40[0], _logic_out_T_38[0], _logic_out_T_36[0], _logic_out_T_34[0], _logic_out_T_32[0], _logic_out_T_30[0], _logic_out_T_28[0], _logic_out_T_26[0], _logic_out_T_24[0], _logic_out_T_22[0], _logic_out_T_20[0], _logic_out_T_18[0], _logic_out_T_16[0], _logic_out_T_14[0], _logic_out_T_12[0], _logic_out_T_10[0], _logic_out_T_8[0], _logic_out_T_6[0], _logic_out_T_4[0], _logic_out_T_2[0], _logic_out_T[0]} : cam_a_0_bits_param[2] ? adder_out : cam_a_0_bits_param[0] == (a_a_ext[63] == a_d_ext[63] ? ~(adder_out[63]) : cam_a_0_bits_param[1] == a_a_ext[63]) ? cam_a_0_bits_data : cam_d_0_data) : 64'h0) | (muxStateEarly_1 ? auto_in_a_bits_data : 64'h0);	// @[Arbiter.scala:117:30, AtomicAutomata.scala:79:24, :80:24, :116:57, :119:42, :120:42, :121:39, :133:41, :134:41, :136:33, :138:{38,49}, :139:{27,39,50,55,65}, :140:31, :141:{28,50}, :147:{14,34}, Bundles.scala:259:74, Cat.scala:33:92, Mux.scala:27:73]
  assign auto_out_a_bits_corrupt = muxStateEarly_0 & (cam_a_0_bits_corrupt | cam_d_0_corrupt) | muxStateEarly_1 & auto_in_a_bits_corrupt;	// @[Arbiter.scala:117:30, AtomicAutomata.scala:79:24, :80:24, :168:45, Mux.scala:27:73]
