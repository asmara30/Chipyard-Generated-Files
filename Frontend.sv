...
module Frontend(
  ...
  always @(posedge clock) begin
    ...
    if (reset) begin
      ...
      recent_progress_counter <= 2'h3;	// @[Frontend.scala:150:40]
    end
    else begin
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        s2_tlb_resp_gf_inst = _RANDOM_7[0];	// @[Frontend.scala:116:24]
        s2_tlb_resp_ae_inst = _RANDOM_7[4];	// @[Frontend.scala:116:24]
        s2_tlb_resp_cacheable = _RANDOM_7[10];	// @[Frontend.scala:116:24]
        s2_speculative = _RANDOM_7[13];	// @[Frontend.scala:116:24, :118:31]
        s2_partial_insn_valid = _RANDOM_7[14];	// @[Frontend.scala:116:24, :119:38]
        s2_partial_insn = _RANDOM_7[30:15];	// @[Frontend.scala:116:24, :120:28]
        wrong_path = _RANDOM_7[31];	// @[Frontend.scala:116:24, :121:27]
        s2_replay_REG = _RANDOM_8[0];	// @[Frontend.scala:129:56]
        recent_progress_counter = _RANDOM_8[2:1];	// @[Frontend.scala:129:56, :150:40]
        fq_io_enq_valid_REG = _RANDOM_8[3];	// @[Frontend.scala:129:56, :179:29]
        gpa_valid = _RANDOM_8[4];	// @[Frontend.scala:129:56, :348:22]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  TLB_2 tlb (	// @[Frontend.scala:100:19]
    .clock                         (clock),
    .reset                         (reset),
