...
module ClockSinkDomain_2(
  ...
  input  [3:0]  auto_serdesser_client_out_d_bits_sink,
  ...
  wire        _serdesser_auto_manager_in_a_ready;	// @[SerialAdapter.scala:384:44]
  wire        _serdesser_auto_manager_in_d_valid;	// @[SerialAdapter.scala:384:44]
  wire [2:0]  _serdesser_auto_manager_in_d_bits_opcode;	// @[SerialAdapter.scala:384:44]
  wire [1:0]  _serdesser_auto_manager_in_d_bits_param;	// @[SerialAdapter.scala:384:44]
  wire [2:0]  _serdesser_auto_manager_in_d_bits_size;	// @[SerialAdapter.scala:384:44]
  wire [3:0]  _serdesser_auto_manager_in_d_bits_source;	// @[SerialAdapter.scala:384:44]
  wire        _serdesser_auto_manager_in_d_bits_sink;	// @[SerialAdapter.scala:384:44]
  wire        _serdesser_auto_manager_in_d_bits_denied;	// @[SerialAdapter.scala:384:44]
  wire [63:0] _serdesser_auto_manager_in_d_bits_data;	// @[SerialAdapter.scala:384:44]
  wire        _serdesser_auto_manager_in_d_bits_corrupt;	// @[SerialAdapter.scala:384:44]
  TLSerdesser serdesser (	// @[SerialAdapter.scala:384:44]
  ...
  TLBuffer_24 buffer (	// @[Buffer.scala:69:28]
    .clock                   (auto_clock_in_clock),
    .reset                   (auto_clock_in_reset),
    ...
    .auto_out_a_ready        (_serdesser_auto_manager_in_a_ready),	// @[SerialAdapter.scala:384:44]
    .auto_out_d_valid        (_serdesser_auto_manager_in_d_valid),	// @[SerialAdapter.scala:384:44]
    .auto_out_d_bits_opcode  (_serdesser_auto_manager_in_d_bits_opcode),	// @[SerialAdapter.scala:384:44]
    .auto_out_d_bits_param   (_serdesser_auto_manager_in_d_bits_param),	// @[SerialAdapter.scala:384:44]
    .auto_out_d_bits_size    (_serdesser_auto_manager_in_d_bits_size),	// @[SerialAdapter.scala:384:44]
    .auto_out_d_bits_source  (_serdesser_auto_manager_in_d_bits_source),	// @[SerialAdapter.scala:384:44]
    .auto_out_d_bits_sink    (_serdesser_auto_manager_in_d_bits_sink),	// @[SerialAdapter.scala:384:44]
    .auto_out_d_bits_denied  (_serdesser_auto_manager_in_d_bits_denied),	// @[SerialAdapter.scala:384:44]
    .auto_out_d_bits_data    (_serdesser_auto_manager_in_d_bits_data),	// @[SerialAdapter.scala:384:44]
    .auto_out_d_bits_corrupt (_serdesser_auto_manager_in_d_bits_corrupt),	// @[SerialAdapter.scala:384:44]
