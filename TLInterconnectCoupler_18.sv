...
module TLInterconnectCoupler_18(
  ...
  wire [4:0]  _tl2axi4_auto_out_aw_bits_id;	// @[ToAXI4.scala:285:29]
  wire [31:0] _tl2axi4_auto_out_aw_bits_addr;	// @[ToAXI4.scala:285:29]
  ...
  wire [4:0]  _tl2axi4_auto_out_aw_bits_echo_tl_state_source;	// @[ToAXI4.scala:285:29]
  ...
  wire [4:0]  _tl2axi4_auto_out_ar_bits_id;	// @[ToAXI4.scala:285:29]
  wire [31:0] _tl2axi4_auto_out_ar_bits_addr;	// @[ToAXI4.scala:285:29]
  ...
  wire [4:0]  _tl2axi4_auto_out_ar_bits_echo_tl_state_source;	// @[ToAXI4.scala:285:29]
  ...
  wire [4:0]  _axi4index_auto_in_b_bits_id;	// @[IdIndexer.scala:93:31]
  ...
  wire [4:0]  _axi4index_auto_in_b_bits_echo_tl_state_source;	// @[IdIndexer.scala:93:31]
  wire        _axi4index_auto_in_ar_ready;	// @[IdIndexer.scala:93:31]
  wire        _axi4index_auto_in_r_valid;	// @[IdIndexer.scala:93:31]
  wire [4:0]  _axi4index_auto_in_r_bits_id;	// @[IdIndexer.scala:93:31]
  ...
  wire [4:0]  _axi4index_auto_in_r_bits_echo_tl_state_source;	// @[IdIndexer.scala:93:31]
  ...
  wire [31:0] _axi4index_auto_out_aw_bits_addr;	// @[IdIndexer.scala:93:31]
  ...
  wire [4:0]  _axi4index_auto_out_aw_bits_echo_tl_state_source;	// @[IdIndexer.scala:93:31]
  wire        _axi4index_auto_out_aw_bits_echo_extra_id;	// @[IdIndexer.scala:93:31]
  ...
  wire [31:0] _axi4index_auto_out_ar_bits_addr;	// @[IdIndexer.scala:93:31]
  ...
  wire [4:0]  _axi4index_auto_out_ar_bits_echo_tl_state_source;	// @[IdIndexer.scala:93:31]
  wire        _axi4index_auto_out_ar_bits_echo_extra_id;	// @[IdIndexer.scala:93:31]
  ...
  wire [4:0]  _axi4yank_auto_in_b_bits_echo_tl_state_source;	// @[UserYanker.scala:106:30]
  wire        _axi4yank_auto_in_b_bits_echo_extra_id;	// @[UserYanker.scala:106:30]
  ...
  wire [4:0]  _axi4yank_auto_in_r_bits_echo_tl_state_source;	// @[UserYanker.scala:106:30]
  wire        _axi4yank_auto_in_r_bits_echo_extra_id;	// @[UserYanker.scala:106:30]
  ...
  AXI4UserYanker axi4yank (	// @[UserYanker.scala:106:30]
    ...
    .auto_in_aw_bits_echo_extra_id        (_axi4index_auto_out_aw_bits_echo_extra_id),	// @[IdIndexer.scala:93:31]
    ...
    .auto_in_ar_bits_echo_extra_id        (_axi4index_auto_out_ar_bits_echo_extra_id),	// @[IdIndexer.scala:93:31]
  ...
  AXI4IdIndexer axi4index (	// @[IdIndexer.scala:93:31]
    ...
    .auto_out_b_bits_echo_extra_id         (_axi4yank_auto_in_b_bits_echo_extra_id),	// @[UserYanker.scala:106:30]
    ...
    .auto_out_r_bits_echo_extra_id         (_axi4yank_auto_in_r_bits_echo_extra_id),	// @[UserYanker.scala:106:30]
