...
module Queue_50(
  ...
  wire [128:0] _ram_ext_R0_data;	// @[Decoupled.scala:273:95]
  ...
  ram_combMem_30 ram_ext (	// @[Decoupled.scala:273:95]
    .R0_addr (1'h0),
    .R0_en   (1'h1),
    .R0_clk  (clock),
    .W0_addr (1'h0),
    ...
    .W0_clk  (clock),
    .W0_data ({io_enq_bits_fromDMA, io_enq_bits_data}),	// @[Decoupled.scala:273:95]
  ...
  assign io_deq_bits_data = maybe_full ? _ram_ext_R0_data[127:0] : io_enq_bits_data;	// @[Decoupled.scala:273:95, :276:27, :310:17, :315:17, :316:19]
  assign io_deq_bits_fromDMA = maybe_full ? _ram_ext_R0_data[128] : io_enq_bits_fromDMA;	// @[Decoupled.scala:273:95, :276:27, :310:17, :315:17, :316:19]
