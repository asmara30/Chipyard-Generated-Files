...
module SerialRAM(
  ...
  wire        _rom_auto_in_a_ready;	// @[SerialAdapter.scala:441:25]
  wire        _rom_auto_in_d_valid;	// @[SerialAdapter.scala:441:25]
  wire [1:0]  _rom_auto_in_d_bits_size;	// @[SerialAdapter.scala:441:25]
  wire [7:0]  _rom_auto_in_d_bits_source;	// @[SerialAdapter.scala:441:25]
  wire [63:0] _rom_auto_in_d_bits_data;	// @[SerialAdapter.scala:441:25]
  wire        _srams_auto_in_a_ready;	// @[SerialAdapter.scala:462:15]
  wire        _srams_auto_in_d_valid;	// @[SerialAdapter.scala:462:15]
  wire [2:0]  _srams_auto_in_d_bits_opcode;	// @[SerialAdapter.scala:462:15]
  wire [1:0]  _srams_auto_in_d_bits_size;	// @[SerialAdapter.scala:462:15]
  wire [7:0]  _srams_auto_in_d_bits_source;	// @[SerialAdapter.scala:462:15]
  wire [63:0] _srams_auto_in_d_bits_data;	// @[SerialAdapter.scala:462:15]
  wire        _serdesser_auto_manager_in_a_ready;	// @[SerialAdapter.scala:455:29]
  wire        _serdesser_auto_manager_in_d_valid;	// @[SerialAdapter.scala:455:29]
  wire [2:0]  _serdesser_auto_manager_in_d_bits_opcode;	// @[SerialAdapter.scala:455:29]
  wire [1:0]  _serdesser_auto_manager_in_d_bits_param;	// @[SerialAdapter.scala:455:29]
  wire [3:0]  _serdesser_auto_manager_in_d_bits_size;	// @[SerialAdapter.scala:455:29]
  wire        _serdesser_auto_manager_in_d_bits_source;	// @[SerialAdapter.scala:455:29]
  wire [3:0]  _serdesser_auto_manager_in_d_bits_sink;	// @[SerialAdapter.scala:455:29]
  wire        _serdesser_auto_manager_in_d_bits_denied;	// @[SerialAdapter.scala:455:29]
  wire [63:0] _serdesser_auto_manager_in_d_bits_data;	// @[SerialAdapter.scala:455:29]
  wire        _serdesser_auto_manager_in_d_bits_corrupt;	// @[SerialAdapter.scala:455:29]
  wire        _serdesser_auto_client_out_a_valid;	// @[SerialAdapter.scala:455:29]
  wire [2:0]  _serdesser_auto_client_out_a_bits_opcode;	// @[SerialAdapter.scala:455:29]
  wire [2:0]  _serdesser_auto_client_out_a_bits_param;	// @[SerialAdapter.scala:455:29]
  wire [2:0]  _serdesser_auto_client_out_a_bits_size;	// @[SerialAdapter.scala:455:29]
  wire [3:0]  _serdesser_auto_client_out_a_bits_source;	// @[SerialAdapter.scala:455:29]
  wire [28:0] _serdesser_auto_client_out_a_bits_address;	// @[SerialAdapter.scala:455:29]
  wire [7:0]  _serdesser_auto_client_out_a_bits_mask;	// @[SerialAdapter.scala:455:29]
  wire [63:0] _serdesser_auto_client_out_a_bits_data;	// @[SerialAdapter.scala:455:29]
  wire        _serdesser_auto_client_out_a_bits_corrupt;	// @[SerialAdapter.scala:455:29]
  wire        _serdesser_auto_client_out_d_ready;	// @[SerialAdapter.scala:455:29]
  wire        _adapter_auto_out_a_valid;	// @[SerialAdapter.scala:454:27]
  wire [2:0]  _adapter_auto_out_a_bits_opcode;	// @[SerialAdapter.scala:454:27]
  wire [3:0]  _adapter_auto_out_a_bits_size;	// @[SerialAdapter.scala:454:27]
  wire [31:0] _adapter_auto_out_a_bits_address;	// @[SerialAdapter.scala:454:27]
  wire [7:0]  _adapter_auto_out_a_bits_mask;	// @[SerialAdapter.scala:454:27]
  wire [63:0] _adapter_auto_out_a_bits_data;	// @[SerialAdapter.scala:454:27]
  wire        _adapter_auto_out_d_ready;	// @[SerialAdapter.scala:454:27]
  SerialAdapter adapter (	// @[SerialAdapter.scala:454:27]
    .clock                   (clock),
    .reset                   (reset),
  ...
  TLSerdesser_1 serdesser (	// @[SerialAdapter.scala:455:29]
    .clock                          (clock),
    .reset                          (reset),
  ...
  TLRAM srams (	// @[SerialAdapter.scala:462:15]
    .clock                  (clock),
    .reset                  (reset),
  ...
  TLROM_1 rom (	// @[SerialAdapter.scala:441:25]
    .clock                  (clock),
    .reset                  (reset),
  ...
  TLXbar_12 xbar (	// @[Xbar.scala:144:26]
    .clock                     (clock),
    .reset                     (reset),
    .auto_in_a_valid           (_serdesser_auto_client_out_a_valid),	// @[SerialAdapter.scala:455:29]
    .auto_in_a_bits_opcode     (_serdesser_auto_client_out_a_bits_opcode),	// @[SerialAdapter.scala:455:29]
    .auto_in_a_bits_param      (_serdesser_auto_client_out_a_bits_param),	// @[SerialAdapter.scala:455:29]
    .auto_in_a_bits_size       (_serdesser_auto_client_out_a_bits_size),	// @[SerialAdapter.scala:455:29]
    .auto_in_a_bits_source     (_serdesser_auto_client_out_a_bits_source),	// @[SerialAdapter.scala:455:29]
    .auto_in_a_bits_address    (_serdesser_auto_client_out_a_bits_address),	// @[SerialAdapter.scala:455:29]
    .auto_in_a_bits_mask       (_serdesser_auto_client_out_a_bits_mask),	// @[SerialAdapter.scala:455:29]
    .auto_in_a_bits_data       (_serdesser_auto_client_out_a_bits_data),	// @[SerialAdapter.scala:455:29]
    .auto_in_a_bits_corrupt    (_serdesser_auto_client_out_a_bits_corrupt),	// @[SerialAdapter.scala:455:29]
    .auto_in_d_ready           (_serdesser_auto_client_out_d_ready),	// @[SerialAdapter.scala:455:29]
  ...
  TLBuffer_26 buffer (	// @[Buffer.scala:69:28]
    .clock                   (clock),
    .reset                   (reset),
    ...
    .auto_out_a_ready        (_srams_auto_in_a_ready),	// @[SerialAdapter.scala:462:15]
    .auto_out_d_valid        (_srams_auto_in_d_valid),	// @[SerialAdapter.scala:462:15]
    .auto_out_d_bits_opcode  (_srams_auto_in_d_bits_opcode),	// @[SerialAdapter.scala:462:15]
    .auto_out_d_bits_size    (_srams_auto_in_d_bits_size),	// @[SerialAdapter.scala:462:15]
    .auto_out_d_bits_source  (_srams_auto_in_d_bits_source),	// @[SerialAdapter.scala:462:15]
    .auto_out_d_bits_data    (_srams_auto_in_d_bits_data),	// @[SerialAdapter.scala:462:15]
  ...
  TLFragmenter_10 fragmenter (	// @[Fragmenter.scala:334:34]
    .clock                   (clock),
    .reset                   (reset),
  ...
  TLFragmenter_11 fragmenter_1 (	// @[Fragmenter.scala:334:34]
    .clock                   (clock),
    .reset                   (reset),
    ...
    .auto_out_a_ready        (_rom_auto_in_a_ready),	// @[SerialAdapter.scala:441:25]
    .auto_out_d_valid        (_rom_auto_in_d_valid),	// @[SerialAdapter.scala:441:25]
    .auto_out_d_bits_size    (_rom_auto_in_d_bits_size),	// @[SerialAdapter.scala:441:25]
    .auto_out_d_bits_source  (_rom_auto_in_d_bits_source),	// @[SerialAdapter.scala:441:25]
    .auto_out_d_bits_data    (_rom_auto_in_d_bits_data),	// @[SerialAdapter.scala:441:25]
  ...
  TLBuffer_27 buffer_1 (	// @[Buffer.scala:69:28]
    .clock                   (clock),
    .reset                   (reset),
    .auto_in_a_valid         (_adapter_auto_out_a_valid),	// @[SerialAdapter.scala:454:27]
    .auto_in_a_bits_opcode   (_adapter_auto_out_a_bits_opcode),	// @[SerialAdapter.scala:454:27]
    .auto_in_a_bits_size     (_adapter_auto_out_a_bits_size),	// @[SerialAdapter.scala:454:27]
    .auto_in_a_bits_address  (_adapter_auto_out_a_bits_address),	// @[SerialAdapter.scala:454:27]
    .auto_in_a_bits_mask     (_adapter_auto_out_a_bits_mask),	// @[SerialAdapter.scala:454:27]
    .auto_in_a_bits_data     (_adapter_auto_out_a_bits_data),	// @[SerialAdapter.scala:454:27]
    .auto_in_d_ready         (_adapter_auto_out_d_ready),	// @[SerialAdapter.scala:454:27]
    .auto_out_a_ready        (_serdesser_auto_manager_in_a_ready),	// @[SerialAdapter.scala:455:29]
    .auto_out_d_valid        (_serdesser_auto_manager_in_d_valid),	// @[SerialAdapter.scala:455:29]
    .auto_out_d_bits_opcode  (_serdesser_auto_manager_in_d_bits_opcode),	// @[SerialAdapter.scala:455:29]
    .auto_out_d_bits_param   (_serdesser_auto_manager_in_d_bits_param),	// @[SerialAdapter.scala:455:29]
    .auto_out_d_bits_size    (_serdesser_auto_manager_in_d_bits_size),	// @[SerialAdapter.scala:455:29]
    .auto_out_d_bits_source  (_serdesser_auto_manager_in_d_bits_source),	// @[SerialAdapter.scala:455:29]
    .auto_out_d_bits_sink    (_serdesser_auto_manager_in_d_bits_sink),	// @[SerialAdapter.scala:455:29]
    .auto_out_d_bits_denied  (_serdesser_auto_manager_in_d_bits_denied),	// @[SerialAdapter.scala:455:29]
    .auto_out_d_bits_data    (_serdesser_auto_manager_in_d_bits_data),	// @[SerialAdapter.scala:455:29]
    .auto_out_d_bits_corrupt (_serdesser_auto_manager_in_d_bits_corrupt),	// @[SerialAdapter.scala:455:29]
