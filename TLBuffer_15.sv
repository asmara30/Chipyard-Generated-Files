...
module TLBuffer_15(
  ...
  wire [5:0] _bundleIn_0_d_q_io_deq_bits_source;	// @[Decoupled.scala:375:21]
  ...
  Queue_30 x1_a_q (	// @[Decoupled.scala:375:21]
    .clock               (clock),
    .reset               (reset),
  ...
  Queue_31 bundleIn_0_d_q (	// @[Decoupled.scala:375:21]
    .clock               (clock),
    .reset               (reset),
