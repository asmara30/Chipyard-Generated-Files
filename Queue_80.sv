...
module Queue_80(
  ...
  wire [81:0] _ram_ext_R0_data;	// @[Decoupled.scala:273:95]
  ...
  assign io_deq_bits_source = _ram_ext_R0_data[14:7];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_sink = _ram_ext_R0_data[15];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_denied = _ram_ext_R0_data[16];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_data = _ram_ext_R0_data[80:17];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_corrupt = _ram_ext_R0_data[81];	// @[Decoupled.scala:273:95]
endmodule
